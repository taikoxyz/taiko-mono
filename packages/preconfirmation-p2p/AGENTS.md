...
- Key docs: `README.md`, `ARCHITECTURE.md`, `AGENTS.md`, `docs/specification.md` (authoritative P2P protocol spec covering topics/IDs, libp2p varint framing, size/rate limits).
