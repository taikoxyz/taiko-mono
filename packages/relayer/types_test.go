...
func Test_DecodeMessageSentData(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"receiveERC20",
			// nolint lll
			common.Hex2Bytes(""),
			nil,
			EventTypeSendERC20,
			CanonicalERC20{
				ChainId:  167001,
