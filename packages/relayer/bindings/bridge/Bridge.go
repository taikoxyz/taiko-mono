...
// CALLDATAMESSAGESIZEBYTES is a free data retrieval call binding the contract method 0xd88e4ab1.
//
// Solidity: function CALLDATA_MESSAGE_SIZE_BYTES() view returns(uint256)
func (_Bridge *BridgeCaller) CALLDATAMESSAGESIZEBYTES(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "CALLDATA_MESSAGE_SIZE_BYTES")
...
//
// Solidity: function CALLDATA_MESSAGE_SIZE_BYTES() view returns(uint256)
func (_Bridge *BridgeSession) CALLDATAMESSAGESIZEBYTES() (*big.Int, error) {
	return _Bridge.Contract.CALLDATAMESSAGESIZEBYTES(&_Bridge.CallOpts)
}

// CALLDATAMESSAGESIZEBYTES is a free data retrieval call binding the contract method 0xd88e4ab1.
//
// Solidity: function CALLDATA_MESSAGE_SIZE_BYTES() view returns(uint256)
func (_Bridge *BridgeCallerSession) CALLDATAMESSAGESIZEBYTES() (*big.Int, error) {
	return _Bridge.Contract.CALLDATAMESSAGESIZEBYTES(&_Bridge.CallOpts)
}
