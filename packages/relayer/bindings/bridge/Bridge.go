...
// BridgeGasStats is an auto generated low-level Go binding around an user-defined struct.
type BridgeGasStats struct {
	Start            *big.Int
	BeforeInvocation *big.Int
	AfterInvocation  *big.Int
	GasUsedInFeeCalc *big.Int
	End              *big.Int
}
...
// FilterGasLog is a free log retrieval operation binding the contract event 0x7429b50f80efeac65ec7bd6dc3f2afaa1302a80a2ec4217b6db5e46299729ca3.
//
// Solidity: event GasLog(bytes32 indexed msgHash, (uint256,uint256,uint256,uint256,uint256) stats, uint256 overhead, uint256 proofSize, uint256 numCacheOps)
func (_Bridge *BridgeFilterer) FilterGasLog(opts *bind.FilterOpts, msgHash [][32]byte) (*BridgeGasLogIterator, error) {
	...
	logs, sub, err := _Bridge.contract.FilterLogs(opts, "GasLog", msgHashRule)
	if err != nil {
		return nil, err
	}
...
// WatchGasLog is a free log subscription operation binding the contract event 0x7429b50f80efeac65ec7bd6dc3f2afaa1302a80a2ec4217b6db5e46299729ca3.
//
// Solidity: event GasLog(bytes32 indexed msgHash, (uint256,uint256,uint256,uint256,uint256) stats, uint256 overhead, uint256 proofSize, uint256 numCacheOps)
func (_Bridge *BridgeFilterer) WatchGasLog(opts *bind.WatchOpts, sink chan<- *BridgeGasLog, msgHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _Bridge.contract.WatchLogs(opts, "GasLog", msgHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseGasLog is a log parse operation binding the contract event 0x7429b50f80efeac65ec7bd6dc3f2afaa1302a80a2ec4217b6db5e46299729ca3.
//
// Solidity: event GasLog(bytes32 indexed msgHash, (uint256,uint256,uint256,uint256,uint256) stats, uint256 overhead, uint256 proofSize, uint256 numCacheOps)
...
// FilterMessageProcessed is a free log retrieval operation binding the contract event 0xbf54c9479bb75c64efeb0b120dc05529bc8ac2736797196fbe6df7ce6a7c38e6.
//
// Solidity: event MessageProcessed((uint64,uint64,uint32,address,uint64,address,uint64,address,address,uint256,bytes) message)
func (_Bridge *BridgeFilterer) FilterMessageProcessed(opts *bind.FilterOpts) (*BridgeMessageProcessedIterator, error) {

	logs, sub, err := _Bridge.contract.FilterLogs(opts, "MessageProcessed")
	if err != nil {
		return nil, err
	}
...
// WatchMessageProcessed is a free log subscription operation binding the contract event 0xbf54c9479bb75c64efeb0b120dc05529bc8ac2736797196fbe6df7ce6a7c38e6.
//
// Solidity: event MessageProcessed((uint64,uint64,uint32,address,uint64,address,uint64,address,address,uint256,bytes) message)
func (_Bridge *BridgeFilterer) WatchMessageProcessed(opts *bind.WatchOpts, sink chan<- *BridgeMessageProcessed) (event.Subscription, error) {

	logs, sub, err := _Bridge.contract.WatchLogs(opts, "MessageProcessed")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseMessageProcessed is a log parse operation binding the contract event 0xbf54c9479bb75c64efeb0b120dc05529bc8ac2736797196fbe6df7ce6a7c38e6.
//
// Solidity: event MessageProcessed((uint64,uint64,uint32,address,uint64,address,uint64,address,address,uint256,bytes) message)
