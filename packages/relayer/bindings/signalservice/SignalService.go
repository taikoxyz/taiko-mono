...
// GetSyncedChainHeight is a free data retrieval call binding the contract method 0x71c2f704.
//
// Solidity: function getSyncedChainHeight(uint64 _chainId, bytes32 _kind) view returns(uint64)
func (_SignalService *SignalServiceCaller) GetSyncedChainHeight(opts *bind.CallOpts, _chainId uint64, _kind [32]byte) (uint64, error) {
	var out []interface{}
	err := _SignalService.contract.Call(opts, &out, "getSyncedChainHeight", _chainId, _kind)
...
//
// Solidity: function getSyncedChainHeight(uint64 _chainId, bytes32 _kind) view returns(uint64)
func (_SignalService *SignalServiceSession) GetSyncedChainHeight(_chainId uint64, _kind [32]byte) (uint64, error) {
	return _SignalService.Contract.GetSyncedChainHeight(&_SignalService.CallOpts, _chainId, _kind)
}

// GetSyncedChainHeight is a free data retrieval call binding the contract method 0x71c2f704.
//
// Solidity: function getSyncedChainHeight(uint64 _chainId, bytes32 _kind) view returns(uint64)
func (_SignalService *SignalServiceCallerSession) GetSyncedChainHeight(_chainId uint64, _kind [32]byte) (uint64, error) {
	return _SignalService.Contract.GetSyncedChainHeight(&_SignalService.CallOpts, _chainId, _kind)
}
