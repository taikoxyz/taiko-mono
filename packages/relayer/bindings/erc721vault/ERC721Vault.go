...
func (_ERC721Vault *ERC721VaultTransactor) OnMessageInvocation(opts *bind.TransactOpts, data []byte) (*types.Transaction, error) {
	return _ERC721Vault.contract.Transact(opts, "onMessageInvocation", data)
}

// OnMessageInvocation is a paid mutator transaction binding the contract method 0x7f07c947.
//
// Solidity: function onMessageInvocation(bytes data) payable returns()
func (_ERC721Vault *ERC721VaultSession) OnMessageInvocation(data []byte) (*types.Transaction, error) {
	return _ERC721Vault.Contract.OnMessageInvocation(&_ERC721Vault.TransactOpts, data)
}

// OnMessageInvocation is a paid mutator transaction binding the contract method 0x7f07c947.
//
// Solidity: function onMessageInvocation(bytes data) payable returns()
func (_ERC721Vault *ERC721VaultTransactorSession) OnMessageInvocation(data []byte) (*types.Transaction, error) {
	return _ERC721Vault.Contract.OnMessageInvocation(&_ERC721Vault.TransactOpts, data)
}
...
//
// Solidity: function sendToken((uint64,address,address,address,uint256[],uint256[],uint256,uint256,address,string) op) payable returns((uint128,address,uint64,uint64,address,address,address,address,uint256,uint256,uint256,bytes,string) _message)
