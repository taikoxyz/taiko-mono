...
func (_ERC1155Vault *ERC1155VaultCaller) Impl(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ERC1155Vault.contract.Call(opts, &out, "impl")
...
func (_ERC1155Vault *ERC1155VaultSession) Impl() (common.Address, error) {
	return _ERC1155Vault.Contract.Impl(&_ERC1155Vault.CallOpts)
}
...
func (_ERC1155Vault *ERC1155VaultCaller) Resolver(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ERC1155Vault.contract.Call(opts, &out, "resolver")
...
//
// Solidity: function resolver() view returns(address)
func (_ERC1155Vault *ERC1155VaultSession) Resolver() (common.Address, error) {
	return _ERC1155Vault.Contract.Resolver(&_ERC1155Vault.CallOpts)
}

// Resolver is a free data retrieval call binding the contract method 0x04f3bcec.
//
// Solidity: function resolver() view returns(address)
func (_ERC1155Vault *ERC1155VaultCallerSession) Resolver() (common.Address, error) {
	return _ERC1155Vault.Contract.Resolver(&_ERC1155Vault.CallOpts)
}
...
func (_ERC1155Vault *ERC1155VaultTransactor) Init(opts *bind.TransactOpts, _owner common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.contract.Transact(opts, "init", _owner)
}

// Init is a paid mutator transaction binding the contract method 0x19ab453c.
//
// Solidity: function init(address _owner) returns()
func (_ERC1155Vault *ERC1155VaultSession) Init(_owner common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.Contract.Init(&_ERC1155Vault.TransactOpts, _owner)
}

// Init is a paid mutator transaction binding the contract method 0x19ab453c.
//
// Solidity: function init(address _owner) returns()
func (_ERC1155Vault *ERC1155VaultTransactorSession) Init(_owner common.Address) (*types.Transaction, error) {
	return _ERC1155Vault.Contract.Init(&_ERC1155Vault.TransactOpts, _owner)
}
