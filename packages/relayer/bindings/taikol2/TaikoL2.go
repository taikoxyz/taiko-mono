...
func (_TaikoL2 *TaikoL2Caller) AdjustExcess(opts *bind.CallOpts, _currGasExcess uint64, _currGasTarget uint64, _newGasTarget uint64) (uint64, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "adjustExcess", _currGasExcess, _currGasTarget, _newGasTarget)
...
//
// Solidity: function adjustExcess(uint64 _currGasExcess, uint64 _currGasTarget, uint64 _newGasTarget) pure returns(uint64 newGasExcess_)
func (_TaikoL2 *TaikoL2Session) AdjustExcess(_currGasExcess uint64, _currGasTarget uint64, _newGasTarget uint64) (uint64, error) {
	return _TaikoL2.Contract.AdjustExcess(&_TaikoL2.CallOpts, _currGasExcess, _currGasTarget, _newGasTarget)
}

// AdjustExcess is a free data retrieval call binding the contract method 0x136dc4a8.
//
// Solidity: function adjustExcess(uint64 _currGasExcess, uint64 _currGasTarget, uint64 _newGasTarget) pure returns(uint64 newGasExcess_)
func (_TaikoL2 *TaikoL2CallerSession) AdjustExcess(_currGasExcess uint64, _currGasTarget uint64, _newGasTarget uint64) (uint64, error) {
	return _TaikoL2.Contract.AdjustExcess(&_TaikoL2.CallOpts, _currGasExcess, _currGasTarget, _newGasTarget)
}
...
func (_TaikoL2 *TaikoL2Caller) CalculateBaseFee(opts *bind.CallOpts, _baseFeeConfig LibSharedDataBaseFeeConfig, _blocktime uint64, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "calculateBaseFee", _baseFeeConfig, _blocktime, _parentGasExcess, _parentGasUsed)
...
//
// Solidity: function calculateBaseFee((uint8,uint8,uint32,uint64,uint32) _baseFeeConfig, uint64 _blocktime, uint64 _parentGasExcess, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2Session) CalculateBaseFee(_baseFeeConfig LibSharedDataBaseFeeConfig, _blocktime uint64, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.CalculateBaseFee(&_TaikoL2.CallOpts, _baseFeeConfig, _blocktime, _parentGasExcess, _parentGasUsed)
}

// CalculateBaseFee is a free data retrieval call binding the contract method 0xe902461a.
//
// Solidity: function calculateBaseFee((uint8,uint8,uint32,uint64,uint32) _baseFeeConfig, uint64 _blocktime, uint64 _parentGasExcess, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2CallerSession) CalculateBaseFee(_baseFeeConfig LibSharedDataBaseFeeConfig, _blocktime uint64, _parentGasExcess uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.CalculateBaseFee(&_TaikoL2.CallOpts, _baseFeeConfig, _blocktime, _parentGasExcess, _parentGasUsed)
...
func (_TaikoL2 *TaikoL2Caller) GetBasefee(opts *bind.CallOpts, _anchorBlockId uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "getBasefee", _anchorBlockId, _parentGasUsed)
...
//
// Solidity: function getBasefee(uint64 _anchorBlockId, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2Session) GetBasefee(_anchorBlockId uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.GetBasefee(&_TaikoL2.CallOpts, _anchorBlockId, _parentGasUsed)
}

// GetBasefee is a free data retrieval call binding the contract method 0xa7e022d1.
//
// Solidity: function getBasefee(uint64 _anchorBlockId, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
func (_TaikoL2 *TaikoL2CallerSession) GetBasefee(_anchorBlockId uint64, _parentGasUsed uint32) (struct {
	Basefee         *big.Int
	ParentGasExcess uint64
}, error) {
	return _TaikoL2.Contract.GetBasefee(&_TaikoL2.CallOpts, _anchorBlockId, _parentGasUsed)
...
// GetBasefeeV2 is a free data retrieval call binding the contract method 0xc97157b6.
//
// Solidity: function getBasefeeV2(uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoL2 *TaikoL2Caller) GetBasefeeV2(opts *bind.CallOpts, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "getBasefeeV2", _parentGasUsed, _baseFeeConfig)
...
//
// Solidity: function getBasefeeV2(uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoL2 *TaikoL2Session) GetBasefeeV2(_parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
	return _TaikoL2.Contract.GetBasefeeV2(&_TaikoL2.CallOpts, _parentGasUsed, _baseFeeConfig)
}

// GetBasefeeV2 is a free data retrieval call binding the contract method 0xc97157b6.
//
// Solidity: function getBasefeeV2(uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoL2 *TaikoL2CallerSession) GetBasefeeV2(_parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
...
func (_TaikoL2 *TaikoL2Caller) GetBlockHash(opts *bind.CallOpts, _blockId *big.Int) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function getBlockHash(uint256 _blockId) view returns(bytes32)
func (_TaikoL2 *TaikoL2Session) GetBlockHash(_blockId *big.Int) ([32]byte, error) {
...
//
// Solidity: function getBlockHash(uint256 _blockId) view returns(bytes32)
func (_TaikoL2 *TaikoL2CallerSession) GetBlockHash(_blockId *big.Int) ([32]byte, error) {
	return _TaikoL2.Contract.GetBlockHash(&_TaikoL2.CallOpts, _blockId)
}
...
func (_TaikoL2 *TaikoL2Caller) Impl(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "impl")
...
func (_TaikoL2 *TaikoL2Session) Impl() (common.Address, error) {
	return _TaikoL2.Contract.Impl(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Caller) InNonReentrant(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "inNonReentrant")
...
func (_TaikoL2 *TaikoL2Session) InNonReentrant() (bool, error) {
	return _TaikoL2.Contract.InNonReentrant(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Caller) OntakeForkHeight(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "ontakeForkHeight")
...
//
// Solidity: function ontakeForkHeight() pure returns(uint64)
func (_TaikoL2 *TaikoL2Session) OntakeForkHeight() (uint64, error) {
	return _TaikoL2.Contract.OntakeForkHeight(&_TaikoL2.CallOpts)
}

// OntakeForkHeight is a free data retrieval call binding the contract method 0x356aec04.
//
// Solidity: function ontakeForkHeight() pure returns(uint64)
func (_TaikoL2 *TaikoL2CallerSession) OntakeForkHeight() (uint64, error) {
	return _TaikoL2.Contract.OntakeForkHeight(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Caller) ParentGasExcess(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "parentGasExcess")
...
//
// Solidity: function parentGasExcess() view returns(uint64)
func (_TaikoL2 *TaikoL2Session) ParentGasExcess() (uint64, error) {
	return _TaikoL2.Contract.ParentGasExcess(&_TaikoL2.CallOpts)
}

// ParentGasExcess is a free data retrieval call binding the contract method 0xb8c7b30c.
//
// Solidity: function parentGasExcess() view returns(uint64)
func (_TaikoL2 *TaikoL2CallerSession) ParentGasExcess() (uint64, error) {
	return _TaikoL2.Contract.ParentGasExcess(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Caller) ParentGasTarget(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "parentGasTarget")
...
//
// Solidity: function parentGasTarget() view returns(uint64)
func (_TaikoL2 *TaikoL2Session) ParentGasTarget() (uint64, error) {
	return _TaikoL2.Contract.ParentGasTarget(&_TaikoL2.CallOpts)
}

// ParentGasTarget is a free data retrieval call binding the contract method 0xa7137c0f.
//
// Solidity: function parentGasTarget() view returns(uint64)
func (_TaikoL2 *TaikoL2CallerSession) ParentGasTarget() (uint64, error) {
	return _TaikoL2.Contract.ParentGasTarget(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Transactor) AnchorV2(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2.contract.Transact(opts, "anchorV2", _anchorBlockId, _anchorStateRoot, _parentGasUsed, _baseFeeConfig)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0xfd85eb2d.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
func (_TaikoL2 *TaikoL2Session) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2.Contract.AnchorV2(&_TaikoL2.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, _baseFeeConfig)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0xfd85eb2d.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
func (_TaikoL2 *TaikoL2TransactorSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig) (*types.Transaction, error) {
	return _TaikoL2.Contract.AnchorV2(&_TaikoL2.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, _baseFeeConfig)
}
...
func (_TaikoL2 *TaikoL2Transactor) Init(opts *bind.TransactOpts, _owner common.Address, _rollupAddressManager common.Address, _l1ChainId uint64, _initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.contract.Transact(opts, "init", _owner, _rollupAddressManager, _l1ChainId, _initialGasExcess)
}

// Init is a paid mutator transaction binding the contract method 0x5950f9f1.
//
// Solidity: function init(address _owner, address _rollupAddressManager, uint64 _l1ChainId, uint64 _initialGasExcess) returns()
func (_TaikoL2 *TaikoL2Session) Init(_owner common.Address, _rollupAddressManager common.Address, _l1ChainId uint64, _initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.Contract.Init(&_TaikoL2.TransactOpts, _owner, _rollupAddressManager, _l1ChainId, _initialGasExcess)
}

// Init is a paid mutator transaction binding the contract method 0x5950f9f1.
//
// Solidity: function init(address _owner, address _rollupAddressManager, uint64 _l1ChainId, uint64 _initialGasExcess) returns()
func (_TaikoL2 *TaikoL2TransactorSession) Init(_owner common.Address, _rollupAddressManager common.Address, _l1ChainId uint64, _initialGasExcess uint64) (*types.Transaction, error) {
	return _TaikoL2.Contract.Init(&_TaikoL2.TransactOpts, _owner, _rollupAddressManager, _l1ChainId, _initialGasExcess)
}
...
// TaikoL2EIP1559UpdateIterator is returned from FilterEIP1559Update and is used to iterate over the raw logs and unpacked data for EIP1559Update events raised by the TaikoL2 contract.
type TaikoL2EIP1559UpdateIterator struct {
	Event *TaikoL2EIP1559Update // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL2EIP1559UpdateIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL2EIP1559Update)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL2EIP1559UpdateIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL2EIP1559UpdateIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL2EIP1559Update represents a EIP1559Update event raised by the TaikoL2 contract.
type TaikoL2EIP1559Update struct {
	OldGasTarget uint64
	NewGasTarget uint64
	OldGasExcess uint64
	NewGasExcess uint64
...
func (_TaikoL2 *TaikoL2Filterer) FilterEIP1559Update(opts *bind.FilterOpts) (*TaikoL2EIP1559UpdateIterator, error) {

	logs, sub, err := _TaikoL2.contract.FilterLogs(opts, "EIP1559Update")
	if err != nil {
		return nil, err
	}
	return &TaikoL2EIP1559UpdateIterator{contract: _TaikoL2.contract, event: "EIP1559Update", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event EIP1559Update(uint64 oldGasTarget, uint64 newGasTarget, uint64 oldGasExcess, uint64 newGasExcess, uint256 basefee)
func (_TaikoL2 *TaikoL2Filterer) WatchEIP1559Update(opts *bind.WatchOpts, sink chan<- *TaikoL2EIP1559Update) (event.Subscription, error) {

	logs, sub, err := _TaikoL2.contract.WatchLogs(opts, "EIP1559Update")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL2EIP1559Update)
				if err := _TaikoL2.contract.UnpackLog(event, "EIP1559Update", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event EIP1559Update(uint64 oldGasTarget, uint64 newGasTarget, uint64 oldGasExcess, uint64 newGasExcess, uint256 basefee)
func (_TaikoL2 *TaikoL2Filterer) ParseEIP1559Update(log types.Log) (*TaikoL2EIP1559Update, error) {
	event := new(TaikoL2EIP1559Update)
	if err := _TaikoL2.contract.UnpackLog(event, "EIP1559Update", log); err != nil {
		return nil, err
	}
