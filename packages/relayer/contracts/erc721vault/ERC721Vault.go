...
func (_ERC721Vault *ERC721VaultCaller) CanonicalToBridged(opts *bind.CallOpts, chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _ERC721Vault.contract.Call(opts, &out, "canonicalToBridged", chainId, ctokenAddress)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address ctokenAddress) view returns(address btoken)
func (_ERC721Vault *ERC721VaultSession) CanonicalToBridged(chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	return _ERC721Vault.Contract.CanonicalToBridged(&_ERC721Vault.CallOpts, chainId, ctokenAddress)
}

// CanonicalToBridged is a free data retrieval call binding the contract method 0x67090ccf.
//
// Solidity: function canonicalToBridged(uint256 chainId, address ctokenAddress) view returns(address btoken)
func (_ERC721Vault *ERC721VaultCallerSession) CanonicalToBridged(chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	return _ERC721Vault.Contract.CanonicalToBridged(&_ERC721Vault.CallOpts, chainId, ctokenAddress)
}
...
func (_ERC721Vault *ERC721VaultCaller) IsBridgedToken(opts *bind.CallOpts, tokenAddress common.Address) (bool, error) {
	var out []interface{}
	err := _ERC721Vault.contract.Call(opts, &out, "isBridgedToken", tokenAddress)
...
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC721Vault *ERC721VaultSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC721Vault.Contract.IsBridgedToken(&_ERC721Vault.CallOpts, tokenAddress)
}

// IsBridgedToken is a free data retrieval call binding the contract method 0xc287e578.
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC721Vault *ERC721VaultCallerSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC721Vault.Contract.IsBridgedToken(&_ERC721Vault.CallOpts, tokenAddress)
}
...
//
// Solidity: function receiveToken((uint256,address,string,string) ctoken, address from, address to, uint256[] tokenIds) returns()
