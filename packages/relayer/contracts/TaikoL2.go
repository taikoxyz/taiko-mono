...
//
// Solidity: function getConfig() view returns((uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint64,uint64,uint64,uint64,uint64,uint64,uint64,bool) config)
...
func (_TaikoL2 *TaikoL2Caller) LatestSyncedHeader(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "latestSyncedHeader")
...
//
// Solidity: function latestSyncedHeader() view returns(bytes32)
func (_TaikoL2 *TaikoL2Session) LatestSyncedHeader() ([32]byte, error) {
	return _TaikoL2.Contract.LatestSyncedHeader(&_TaikoL2.CallOpts)
}

// LatestSyncedHeader is a free data retrieval call binding the contract method 0xc8d772ab.
//
// Solidity: function latestSyncedHeader() view returns(bytes32)
func (_TaikoL2 *TaikoL2CallerSession) LatestSyncedHeader() ([32]byte, error) {
	return _TaikoL2.Contract.LatestSyncedHeader(&_TaikoL2.CallOpts)
}
...
func (_TaikoL2 *TaikoL2Caller) Resolve(opts *bind.CallOpts, name string) (common.Address, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "resolve", name)
...
//
// Solidity: function resolve(string name) view returns(address)
func (_TaikoL2 *TaikoL2Session) Resolve(name string) (common.Address, error) {
	return _TaikoL2.Contract.Resolve(&_TaikoL2.CallOpts, name)
}

// Resolve is a free data retrieval call binding the contract method 0x461a4478.
//
// Solidity: function resolve(string name) view returns(address)
func (_TaikoL2 *TaikoL2CallerSession) Resolve(name string) (common.Address, error) {
	return _TaikoL2.Contract.Resolve(&_TaikoL2.CallOpts, name)
}
...
func (_TaikoL2 *TaikoL2Caller) Resolve0(opts *bind.CallOpts, chainId *big.Int, name string) (common.Address, error) {
	var out []interface{}
	err := _TaikoL2.contract.Call(opts, &out, "resolve0", chainId, name)
...
//
// Solidity: function resolve(uint256 chainId, string name) view returns(address)
func (_TaikoL2 *TaikoL2Session) Resolve0(chainId *big.Int, name string) (common.Address, error) {
	return _TaikoL2.Contract.Resolve0(&_TaikoL2.CallOpts, chainId, name)
}

// Resolve0 is a free data retrieval call binding the contract method 0xf16c7934.
//
// Solidity: function resolve(uint256 chainId, string name) view returns(address)
func (_TaikoL2 *TaikoL2CallerSession) Resolve0(chainId *big.Int, name string) (common.Address, error) {
	return _TaikoL2.Contract.Resolve0(&_TaikoL2.CallOpts, chainId, name)
}
