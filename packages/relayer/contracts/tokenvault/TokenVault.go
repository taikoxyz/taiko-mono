...
//
// Solidity: function bridgedToCanonical(address bridgedAddress) view returns(uint256 chainId, address addr, uint8 decimals, string symbol, string name)
func (_TokenVault *TokenVaultCaller) BridgedToCanonical(opts *bind.CallOpts, bridgedAddress common.Address) (struct {
	ChainId  *big.Int
	Addr     common.Address
	Decimals uint8
	Symbol   string
	...
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "bridgedToCanonical", bridgedAddress)
...
//
// Solidity: function bridgedToCanonical(address bridgedAddress) view returns(uint256 chainId, address addr, uint8 decimals, string symbol, string name)
func (_TokenVault *TokenVaultSession) BridgedToCanonical(bridgedAddress common.Address) (struct {
	ChainId  *big.Int
	Addr     common.Address
	Decimals uint8
	Symbol   string
	...
	return _TokenVault.Contract.BridgedToCanonical(&_TokenVault.CallOpts, bridgedAddress)
}

// BridgedToCanonical is a free data retrieval call binding the contract method 0x9aa8605c.
//
// Solidity: function bridgedToCanonical(address bridgedAddress) view returns(uint256 chainId, address addr, uint8 decimals, string symbol, string name)
func (_TokenVault *TokenVaultCallerSession) BridgedToCanonical(bridgedAddress common.Address) (struct {
	ChainId  *big.Int
	Addr     common.Address
	Decimals uint8
	Symbol   string
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address bridgedAddress)
func (_TokenVault *TokenVaultCaller) CanonicalToBridged(opts *bind.CallOpts, chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "canonicalToBridged", chainId, canonicalAddress)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address bridgedAddress)
func (_TokenVault *TokenVaultSession) CanonicalToBridged(chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	return _TokenVault.Contract.CanonicalToBridged(&_TokenVault.CallOpts, chainId, canonicalAddress)
}

// CanonicalToBridged is a free data retrieval call binding the contract method 0x67090ccf.
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address bridgedAddress)
func (_TokenVault *TokenVaultCallerSession) CanonicalToBridged(chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	return _TokenVault.Contract.CanonicalToBridged(&_TokenVault.CallOpts, chainId, canonicalAddress)
}

// IsBridgedToken is a free data retrieval call binding the contract method 0xc287e578.
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_TokenVault *TokenVaultCaller) IsBridgedToken(opts *bind.CallOpts, tokenAddress common.Address) (bool, error) {
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "isBridgedToken", tokenAddress)
...
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_TokenVault *TokenVaultSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _TokenVault.Contract.IsBridgedToken(&_TokenVault.CallOpts, tokenAddress)
}

// IsBridgedToken is a free data retrieval call binding the contract method 0xc287e578.
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_TokenVault *TokenVaultCallerSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _TokenVault.Contract.IsBridgedToken(&_TokenVault.CallOpts, tokenAddress)
}

// MessageDeposits is a free data retrieval call binding the contract method 0x780b64f0.
//
// Solidity: function messageDeposits(bytes32 msgHash) view returns(address token, uint256 amount)
func (_TokenVault *TokenVaultCaller) MessageDeposits(opts *bind.CallOpts, msgHash [32]byte) (struct {
	Token  common.Address
	Amount *big.Int
}, error) {
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "messageDeposits", msgHash)
...
//
// Solidity: function messageDeposits(bytes32 msgHash) view returns(address token, uint256 amount)
func (_TokenVault *TokenVaultSession) MessageDeposits(msgHash [32]byte) (struct {
	Token  common.Address
	Amount *big.Int
}, error) {
	return _TokenVault.Contract.MessageDeposits(&_TokenVault.CallOpts, msgHash)
}

// MessageDeposits is a free data retrieval call binding the contract method 0x780b64f0.
//
// Solidity: function messageDeposits(bytes32 msgHash) view returns(address token, uint256 amount)
func (_TokenVault *TokenVaultCallerSession) MessageDeposits(msgHash [32]byte) (struct {
	Token  common.Address
	Amount *big.Int
}, error) {
	return _TokenVault.Contract.MessageDeposits(&_TokenVault.CallOpts, msgHash)
...
func (_TokenVault *TokenVaultCaller) Resolve(opts *bind.CallOpts, chainId *big.Int, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "resolve", chainId, name, allowZeroAddress)
...
//
// Solidity: function resolve(uint256 chainId, bytes32 name, bool allowZeroAddress) view returns(address)
func (_TokenVault *TokenVaultSession) Resolve(chainId *big.Int, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TokenVault.Contract.Resolve(&_TokenVault.CallOpts, chainId, name, allowZeroAddress)
}

// Resolve is a free data retrieval call binding the contract method 0x6c6563f6.
//
// Solidity: function resolve(uint256 chainId, bytes32 name, bool allowZeroAddress) view returns(address)
func (_TokenVault *TokenVaultCallerSession) Resolve(chainId *big.Int, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TokenVault.Contract.Resolve(&_TokenVault.CallOpts, chainId, name, allowZeroAddress)
}
...
func (_TokenVault *TokenVaultCaller) Resolve0(opts *bind.CallOpts, name [32]byte, allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TokenVault.contract.Call(opts, &out, "resolve0", name, allowZeroAddress)
...
//
// Solidity: function resolve(bytes32 name, bool allowZeroAddress) view returns(address)
func (_TokenVault *TokenVaultSession) Resolve0(name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TokenVault.Contract.Resolve0(&_TokenVault.CallOpts, name, allowZeroAddress)
}

// Resolve0 is a free data retrieval call binding the contract method 0xa86f9d9e.
//
// Solidity: function resolve(bytes32 name, bool allowZeroAddress) view returns(address)
func (_TokenVault *TokenVaultCallerSession) Resolve0(name [32]byte, allowZeroAddress bool) (common.Address, error) {
	return _TokenVault.Contract.Resolve0(&_TokenVault.CallOpts, name, allowZeroAddress)
}
...
func (_TokenVault *TokenVaultTransactor) SetAddressManager(opts *bind.TransactOpts, newAddressManager common.Address) (*types.Transaction, error) {
	return _TokenVault.contract.Transact(opts, "setAddressManager", newAddressManager)
}

// SetAddressManager is a paid mutator transaction binding the contract method 0x0652b57a.
//
// Solidity: function setAddressManager(address newAddressManager) returns()
func (_TokenVault *TokenVaultSession) SetAddressManager(newAddressManager common.Address) (*types.Transaction, error) {
	return _TokenVault.Contract.SetAddressManager(&_TokenVault.TransactOpts, newAddressManager)
}

// SetAddressManager is a paid mutator transaction binding the contract method 0x0652b57a.
//
// Solidity: function setAddressManager(address newAddressManager) returns()
func (_TokenVault *TokenVaultTransactorSession) SetAddressManager(newAddressManager common.Address) (*types.Transaction, error) {
	return _TokenVault.Contract.SetAddressManager(&_TokenVault.TransactOpts, newAddressManager)
}
...
// TokenVaultAddressManagerChangedIterator is returned from FilterAddressManagerChanged and is used to iterate over the raw logs and unpacked data for AddressManagerChanged events raised by the TokenVault contract.
type TokenVaultAddressManagerChangedIterator struct {
	Event *TokenVaultAddressManagerChanged // Event containing the contract specifics and raw log
...
func (it *TokenVaultAddressManagerChangedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenVaultAddressManagerChanged)
...
func (it *TokenVaultAddressManagerChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenVaultAddressManagerChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenVaultAddressManagerChanged represents a AddressManagerChanged event raised by the TokenVault contract.
type TokenVaultAddressManagerChanged struct {
...
func (_TokenVault *TokenVaultFilterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*TokenVaultAddressManagerChangedIterator, error) {

	logs, sub, err := _TokenVault.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
	return &TokenVaultAddressManagerChangedIterator{contract: _TokenVault.contract, event: "AddressManagerChanged", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_TokenVault *TokenVaultFilterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *TokenVaultAddressManagerChanged) (event.Subscription, error) {

	logs, sub, err := _TokenVault.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(TokenVaultAddressManagerChanged)
				if err := _TokenVault.contract.UnpackLog(event, "AddressManagerChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_TokenVault *TokenVaultFilterer) ParseAddressManagerChanged(log types.Log) (*TokenVaultAddressManagerChanged, error) {
	event := new(TokenVaultAddressManagerChanged)
	if err := _TokenVault.contract.UnpackLog(event, "AddressManagerChanged", log); err != nil {
		return nil, err
	}
