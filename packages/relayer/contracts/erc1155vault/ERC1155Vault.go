...
//
// Solidity: function bridgedToCanonical(address btoken) view returns(uint256 chainId, address addr, string symbol, string name)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address ctokenAddress) view returns(address btoken)
func (_ERC1155Vault *ERC1155VaultCaller) CanonicalToBridged(opts *bind.CallOpts, chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _ERC1155Vault.contract.Call(opts, &out, "canonicalToBridged", chainId, ctokenAddress)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address ctokenAddress) view returns(address btoken)
func (_ERC1155Vault *ERC1155VaultSession) CanonicalToBridged(chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	return _ERC1155Vault.Contract.CanonicalToBridged(&_ERC1155Vault.CallOpts, chainId, ctokenAddress)
}

// CanonicalToBridged is a free data retrieval call binding the contract method 0x67090ccf.
//
// Solidity: function canonicalToBridged(uint256 chainId, address ctokenAddress) view returns(address btoken)
func (_ERC1155Vault *ERC1155VaultCallerSession) CanonicalToBridged(chainId *big.Int, ctokenAddress common.Address) (common.Address, error) {
	return _ERC1155Vault.Contract.CanonicalToBridged(&_ERC1155Vault.CallOpts, chainId, ctokenAddress)
}
...
func (_ERC1155Vault *ERC1155VaultCaller) IsBridgedToken(opts *bind.CallOpts, tokenAddress common.Address) (bool, error) {
	var out []interface{}
	err := _ERC1155Vault.contract.Call(opts, &out, "isBridgedToken", tokenAddress)
...
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC1155Vault *ERC1155VaultSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC1155Vault.Contract.IsBridgedToken(&_ERC1155Vault.CallOpts, tokenAddress)
}

// IsBridgedToken is a free data retrieval call binding the contract method 0xc287e578.
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC1155Vault *ERC1155VaultCallerSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC1155Vault.Contract.IsBridgedToken(&_ERC1155Vault.CallOpts, tokenAddress)
}
...
//
// Solidity: function receiveToken((uint256,address,string,string) ctoken, address from, address to, uint256[] tokenIds, uint256[] amounts) returns()
