...
// GetBasefee is a free data retrieval call binding the contract method 0xc20ebea5.
//
// Solidity: function getBasefee(uint32 timeSinceParent, uint32 gasLimit, uint32 parentGasUsed) view returns(uint256 _basefee)
func (_TaikoL2 *TaikoL2Caller) GetBasefee(opts *bind.CallOpts, timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getBasefee(uint32 timeSinceParent, uint32 gasLimit, uint32 parentGasUsed) view returns(uint256 _basefee)
func (_TaikoL2 *TaikoL2Session) GetBasefee(timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
...
//
// Solidity: function getBasefee(uint32 timeSinceParent, uint32 gasLimit, uint32 parentGasUsed) view returns(uint256 _basefee)
func (_TaikoL2 *TaikoL2CallerSession) GetBasefee(timeSinceParent uint32, gasLimit uint32, parentGasUsed uint32) (*big.Int, error) {
	return _TaikoL2.Contract.GetBasefee(&_TaikoL2.CallOpts, timeSinceParent, gasLimit, parentGasUsed)
}
...
func (_TaikoL2 *TaikoL2Filterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*TaikoL2AddressManagerChangedIterator, error) {

	logs, sub, err := _TaikoL2.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_TaikoL2 *TaikoL2Filterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *TaikoL2AddressManagerChanged) (event.Subscription, error) {

	logs, sub, err := _TaikoL2.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
