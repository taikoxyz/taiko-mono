...
//
// Solidity: function bridgedToCanonical(address btoken) view returns(uint256 chainId, address addr, uint8 decimals, string symbol, string name)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address btoken)
func (_ERC20Vault *ERC20VaultCaller) CanonicalToBridged(opts *bind.CallOpts, chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	var out []interface{}
	err := _ERC20Vault.contract.Call(opts, &out, "canonicalToBridged", chainId, canonicalAddress)
...
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address btoken)
func (_ERC20Vault *ERC20VaultSession) CanonicalToBridged(chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	return _ERC20Vault.Contract.CanonicalToBridged(&_ERC20Vault.CallOpts, chainId, canonicalAddress)
}

// CanonicalToBridged is a free data retrieval call binding the contract method 0x67090ccf.
//
// Solidity: function canonicalToBridged(uint256 chainId, address canonicalAddress) view returns(address btoken)
func (_ERC20Vault *ERC20VaultCallerSession) CanonicalToBridged(chainId *big.Int, canonicalAddress common.Address) (common.Address, error) {
	return _ERC20Vault.Contract.CanonicalToBridged(&_ERC20Vault.CallOpts, chainId, canonicalAddress)
}
...
func (_ERC20Vault *ERC20VaultCaller) IsBridgedToken(opts *bind.CallOpts, tokenAddress common.Address) (bool, error) {
	var out []interface{}
	err := _ERC20Vault.contract.Call(opts, &out, "isBridgedToken", tokenAddress)
...
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC20Vault *ERC20VaultSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC20Vault.Contract.IsBridgedToken(&_ERC20Vault.CallOpts, tokenAddress)
}

// IsBridgedToken is a free data retrieval call binding the contract method 0xc287e578.
//
// Solidity: function isBridgedToken(address tokenAddress) view returns(bool isBridged)
func (_ERC20Vault *ERC20VaultCallerSession) IsBridgedToken(tokenAddress common.Address) (bool, error) {
	return _ERC20Vault.Contract.IsBridgedToken(&_ERC20Vault.CallOpts, tokenAddress)
}
...
// ReleasedMessages is a free data retrieval call binding the contract method 0x219b8ab4.
//
// Solidity: function releasedMessages(bytes32 msgHash) view returns(bool released)
func (_ERC20Vault *ERC20VaultCaller) ReleasedMessages(opts *bind.CallOpts, msgHash [32]byte) (bool, error) {
	var out []interface{}
	err := _ERC20Vault.contract.Call(opts, &out, "releasedMessages", msgHash)
...
//
// Solidity: function releasedMessages(bytes32 msgHash) view returns(bool released)
func (_ERC20Vault *ERC20VaultSession) ReleasedMessages(msgHash [32]byte) (bool, error) {
	return _ERC20Vault.Contract.ReleasedMessages(&_ERC20Vault.CallOpts, msgHash)
}

// ReleasedMessages is a free data retrieval call binding the contract method 0x219b8ab4.
//
// Solidity: function releasedMessages(bytes32 msgHash) view returns(bool released)
func (_ERC20Vault *ERC20VaultCallerSession) ReleasedMessages(msgHash [32]byte) (bool, error) {
	return _ERC20Vault.Contract.ReleasedMessages(&_ERC20Vault.CallOpts, msgHash)
}
...
//
// Solidity: function receiveToken((uint256,address,uint8,string,string) ctoken, address from, address to, uint256 amount) returns()
...
// ReleaseToken is a paid mutator transaction binding the contract method 0xdc0eb5ce.
//
// Solidity: function releaseToken((uint256,address,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,bytes,string) message, bytes proof) returns()
func (_ERC20Vault *ERC20VaultTransactor) ReleaseToken(opts *bind.TransactOpts, message IBridgeMessage, proof []byte) (*types.Transaction, error) {
	return _ERC20Vault.contract.Transact(opts, "releaseToken", message, proof)
}

// ReleaseToken is a paid mutator transaction binding the contract method 0xdc0eb5ce.
//
// Solidity: function releaseToken((uint256,address,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,bytes,string) message, bytes proof) returns()
func (_ERC20Vault *ERC20VaultSession) ReleaseToken(message IBridgeMessage, proof []byte) (*types.Transaction, error) {
	return _ERC20Vault.Contract.ReleaseToken(&_ERC20Vault.TransactOpts, message, proof)
}

// ReleaseToken is a paid mutator transaction binding the contract method 0xdc0eb5ce.
//
// Solidity: function releaseToken((uint256,address,uint256,uint256,address,address,address,uint256,uint256,uint256,uint256,bytes,string) message, bytes proof) returns()
func (_ERC20Vault *ERC20VaultTransactorSession) ReleaseToken(message IBridgeMessage, proof []byte) (*types.Transaction, error) {
	return _ERC20Vault.Contract.ReleaseToken(&_ERC20Vault.TransactOpts, message, proof)
}
...
func (_ERC20Vault *ERC20VaultFilterer) FilterAddressManagerChanged(opts *bind.FilterOpts) (*ERC20VaultAddressManagerChangedIterator, error) {

	logs, sub, err := _ERC20Vault.contract.FilterLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event AddressManagerChanged(address addressManager)
func (_ERC20Vault *ERC20VaultFilterer) WatchAddressManagerChanged(opts *bind.WatchOpts, sink chan<- *ERC20VaultAddressManagerChanged) (event.Subscription, error) {

	logs, sub, err := _ERC20Vault.contract.WatchLogs(opts, "AddressManagerChanged")
	if err != nil {
		return nil, err
	}
