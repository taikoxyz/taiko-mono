...
func (_TaikoL1 *TaikoL1Caller) GetProposedBlock(opts *bind.CallOpts, id *big.Int) (LibDataProposedBlock, error) {
	var out []interface{}
...
//
// Solidity: function getProposedBlock(uint256 id) view returns((bytes32))
func (_TaikoL1 *TaikoL1Session) GetProposedBlock(id *big.Int) (LibDataProposedBlock, error) {
...
//
// Solidity: function getProposedBlock(uint256 id) view returns((bytes32))
func (_TaikoL1 *TaikoL1CallerSession) GetProposedBlock(id *big.Int) (LibDataProposedBlock, error) {
	return _TaikoL1.Contract.GetProposedBlock(&_TaikoL1.CallOpts, id)
}
