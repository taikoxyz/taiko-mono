...
To deploy on Taiko, you would need some ETH on Taiko.

You can get some Taiko ETH by bridging from Sepolia ETH to Taiko [here](https://bridge.test.taiko.xyz/).

## Taiko brand assets

Find our official Taiko brainding assets [here](https://github.com/taikoxyz/taiko-mono/tree/main/packages/branding).
