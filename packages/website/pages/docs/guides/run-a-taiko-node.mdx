...
<Tabs items={["Local", "Alchemy", "Infura", "Chainstack"]} defaultIndex="0">
  <Tab>
...
![get WSS endpoints](/images/guides/infura/wss-endpoints.png)
  ...
  <Tab>
  First, sign in to [Chainstack](https://chainstack.com/).
  ![Chainstack console sign in](/images/guides/chainstack/sign-in.png)

Next, click to "Get started" to create a new project:
![Chainstack console](/images/guides/chainstack/get-started.png)

Next, configure your project:

- For "Project name", enter "Taiko Node", or your preferred name.
- For "Type", select "Public chain".


Then, click the "Create" button.
![create a Chainstack project](/images/guides/chainstack/create-project.png)

Now, open the project and click "Get started" to join a new network.

- Choose "Ethereum" under the "Blockchain protocol".
- Choose "Ethereum Sepolia Testnet" under the "Network".

Then, click "Next".
![Join a network](/images/guides/chainstack/join-network.png)

Next, configure the node:

- Keep the parameters as default.
- Choose the location.
- Name the node "Taiko node", or your preferred name.

Then, click "Next", check the node configuration and click "Join Network".
![Deploy a node](/images/guides/chainstack/node-summary.png)

The Sepolia node will be deployed to your console. Click on it and scroll down to access the endpoints.
![Node credentials](/images/guides/chainstack/node-credentials.png)

- The **Execution client HTTPS endpoint** is your `L1_ENDPOINT_HTTP`.

- The **Execution client WSS endpoint** is your `L1_ENDPOINT_WS`.
</Tab>
</Tabs>
