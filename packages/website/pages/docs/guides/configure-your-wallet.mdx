...
This guide help you connect your wallet to Taiko (Grímsvötn testnet). There are two networks to configure your wallet with: Ethereum (Sepolia testnet) and Taiko (Grímsvötn testnet).
