...
Click the text field for `depositTaikoToken` and enter the amount of TTKO you would like to deposit followed by 8 zeroes.
...
<Callout type="note">
  ...
  Status page see: [L2 Protocol Status](https://status.test.taiko.xyz). Insufficient
...
<Callout type="warning">
  ...
  stored in plain text in the `.env` file, and this is not secure.
...
- [Enable a proposer on your Taiko L2 node](https://www.youtube.com/watch?v=z3gWKEoJidw)
