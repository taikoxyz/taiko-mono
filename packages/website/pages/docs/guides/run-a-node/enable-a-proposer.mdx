...
<Callout type="note">
  For accurate deposit amounts, refer to the Block Fee on the L2/L3 Protocol Status page (see: [L2 Protocol Status](https://status.test.taiko.xyz), [L3 Protocol Status](https://explorer.l3test.taiko.xyz/stats)).
