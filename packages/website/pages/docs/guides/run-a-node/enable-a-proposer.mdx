...
- If you are depositing **TTKO**, you can find the link here under [Sepolia L1 based contracts](https://taiko.xyz/docs/reference/contract-addresses#based-contracts).
- If you are depositing **TTKOe**, you can find the link here under [Grimsvotn L2 based contracts](https://taiko.xyz/docs/reference/contract-addresses#based-contracts-1).
