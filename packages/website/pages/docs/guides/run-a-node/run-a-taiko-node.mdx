...
<Callout>
  If you ran a testnet node previously make sure to first run a `docker compose
  ...
  local grafana dashboard and see the latest L2 chain status in the [Taiko block
