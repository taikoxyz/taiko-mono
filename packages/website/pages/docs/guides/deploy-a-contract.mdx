...
These steps will show you how to deploy a smart contract to Taiko using Foundry.

## Prerequisites

- [Install Foundry](https://book.getfoundry.sh/getting-started/installation)
- Have the private key handy to an account that has testnet ETH on Taiko (to pay the transaction fee for deploying the contract)
...
- Have some testnet ETH on Taiko:
   - First, [request Sepolia ETH](/guides/request-from-faucet) from the faucet
