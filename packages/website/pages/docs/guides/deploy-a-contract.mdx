...
<Tabs items={["Remix", "Foundry", "Hardhat", "Thirdweb"]} defaultIndex="0">
  ...
  <Tab>
      **1. Deploy your smart contract using Thirdweb**
      ...
      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb1.png)

      Don't forget to name your project : for example "thirtwebtaiko"

      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb2.png)

      Project structure :

      After initialization, your project will have the following default structure:

      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb3.png)
      ...
      npm i thirdweb
      ```
      Create a new file "MyTestContract.sol" in the "Contracts" folder, as shown in the screenshot above.

      If you want to use the CLI : 
      
      Copy code : nano contracts/MyTestContract.sol

      Open "MyTestContract" an write your contract inside
      ...
      **2. Dashboard interface**
      ...
      ![Deploy interface](/images/guides/deploy-thirdweb/thirdweb4.png)
      
      Fill in the "Unlock Time" (or "_unlockTime") attribute, which represents a period of time in seconds. 
      1 minute would be represented by 60 seconds,
      1 hour would be represented by 3600 seconds,
      1 day would be represented by 86400 seconds.
