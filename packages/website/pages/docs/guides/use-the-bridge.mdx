...
This guide will help you use the bridge to send tokens between Sepolia and Taiko (Alpha-3 testnet). You can read more about how bridging works [here](https://taiko.xyz/docs/concepts/bridging).
