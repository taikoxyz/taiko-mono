...
Click `depositTaikoToken` and enter the amount of TTKO you would like to deposit. **Make sure** to click the plus sign and add `10^8` decimals, or add 8 zeroes manually.
