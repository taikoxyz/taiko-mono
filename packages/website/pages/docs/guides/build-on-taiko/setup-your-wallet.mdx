...
<Steps>
    ...
    You can also connect to Sepolia at [Sepolia RPC configuration](/docs/reference/rpc-configuration).

    ### Add the Taiko testnet
    Search for "Taiko", and click the "Add Chain" button for Taiko (Alpha-3 testnet).
        
    You can also connect to Taiko at [Taiko RPC configuration](/docs/reference/rpc-configuration).
