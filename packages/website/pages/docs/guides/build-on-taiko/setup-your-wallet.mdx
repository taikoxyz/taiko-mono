...
You may have transactions stuck in Metamask as "pending" but they don't exist in the mempool anymore. This is a known issue with Metamask. You can try to fix it by following these steps:

1. Go to Settings > Advanced > Clear activity and nonce data
