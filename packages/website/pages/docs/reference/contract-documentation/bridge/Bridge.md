...
This contract is a Bridge contract which is deployed on both L1 and L2. Mostly a thin wrapper
...
_Sends a message by calling the LibBridgeSend.sendMessage library function._
...
_Releases the Ether by calling the LibBridgeRelease.releaseEther library function._
...
_Processes the message by calling the LibBridgeProcess.processMessage library function._
...
_Retries the message by calling the LibBridgeRetry.retryMessage library function._
