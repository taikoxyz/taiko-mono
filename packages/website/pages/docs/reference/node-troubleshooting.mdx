...
You have not deposit enough TKO to pay the block fee. Deposit enough TKO from TKO token contracts. See [enable a proposer](/docs/guides/run-a-node/enable-a-proposer) for more info.
