...
The RPC in your config is wrong. You have to set the ENDPOINT correctly. Please refer to the following page to set the correct RPC https://taiko.xyz/docs/guides/run-a-node/run-a-taiko-node
