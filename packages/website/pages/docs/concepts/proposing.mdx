...
> Note: This is a temporary solution which may change soon, as we see an issue that can arise where the proposer will submit empty blocks to earn the reward.
