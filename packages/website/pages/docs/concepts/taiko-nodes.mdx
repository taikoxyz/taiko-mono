...
<center>
    <Image src="/images/diagrams/concepts/taiko-nodes/taiko-nodes.png" alt="taiko nodes diagram" width={400} height={400} />
</center>
...
The `proposer` proposes new transactions from the L2 execution engine's transaction pool to the `TaikoL1` protocol contract.
