...
ERC-20 contracts exist on either chain, the canonical chain or the bridged one. In order to send a token and bridge it to the other chain, a new BridgedERC20 contract needs to be deployed on the destination chain.

For example the HORSE token's canonical chain is Ethereum A1: https://l1explorer.a1.taiko.xyz/address/0x3E3a3416DbCc5cb4448B6b171fF15f9Da35Ab72d. So to enable sending it to Taiko A1, we need to deploy the BridgedERC20 contract for it, which can be found here: https://l2explorer.a1.taiko.xyz/address/0xb8eA36284d1Fa062cc0c969E28a49f3531cFB1bf.
