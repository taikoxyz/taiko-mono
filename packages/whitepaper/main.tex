...
$$\boldsymbol{\sigma} \equiv (\boldsymbol{\delta}, h[1..256], d, \boldsymbol{\theta}, i)$$
...
\begin{eqnarray}
B & \equiv & (H, T, U), \\
\nonumber & \equiv &  M(\boldsymbol{\delta}, h[1..256], {d}, \boldsymbol{\theta}, \bar{B}, )  \\
\nonumber & \equiv & M(\boldsymbol{\delta}, h[1..256], {d}, \boldsymbol{\theta}, C, L)
\end{eqnarray}
...
& & \texttt{NUMBER} \equiv {i} \quad \wedge \\
\nonumber& & U \equiv [] \quad \wedge \\
\nonumber& & T \equiv \boldsymbol{\theta}::F(\texttt{RLP}'(L), V^t) \quad \wedge  \\
\nonumber& & H_p \equiv h(1) \quad \wedge \\
\nonumber& & H_o \equiv  K_{\mathrm{ommershash}} \quad \wedge \\
\nonumber& & H_c \equiv  C_c \quad \wedge \\
\nonumber& & H_d \equiv  0 \quad \wedge \\
\nonumber& & H_i \equiv  i \quad \wedge \\
\nonumber& & H_l \equiv  C_l + K_{\mathrm{anchorgas}} \quad \wedge \\
\nonumber& & H_s \equiv  C_s \quad \wedge \\
\nonumber& & H_x \equiv  C_x \quad \wedge \\
\nonumber& & H_m \equiv  C_m \quad \wedge \\
\nonumber& & (H_r, H_t, H_e, H_l, H_g) \equiv  \Pi(\boldsymbol{\sigma}, (T_0, T_1, ...))
\end{eqnarray}
