...
# Preconf p2p variables.
export PRECONFIRMATION_P2P_DISCOVERY_PATH=memory
export PRECONFIRMATION_P2P_PEERSTORE_PATH=memory
export PRECONFIRMATION_P2P_PRIV_RAW=0x3eafc84ef242d517ca50dc69b3f020579b403a454e2f9c5bec1c72c0061cee44
export PRECONFIRMATION_P2P_SEQUENCER_KEY=$L1_PROPOSER_PRIV_KEY
export PRECONFIRMATION_P2P_NO_DISCOVERY=true
