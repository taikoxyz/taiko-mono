...
L2_HTTP=$L2_HTTP
L2_WS=$L2_WS
L2_AUTH=$L2_EXECUTION_ENGINE_AUTH_ENDPOINT
...
GUARDIAN_PROVER_CONTRACT=$GUARDIAN_PROVER_CONTRACT_ADDRESS
GUARDIAN_PROVER_MINORITY=$GUARDIAN_PROVER_MINORITY_ADDRESS
