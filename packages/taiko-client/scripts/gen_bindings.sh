...
cat /Users/davidcai/Workspace/taiko-mono-shasta/packages/protocol/out/layer1/Codec.sol/Codec.json |
	jq .abi |
	${ABIGEN_BIN} --abi - --type CodecClient --pkg ${FORK} --out $DIR/../bindings/${FORK}/gen_shasta_inbox_codec.go
