...
//
// Solidity: function getConfig() pure returns((uint64,uint64,uint64,uint64,uint32,uint96,uint8,bool))
...
//
// Solidity: function proposeBlock(bytes _params, bytes _txList) payable returns((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta_, (address,uint96,uint64)[] deposits_)
...
// FilterBlockProposed is a free log retrieval operation binding the contract event 0xa22a97e467a8db9aa4157bf625ed2641a80e72756ba516767d81f732cd8bc387.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta, (address,uint96,uint64)[] depositsProcessed)
...
// WatchBlockProposed is a free log subscription operation binding the contract event 0xa22a97e467a8db9aa4157bf625ed2641a80e72756ba516767d81f732cd8bc387.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta, (address,uint96,uint64)[] depositsProcessed)
...
// ParseBlockProposed is a log parse operation binding the contract event 0xa22a97e467a8db9aa4157bf625ed2641a80e72756ba516767d81f732cd8bc387.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta, (address,uint96,uint64)[] depositsProcessed)
...
// FilterBlockProposed0 is a free log retrieval operation binding the contract event 0x24227b38f01ef1cc88d5a6fdd74e4ef992b2ecb7eede3d8e4418e758bb25b4c6.
//
...
// WatchBlockProposed0 is a free log subscription operation binding the contract event 0x24227b38f01ef1cc88d5a6fdd74e4ef992b2ecb7eede3d8e4418e758bb25b4c6.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta, (address,uint96,uint64)[] depositsProcessed, uint32 blobTxListOffset, uint32 blobTxListLength, uint8 blobIndex)
...
// ParseBlockProposed0 is a log parse operation binding the contract event 0x24227b38f01ef1cc88d5a6fdd74e4ef992b2ecb7eede3d8e4418e758bb25b4c6.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint32,uint32) meta, (address,uint96,uint64)[] depositsProcessed, uint32 blobTxListOffset, uint32 blobTxListLength, uint8 blobIndex)
