...
// ProposeBlock is a paid mutator transaction binding the contract method 0x72b6347b.
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta_, (address,uint96,uint64)[] deposits_)
func (_TaikoL1Client *TaikoL1ClientTransactor) ProposeBlock(opts *bind.TransactOpts, _params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _TaikoL1Client.contract.Transact(opts, "proposeBlock", _params, _txLists)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x72b6347b.
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta_, (address,uint96,uint64)[] deposits_)
func (_TaikoL1Client *TaikoL1ClientSession) ProposeBlock(_params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.ProposeBlock(&_TaikoL1Client.TransactOpts, _params, _txLists)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x72b6347b.
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns((bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta_, (address,uint96,uint64)[] deposits_)
func (_TaikoL1Client *TaikoL1ClientTransactorSession) ProposeBlock(_params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _TaikoL1Client.Contract.ProposeBlock(&_TaikoL1Client.TransactOpts, _params, _txLists)
}
...
// FilterBlockProposed is a free log retrieval operation binding the contract event 0x2067c6532d2d38d837634fde6a9a1687f8e50c01b809ecb4225c89b7476e54dc.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta, (address,uint96,uint64)[] depositsProcessed)
...
// WatchBlockProposed is a free log subscription operation binding the contract event 0x2067c6532d2d38d837634fde6a9a1687f8e50c01b809ecb4225c89b7476e54dc.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta, (address,uint96,uint64)[] depositsProcessed)
...
// ParseBlockProposed is a log parse operation binding the contract event 0x2067c6532d2d38d837634fde6a9a1687f8e50c01b809ecb4225c89b7476e54dc.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta, (address,uint96,uint64)[] depositsProcessed)
...
// FilterBlockProposed0 is a free log retrieval operation binding the contract event 0xf95afe1ce01cb67c6b4d3d85fe277ec84347cc91a5a205f9e1854419f0ddcacf.
//
...
// WatchBlockProposed0 is a free log subscription operation binding the contract event 0xf95afe1ce01cb67c6b4d3d85fe277ec84347cc91a5a205f9e1854419f0ddcacf.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta, (address,uint96,uint64)[] depositsProcessed, uint64 blobTxListOffset, uint64 blobTxListLength, uint8 blobIndex)
...
// ParseBlockProposed0 is a log parse operation binding the contract event 0xf95afe1ce01cb67c6b4d3d85fe277ec84347cc91a5a205f9e1854419f0ddcacf.
//
// Solidity: event BlockProposed(uint256 indexed blockId, address indexed assignedProver, uint96 livenessBond, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint64,uint64,uint8) meta, (address,uint96,uint64)[] depositsProcessed, uint64 blobTxListOffset, uint64 blobTxListLength, uint8 blobIndex)
