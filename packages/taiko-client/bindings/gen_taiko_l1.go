...
func (_TaikoL1Client *TaikoL1ClientCaller) GetTransitions(opts *bind.CallOpts, _blockIds []uint64, _tids []uint32) ([]TaikoDataTransitionState, error) {
	var out []interface{}
	err := _TaikoL1Client.contract.Call(opts, &out, "getTransitions", _blockIds, _tids)
...
//
// Solidity: function getTransitions(uint64[] _blockIds, uint32[] _tids) view returns((bytes32,bytes32,bytes32,address,uint96,address,uint96,uint64,uint16,uint8)[])
func (_TaikoL1Client *TaikoL1ClientSession) GetTransitions(_blockIds []uint64, _tids []uint32) ([]TaikoDataTransitionState, error) {
	return _TaikoL1Client.Contract.GetTransitions(&_TaikoL1Client.CallOpts, _blockIds, _tids)
}

// GetTransitions is a free data retrieval call binding the contract method 0xaf2ba709.
//
// Solidity: function getTransitions(uint64[] _blockIds, uint32[] _tids) view returns((bytes32,bytes32,bytes32,address,uint96,address,uint96,uint64,uint16,uint8)[])
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetTransitions(_blockIds []uint64, _tids []uint32) ([]TaikoDataTransitionState, error) {
	return _TaikoL1Client.Contract.GetTransitions(&_TaikoL1Client.CallOpts, _blockIds, _tids)
}
...
func (_TaikoL1Client *TaikoL1ClientCaller) GetTransitions0(opts *bind.CallOpts, _blockIds []uint64, _parentHashes [][32]byte) ([]TaikoDataTransitionState, error) {
	var out []interface{}
	err := _TaikoL1Client.contract.Call(opts, &out, "getTransitions0", _blockIds, _parentHashes)
...
//
// Solidity: function getTransitions(uint64[] _blockIds, bytes32[] _parentHashes) view returns((bytes32,bytes32,bytes32,address,uint96,address,uint96,uint64,uint16,uint8)[])
func (_TaikoL1Client *TaikoL1ClientSession) GetTransitions0(_blockIds []uint64, _parentHashes [][32]byte) ([]TaikoDataTransitionState, error) {
	return _TaikoL1Client.Contract.GetTransitions0(&_TaikoL1Client.CallOpts, _blockIds, _parentHashes)
}

// GetTransitions0 is a free data retrieval call binding the contract method 0xb89c61bc.
//
// Solidity: function getTransitions(uint64[] _blockIds, bytes32[] _parentHashes) view returns((bytes32,bytes32,bytes32,address,uint96,address,uint96,uint64,uint16,uint8)[])
func (_TaikoL1Client *TaikoL1ClientCallerSession) GetTransitions0(_blockIds []uint64, _parentHashes [][32]byte) ([]TaikoDataTransitionState, error) {
	return _TaikoL1Client.Contract.GetTransitions0(&_TaikoL1Client.CallOpts, _blockIds, _parentHashes)
}
