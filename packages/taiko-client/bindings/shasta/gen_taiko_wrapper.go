...
func (_TaikoWrapperClient *TaikoWrapperClientCaller) PendingOwner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TaikoWrapperClient.contract.Call(opts, &out, "pendingOwner")
...
func (_TaikoWrapperClient *TaikoWrapperClientSession) PendingOwner() (common.Address, error) {
	return _TaikoWrapperClient.Contract.PendingOwner(&_TaikoWrapperClient.CallOpts)
}
...
func (_TaikoWrapperClient *TaikoWrapperClientTransactor) AcceptOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _TaikoWrapperClient.contract.Transact(opts, "acceptOwnership")
}
...
func (_TaikoWrapperClient *TaikoWrapperClientSession) AcceptOwnership() (*types.Transaction, error) {
	return _TaikoWrapperClient.Contract.AcceptOwnership(&_TaikoWrapperClient.TransactOpts)
}
...
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_TaikoWrapperClient *TaikoWrapperClientTransactor) V4ProposeBatch(opts *bind.TransactOpts, _params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoWrapperClient.contract.Transact(opts, "v4ProposeBatch", _params, _txList, arg2)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_TaikoWrapperClient *TaikoWrapperClientSession) V4ProposeBatch(_params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoWrapperClient.Contract.V4ProposeBatch(&_TaikoWrapperClient.TransactOpts, _params, _txList, arg2)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_TaikoWrapperClient *TaikoWrapperClientTransactorSession) V4ProposeBatch(_params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoWrapperClient.Contract.V4ProposeBatch(&_TaikoWrapperClient.TransactOpts, _params, _txList, arg2)
}
...
type TaikoWrapperClientOwnershipTransferStartedIterator struct {
	Event *TaikoWrapperClientOwnershipTransferStarted // Event containing the contract specifics and raw log
...
func (it *TaikoWrapperClientOwnershipTransferStartedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoWrapperClientOwnershipTransferStarted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type TaikoWrapperClientOwnershipTransferStarted struct {
...
func (_TaikoWrapperClient *TaikoWrapperClientFilterer) FilterOwnershipTransferStarted(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*TaikoWrapperClientOwnershipTransferStartedIterator, error) {
	...
	logs, sub, err := _TaikoWrapperClient.contract.FilterLogs(opts, "OwnershipTransferStarted", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &TaikoWrapperClientOwnershipTransferStartedIterator{contract: _TaikoWrapperClient.contract, event: "OwnershipTransferStarted", logs: logs, sub: sub}, nil
}
...
func (_TaikoWrapperClient *TaikoWrapperClientFilterer) WatchOwnershipTransferStarted(opts *bind.WatchOpts, sink chan<- *TaikoWrapperClientOwnershipTransferStarted, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TaikoWrapperClient.contract.WatchLogs(opts, "OwnershipTransferStarted", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoWrapperClientOwnershipTransferStarted)
				if err := _TaikoWrapperClient.contract.UnpackLog(event, "OwnershipTransferStarted", log); err != nil {
					return err
				}
				event.Raw = log
