...
func (_ShastaAnchor *ShastaAnchorCaller) BlockHashes(opts *bind.CallOpts, arg0 *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _ShastaAnchor.contract.Call(opts, &out, "blockHashes", arg0)
...
//
// Solidity: function blockHashes(uint256 ) view returns(bytes32)
func (_ShastaAnchor *ShastaAnchorSession) BlockHashes(arg0 *big.Int) ([32]byte, error) {
	return _ShastaAnchor.Contract.BlockHashes(&_ShastaAnchor.CallOpts, arg0)
}

// BlockHashes is a free data retrieval call binding the contract method 0x34cdf78d.
//
// Solidity: function blockHashes(uint256 ) view returns(bytes32)
func (_ShastaAnchor *ShastaAnchorCallerSession) BlockHashes(arg0 *big.Int) ([32]byte, error) {
	return _ShastaAnchor.Contract.BlockHashes(&_ShastaAnchor.CallOpts, arg0)
}
