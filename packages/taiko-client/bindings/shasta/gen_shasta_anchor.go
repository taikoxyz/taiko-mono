...
//
// Solidity: function getState() view returns((bytes32,uint48,address,bool))
...
func (_ShastaAnchor *ShastaAnchorCaller) LastSyncedBlock(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ShastaAnchor.contract.Call(opts, &out, "lastSyncedBlock")
...
//
// Solidity: function lastSyncedBlock() view returns(uint64)
func (_ShastaAnchor *ShastaAnchorSession) LastSyncedBlock() (uint64, error) {
	return _ShastaAnchor.Contract.LastSyncedBlock(&_ShastaAnchor.CallOpts)
}

// LastSyncedBlock is a free data retrieval call binding the contract method 0x33d5ac9b.
//
// Solidity: function lastSyncedBlock() view returns(uint64)
func (_ShastaAnchor *ShastaAnchorCallerSession) LastSyncedBlock() (uint64, error) {
	return _ShastaAnchor.Contract.LastSyncedBlock(&_ShastaAnchor.CallOpts)
}
...
// SyncedBlockManager is a free data retrieval call binding the contract method 0x1076871e.
//
// Solidity: function syncedBlockManager() view returns(address)
func (_ShastaAnchor *ShastaAnchorCaller) SyncedBlockManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ShastaAnchor.contract.Call(opts, &out, "syncedBlockManager")
...
//
// Solidity: function syncedBlockManager() view returns(address)
func (_ShastaAnchor *ShastaAnchorSession) SyncedBlockManager() (common.Address, error) {
	return _ShastaAnchor.Contract.SyncedBlockManager(&_ShastaAnchor.CallOpts)
}

// SyncedBlockManager is a free data retrieval call binding the contract method 0x1076871e.
//
// Solidity: function syncedBlockManager() view returns(address)
func (_ShastaAnchor *ShastaAnchorCallerSession) SyncedBlockManager() (common.Address, error) {
	return _ShastaAnchor.Contract.SyncedBlockManager(&_ShastaAnchor.CallOpts)
}
...
// UpdateState is a paid mutator transaction binding the contract method 0xbe065231.
//
// Solidity: function updateState(uint48 _proposalId, address _proposer, bytes _proverAuth, bytes32 _bondInstructionsHash, (uint48,uint8,address,address)[] _bondInstructions, uint16 _blockIndex, uint48 _anchorBlockNumber, bytes32 _anchorBlockHash, bytes32 _anchorStateRoot) returns(bool isLowBondProposal_, address designatedProver_)
func (_ShastaAnchor *ShastaAnchorTransactor) UpdateState(opts *bind.TransactOpts, _proposalId *big.Int, _proposer common.Address, _proverAuth []byte, _bondInstructionsHash [32]byte, _bondInstructions []LibBondsBondInstruction, _blockIndex uint16, _anchorBlockNumber *big.Int, _anchorBlockHash [32]byte, _anchorStateRoot [32]byte) (*types.Transaction, error) {
	return _ShastaAnchor.contract.Transact(opts, "updateState", _proposalId, _proposer, _proverAuth, _bondInstructionsHash, _bondInstructions, _blockIndex, _anchorBlockNumber, _anchorBlockHash, _anchorStateRoot)
}
...
func (_ShastaAnchor *ShastaAnchorSession) UpdateState(_proposalId *big.Int, _proposer common.Address, _proverAuth []byte, _bondInstructionsHash [32]byte, _bondInstructions []LibBondsBondInstruction, _blockIndex uint16, _anchorBlockNumber *big.Int, _anchorBlockHash [32]byte, _anchorStateRoot [32]byte) (*types.Transaction, error) {
	return _ShastaAnchor.Contract.UpdateState(&_ShastaAnchor.TransactOpts, _proposalId, _proposer, _proverAuth, _bondInstructionsHash, _bondInstructions, _blockIndex, _anchorBlockNumber, _anchorBlockHash, _anchorStateRoot)
}
