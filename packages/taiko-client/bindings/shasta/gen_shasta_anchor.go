...
func (_ShastaAnchor *ShastaAnchorCaller) GetPreconfMetadata(opts *bind.CallOpts, _blockNumber *big.Int) (AnchorPreconfMetadata, error) {
	var out []interface{}
	err := _ShastaAnchor.contract.Call(opts, &out, "getPreconfMetadata", _blockNumber)
...
//
// Solidity: function getPreconfMetadata(uint256 _blockNumber) view returns((uint48,uint48,uint48,bytes32,bytes32))
func (_ShastaAnchor *ShastaAnchorSession) GetPreconfMetadata(_blockNumber *big.Int) (AnchorPreconfMetadata, error) {
	return _ShastaAnchor.Contract.GetPreconfMetadata(&_ShastaAnchor.CallOpts, _blockNumber)
}

// GetPreconfMetadata is a free data retrieval call binding the contract method 0x260c5344.
//
// Solidity: function getPreconfMetadata(uint256 _blockNumber) view returns((uint48,uint48,uint48,bytes32,bytes32))
func (_ShastaAnchor *ShastaAnchorCallerSession) GetPreconfMetadata(_blockNumber *big.Int) (AnchorPreconfMetadata, error) {
	return _ShastaAnchor.Contract.GetPreconfMetadata(&_ShastaAnchor.CallOpts, _blockNumber)
}
...
// AnchorV4 is a paid mutator transaction binding the contract method 0x3c7aa911.
//
// Solidity: function anchorV4((uint48,uint48,address,bytes,bytes32,(uint48,uint8,address,address)[]) _proposalParams, (uint48,bytes32,bytes32,bytes32) _blockParams) returns()
...
// FilterAnchored is a free log retrieval operation binding the contract event 0xe80d555eb6906f6907b68e6ead37d1089d1fbb7e23a68f3335dd04f8aef3e1e7.
//
// Solidity: event Anchored(bytes32 bondInstructionsHash, address designatedProver, bool isLowBondProposal, uint48 prevAnchorBlockNumber, uint48 anchorBlockNumber, bytes32 ancestorsHash)
...
// WatchAnchored is a free log subscription operation binding the contract event 0xe80d555eb6906f6907b68e6ead37d1089d1fbb7e23a68f3335dd04f8aef3e1e7.
//
// Solidity: event Anchored(bytes32 bondInstructionsHash, address designatedProver, bool isLowBondProposal, uint48 prevAnchorBlockNumber, uint48 anchorBlockNumber, bytes32 ancestorsHash)
...
// ParseAnchored is a log parse operation binding the contract event 0xe80d555eb6906f6907b68e6ead37d1089d1fbb7e23a68f3335dd04f8aef3e1e7.
//
// Solidity: event Anchored(bytes32 bondInstructionsHash, address designatedProver, bool isLowBondProposal, uint48 prevAnchorBlockNumber, uint48 anchorBlockNumber, bytes32 ancestorsHash)
