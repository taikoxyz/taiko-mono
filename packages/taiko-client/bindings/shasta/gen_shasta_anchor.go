...
func (_ShastaAnchor *ShastaAnchorTransactor) AnchorV4WithSignalSlots(opts *bind.TransactOpts, _checkpoint ICheckpointStoreCheckpoint, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _ShastaAnchor.contract.Transact(opts, "anchorV4WithSignalSlots", _checkpoint, _signalSlots)
}

// AnchorV4WithSignalSlots is a paid mutator transaction binding the contract method.
//
// Solidity: function anchorV4WithSignalSlots((uint48,bytes32,bytes32) _checkpoint, bytes32[] _signalSlots) returns()
func (_ShastaAnchor *ShastaAnchorSession) AnchorV4WithSignalSlots(_checkpoint ICheckpointStoreCheckpoint, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _ShastaAnchor.Contract.AnchorV4WithSignalSlots(&_ShastaAnchor.TransactOpts, _checkpoint, _signalSlots)
}

// AnchorV4WithSignalSlots is a paid mutator transaction binding the contract method.
//
// Solidity: function anchorV4WithSignalSlots((uint48,bytes32,bytes32) _checkpoint, bytes32[] _signalSlots) returns()
func (_ShastaAnchor *ShastaAnchorTransactorSession) AnchorV4WithSignalSlots(_checkpoint ICheckpointStoreCheckpoint, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _ShastaAnchor.Contract.AnchorV4WithSignalSlots(&_ShastaAnchor.TransactOpts, _checkpoint, _signalSlots)
}
