...
//
// Solidity: function decodeProvedEvent(bytes _data) pure returns((((uint48,bytes32,bytes32,address,uint48,bytes32,(address,address,uint48,bytes32)[]),bool)) payload_)
...
// EncodeProvedEvent is a free data retrieval call binding the contract method 0x2a1dd6fb.
//
// Solidity: function encodeProvedEvent((((uint48,bytes32,bytes32,address,uint48,bytes32,(address,address,uint48,bytes32)[]),bool)) _payload) pure returns(bytes encoded_)
