...
func (_ComposeVerifier *ComposeVerifierCaller) VerifyProof(opts *bind.CallOpts, _proposalAge *big.Int, _transitionsHash [32]byte, _proof []byte) error {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "verifyProof", _proposalAge, _transitionsHash, _proof)
...
//
// Solidity: function verifyProof(uint256 _proposalAge, bytes32 _transitionsHash, bytes _proof) view returns()
func (_ComposeVerifier *ComposeVerifierSession) VerifyProof(_proposalAge *big.Int, _transitionsHash [32]byte, _proof []byte) error {
