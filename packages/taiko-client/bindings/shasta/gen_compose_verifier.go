...
//
// Solidity: function NONE() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCaller) NONE(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "NONE")
...
//
// Solidity: function NONE() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) NONE() (uint8, error) {
	return _ComposeVerifier.Contract.NONE(&_ComposeVerifier.CallOpts)
}

// NONE is a free data retrieval call binding the contract method 0x83525394.
//
// Solidity: function NONE() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) NONE() (uint8, error) {
	return _ComposeVerifier.Contract.NONE(&_ComposeVerifier.CallOpts)
}

// OP is a free data retrieval call binding the contract method 0x7c9c3472.
//
// Solidity: function OP() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCaller) OP(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "OP")
...
//
// Solidity: function OP() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) OP() (uint8, error) {
	return _ComposeVerifier.Contract.OP(&_ComposeVerifier.CallOpts)
}

// OP is a free data retrieval call binding the contract method 0x7c9c3472.
//
// Solidity: function OP() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) OP() (uint8, error) {
	return _ComposeVerifier.Contract.OP(&_ComposeVerifier.CallOpts)
}
...
func (_ComposeVerifier *ComposeVerifierCaller) RISC0RETH(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "RISC0_RETH")
...
//
// Solidity: function RISC0_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) RISC0RETH() (uint8, error) {
	return _ComposeVerifier.Contract.RISC0RETH(&_ComposeVerifier.CallOpts)
}

// RISC0RETH is a free data retrieval call binding the contract method 0x8a153cb3.
//
// Solidity: function RISC0_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) RISC0RETH() (uint8, error) {
	return _ComposeVerifier.Contract.RISC0RETH(&_ComposeVerifier.CallOpts)
}

// SGXGETH is a free data retrieval call binding the contract method 0x995a034f.
//
// Solidity: function SGX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCaller) SGXGETH(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "SGX_GETH")
...
//
// Solidity: function SGX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) SGXGETH() (uint8, error) {
	return _ComposeVerifier.Contract.SGXGETH(&_ComposeVerifier.CallOpts)
}

// SGXGETH is a free data retrieval call binding the contract method 0x995a034f.
//
// Solidity: function SGX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) SGXGETH() (uint8, error) {
	return _ComposeVerifier.Contract.SGXGETH(&_ComposeVerifier.CallOpts)
}

// SGXRETH is a free data retrieval call binding the contract method 0x93934956.
//
// Solidity: function SGX_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCaller) SGXRETH(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "SGX_RETH")
...
//
// Solidity: function SGX_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) SGXRETH() (uint8, error) {
	return _ComposeVerifier.Contract.SGXRETH(&_ComposeVerifier.CallOpts)
}

// SGXRETH is a free data retrieval call binding the contract method 0x93934956.
//
// Solidity: function SGX_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) SGXRETH() (uint8, error) {
	return _ComposeVerifier.Contract.SGXRETH(&_ComposeVerifier.CallOpts)
}
...
func (_ComposeVerifier *ComposeVerifierCaller) SP1RETH(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "SP1_RETH")
...
//
// Solidity: function SP1_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) SP1RETH() (uint8, error) {
	return _ComposeVerifier.Contract.SP1RETH(&_ComposeVerifier.CallOpts)
}

// SP1RETH is a free data retrieval call binding the contract method 0x89b2e184.
//
// Solidity: function SP1_RETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) SP1RETH() (uint8, error) {
	return _ComposeVerifier.Contract.SP1RETH(&_ComposeVerifier.CallOpts)
}

// TDXGETH is a free data retrieval call binding the contract method 0xdeef3878.
//
// Solidity: function TDX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCaller) TDXGETH(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "TDX_GETH")
...
//
// Solidity: function TDX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierSession) TDXGETH() (uint8, error) {
...
//
// Solidity: function TDX_GETH() view returns(uint8)
func (_ComposeVerifier *ComposeVerifierCallerSession) TDXGETH() (uint8, error) {
	return _ComposeVerifier.Contract.TDXGETH(&_ComposeVerifier.CallOpts)
}
...
//
// Solidity: function verifyProof(uint256 _proposalAge, bytes32 _proveInputHash, bytes _proof) view returns()
func (_ComposeVerifier *ComposeVerifierCaller) VerifyProof(opts *bind.CallOpts, _proposalAge *big.Int, _proveInputHash [32]byte, _proof []byte) error {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "verifyProof", _proposalAge, _proveInputHash, _proof)
...
//
// Solidity: function verifyProof(uint256 _proposalAge, bytes32 _proveInputHash, bytes _proof) view returns()
func (_ComposeVerifier *ComposeVerifierSession) VerifyProof(_proposalAge *big.Int, _proveInputHash [32]byte, _proof []byte) error {
	return _ComposeVerifier.Contract.VerifyProof(&_ComposeVerifier.CallOpts, _proposalAge, _proveInputHash, _proof)
}

// VerifyProof is a free data retrieval call binding the contract method 0x14bcf3dd.
//
// Solidity: function verifyProof(uint256 _proposalAge, bytes32 _proveInputHash, bytes _proof) view returns()
func (_ComposeVerifier *ComposeVerifierCallerSession) VerifyProof(_proposalAge *big.Int, _proveInputHash [32]byte, _proof []byte) error {
	return _ComposeVerifier.Contract.VerifyProof(&_ComposeVerifier.CallOpts, _proposalAge, _proveInputHash, _proof)
}
