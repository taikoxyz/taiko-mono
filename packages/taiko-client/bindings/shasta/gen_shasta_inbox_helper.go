...
func (_InboxHelperClient *InboxHelperClientCaller) HashCheckpoint(opts *bind.CallOpts, _checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function hashCheckpoint((uint48,bytes32,bytes32) _checkpoint) pure returns(bytes32)
func (_InboxHelperClient *InboxHelperClientSession) HashCheckpoint(_checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
...
//
// Solidity: function hashCheckpoint((uint48,bytes32,bytes32) _checkpoint) pure returns(bytes32)
func (_InboxHelperClient *InboxHelperClientCallerSession) HashCheckpoint(_checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
	return _InboxHelperClient.Contract.HashCheckpoint(&_InboxHelperClient.CallOpts, _checkpoint)
}
...
func (_InboxHelperClient *InboxHelperClientCaller) HashCheckpointOptimized(opts *bind.CallOpts, _checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
	var out []interface{}
...
//
// Solidity: function hashCheckpointOptimized((uint48,bytes32,bytes32) _checkpoint) pure returns(bytes32)
func (_InboxHelperClient *InboxHelperClientSession) HashCheckpointOptimized(_checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
...
//
// Solidity: function hashCheckpointOptimized((uint48,bytes32,bytes32) _checkpoint) pure returns(bytes32)
func (_InboxHelperClient *InboxHelperClientCallerSession) HashCheckpointOptimized(_checkpoint ICheckpointManagerCheckpoint) ([32]byte, error) {
	return _InboxHelperClient.Contract.HashCheckpointOptimized(&_InboxHelperClient.CallOpts, _checkpoint)
}
