...
//
// Solidity: function ANCHOR_GAS_LIMIT() view returns(uint256)
func (_TaikoAnchorClient *TaikoAnchorClientCaller) ANCHORGASLIMIT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "ANCHOR_GAS_LIMIT")
...
//
// Solidity: function ANCHOR_GAS_LIMIT() view returns(uint256)
func (_TaikoAnchorClient *TaikoAnchorClientSession) ANCHORGASLIMIT() (*big.Int, error) {
	return _TaikoAnchorClient.Contract.ANCHORGASLIMIT(&_TaikoAnchorClient.CallOpts)
}

// ANCHORGASLIMIT is a free data retrieval call binding the contract method 0xc46e3a66.
//
// Solidity: function ANCHOR_GAS_LIMIT() view returns(uint256)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) ANCHORGASLIMIT() (*big.Int, error) {
	return _TaikoAnchorClient.Contract.ANCHORGASLIMIT(&_TaikoAnchorClient.CallOpts)
}
...
// CalculateBaseFee is a free data retrieval call binding the contract method 0x5599c772.
//
// Solidity: function calculateBaseFee((uint8,uint32,uint64,uint32) _baseFeeConfig, uint64 _blocktime, uint64 _parentGasExcess, uint32 _parentGasUsed) pure returns(uint256 basefee_, uint64 parentGasExcess_)
...
// GetBasefeeV2 is a free data retrieval call binding the contract method 0x96d98cc8.
//
// Solidity: function getBasefeeV2(uint32 _parentGasUsed, uint64 _blockTimestamp, (uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
...
func (_TaikoAnchorClient *TaikoAnchorClientCaller) LastAnchorGasUsed(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "lastAnchorGasUsed")
...
//
// Solidity: function lastAnchorGasUsed() view returns(uint32)
func (_TaikoAnchorClient *TaikoAnchorClientSession) LastAnchorGasUsed() (uint32, error) {
	return _TaikoAnchorClient.Contract.LastAnchorGasUsed(&_TaikoAnchorClient.CallOpts)
}

// LastAnchorGasUsed is a free data retrieval call binding the contract method 0x4ef77eb5.
//
// Solidity: function lastAnchorGasUsed() view returns(uint32)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) LastAnchorGasUsed() (uint32, error) {
	return _TaikoAnchorClient.Contract.LastAnchorGasUsed(&_TaikoAnchorClient.CallOpts)
}
...
func (_TaikoAnchorClient *TaikoAnchorClientCaller) ShastaForkHeight(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "shastaForkHeight")
...
//
// Solidity: function shastaForkHeight() view returns(uint64)
func (_TaikoAnchorClient *TaikoAnchorClientSession) ShastaForkHeight() (uint64, error) {
	return _TaikoAnchorClient.Contract.ShastaForkHeight(&_TaikoAnchorClient.CallOpts)
}

// ShastaForkHeight is a free data retrieval call binding the contract method 0xf37f2868.
//
// Solidity: function shastaForkHeight() view returns(uint64)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) ShastaForkHeight() (uint64, error) {
	return _TaikoAnchorClient.Contract.ShastaForkHeight(&_TaikoAnchorClient.CallOpts)
}
...
// V4GetBaseFee is a free data retrieval call binding the contract method 0x5eed4734.
//
// Solidity: function v4GetBaseFee(uint32 _parentGasUsed, uint64 _blockTimestamp, (uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoAnchorClient *TaikoAnchorClientCaller) V4GetBaseFee(opts *bind.CallOpts, _parentGasUsed uint32, _blockTimestamp uint64, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "v4GetBaseFee", _parentGasUsed, _blockTimestamp, _baseFeeConfig)
...
//
// Solidity: function v4GetBaseFee(uint32 _parentGasUsed, uint64 _blockTimestamp, (uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoAnchorClient *TaikoAnchorClientSession) V4GetBaseFee(_parentGasUsed uint32, _blockTimestamp uint64, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
	return _TaikoAnchorClient.Contract.V4GetBaseFee(&_TaikoAnchorClient.CallOpts, _parentGasUsed, _blockTimestamp, _baseFeeConfig)
}

// V4GetBaseFee is a free data retrieval call binding the contract method 0x5eed4734.
//
// Solidity: function v4GetBaseFee(uint32 _parentGasUsed, uint64 _blockTimestamp, (uint8,uint32,uint64,uint32) _baseFeeConfig) view returns(uint256 basefee_, uint64 newGasTarget_, uint64 newGasExcess_)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) V4GetBaseFee(_parentGasUsed uint32, _blockTimestamp uint64, _baseFeeConfig LibSharedDataBaseFeeConfig) (struct {
	Basefee      *big.Int
	NewGasTarget uint64
	NewGasExcess uint64
}, error) {
...
func (_TaikoAnchorClient *TaikoAnchorClientCaller) V4IsInbox(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "v4IsInbox")
...
//
// Solidity: function v4IsInbox() pure returns(bool)
func (_TaikoAnchorClient *TaikoAnchorClientSession) V4IsInbox() (bool, error) {
	return _TaikoAnchorClient.Contract.V4IsInbox(&_TaikoAnchorClient.CallOpts)
}

// V4IsInbox is a free data retrieval call binding the contract method 0x5da14237.
//
// Solidity: function v4IsInbox() pure returns(bool)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) V4IsInbox() (bool, error) {
	return _TaikoAnchorClient.Contract.V4IsInbox(&_TaikoAnchorClient.CallOpts)
}
...
// AnchorV2 is a paid mutator transaction binding the contract method 0xdd41b3b1.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint32,uint64,uint32) _baseFeeConfig) returns()
...
// AnchorV3 is a paid mutator transaction binding the contract method 0xe4c483f7.
//
// Solidity: function anchorV3(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint32,uint64,uint32) _baseFeeConfig, bytes32[] _signalSlots) returns()
...
// V4Anchor is a paid mutator transaction binding the contract method 0x3687aa86.
//
// Solidity: function v4Anchor(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint256 , uint32 _parentGasUsed, (uint8,uint32,uint64,uint32) _baseFeeConfig, bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientTransactor) V4Anchor(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte, arg2 *big.Int, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.contract.Transact(opts, "v4Anchor", _anchorBlockId, _anchorStateRoot, arg2, _parentGasUsed, _baseFeeConfig, _signalSlots)
}

// V4Anchor is a paid mutator transaction binding the contract method 0x3687aa86.
//
// Solidity: function v4Anchor(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint256 , uint32 _parentGasUsed, (uint8,uint32,uint64,uint32) _baseFeeConfig, bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientSession) V4Anchor(_anchorBlockId uint64, _anchorStateRoot [32]byte, arg2 *big.Int, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.Contract.V4Anchor(&_TaikoAnchorClient.TransactOpts, _anchorBlockId, _anchorStateRoot, arg2, _parentGasUsed, _baseFeeConfig, _signalSlots)
}

// V4Anchor is a paid mutator transaction binding the contract method 0x3687aa86.
//
// Solidity: function v4Anchor(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint256 , uint32 _parentGasUsed, (uint8,uint32,uint64,uint32) _baseFeeConfig, bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientTransactorSession) V4Anchor(_anchorBlockId uint64, _anchorStateRoot [32]byte, arg2 *big.Int, _parentGasUsed uint32, _baseFeeConfig LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.Contract.V4Anchor(&_TaikoAnchorClient.TransactOpts, _anchorBlockId, _anchorStateRoot, arg2, _parentGasUsed, _baseFeeConfig, _signalSlots)
}
