...
func (_ProverSet *ProverSetCaller) BondToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ProverSet.contract.Call(opts, &out, "bondToken")
...
func (_ProverSet *ProverSetSession) BondToken() (common.Address, error) {
	return _ProverSet.Contract.BondToken(&_ProverSet.CallOpts)
}
...
// IProposeBatch is a free data retrieval call binding the contract method 0x0fb587cc.
//
// Solidity: function iProposeBatch() view returns(address)
func (_ProverSet *ProverSetCaller) IProposeBatch(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ProverSet.contract.Call(opts, &out, "iProposeBatch")
...
//
// Solidity: function iProposeBatch() view returns(address)
func (_ProverSet *ProverSetSession) IProposeBatch() (common.Address, error) {
	return _ProverSet.Contract.IProposeBatch(&_ProverSet.CallOpts)
}

// IProposeBatch is a free data retrieval call binding the contract method 0x0fb587cc.
//
// Solidity: function iProposeBatch() view returns(address)
func (_ProverSet *ProverSetCallerSession) IProposeBatch() (common.Address, error) {
	return _ProverSet.Contract.IProposeBatch(&_ProverSet.CallOpts)
}
...
func (_ProverSet *ProverSetCaller) Inbox(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ProverSet.contract.Call(opts, &out, "inbox")
...
func (_ProverSet *ProverSetSession) Inbox() (common.Address, error) {
	return _ProverSet.Contract.Inbox(&_ProverSet.CallOpts)
}
...
func (_ProverSet *ProverSetTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _admin common.Address) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "init", _owner, _admin)
}
...
func (_ProverSet *ProverSetSession) Init(_owner common.Address, _admin common.Address) (*types.Transaction, error) {
	return _ProverSet.Contract.Init(&_ProverSet.TransactOpts, _owner, _admin)
}
...
func (_ProverSet *ProverSetTransactor) ProposeBlocksV2(opts *bind.TransactOpts, _paramsArr [][]byte, _txListArr [][]byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proposeBlocksV2", _paramsArr, _txListArr)
}
...
func (_ProverSet *ProverSetSession) ProposeBlocksV2(_paramsArr [][]byte, _txListArr [][]byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlocksV2(&_ProverSet.TransactOpts, _paramsArr, _txListArr)
}
...
func (_ProverSet *ProverSetTransactor) ProposeBlocksV2Conditionally(opts *bind.TransactOpts, _params [][]byte, _txList [][]byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proposeBlocksV2Conditionally", _params, _txList)
}
...
func (_ProverSet *ProverSetSession) ProposeBlocksV2Conditionally(_params [][]byte, _txList [][]byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlocksV2Conditionally(&_ProverSet.TransactOpts, _params, _txList)
}
...
func (_ProverSet *ProverSetTransactor) ProveBatches(opts *bind.TransactOpts, _params []byte, _proof []byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proveBatches", _params, _proof)
}
...
func (_ProverSet *ProverSetSession) ProveBatches(_params []byte, _proof []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProveBatches(&_ProverSet.TransactOpts, _params, _proof)
}
...
func (_ProverSet *ProverSetTransactor) ProveBlocks(opts *bind.TransactOpts, _blockId []uint64, _input [][]byte, _batchProof []byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proveBlocks", _blockId, _input, _batchProof)
}
...
func (_ProverSet *ProverSetSession) ProveBlocks(_blockId []uint64, _input [][]byte, _batchProof []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProveBlocks(&_ProverSet.TransactOpts, _blockId, _input, _batchProof)
}
...
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes _additionalData) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_ProverSet *ProverSetTransactor) V4ProposeBatch(opts *bind.TransactOpts, _params []byte, _txList []byte, _additionalData []byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "v4ProposeBatch", _params, _txList, _additionalData)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes _additionalData) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_ProverSet *ProverSetSession) V4ProposeBatch(_params []byte, _txList []byte, _additionalData []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.V4ProposeBatch(&_ProverSet.TransactOpts, _params, _txList, _additionalData)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes _additionalData) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)), (bytes32,address,uint64,uint64))
func (_ProverSet *ProverSetTransactorSession) V4ProposeBatch(_params []byte, _txList []byte, _additionalData []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.V4ProposeBatch(&_ProverSet.TransactOpts, _params, _txList, _additionalData)
}
