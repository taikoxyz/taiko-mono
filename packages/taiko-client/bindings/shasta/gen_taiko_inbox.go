...
// V4BondBalanceOf is a free data retrieval call binding the contract method 0x029b595b.
//
// Solidity: function v4BondBalanceOf(address _user) view returns(uint256)
func (_TaikoInboxClient *TaikoInboxClientCaller) V4BondBalanceOf(opts *bind.CallOpts, _user common.Address) (*big.Int, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4BondBalanceOf", _user)
...
//
// Solidity: function v4BondBalanceOf(address _user) view returns(uint256)
func (_TaikoInboxClient *TaikoInboxClientSession) V4BondBalanceOf(_user common.Address) (*big.Int, error) {
	return _TaikoInboxClient.Contract.V4BondBalanceOf(&_TaikoInboxClient.CallOpts, _user)
}

// V4BondBalanceOf is a free data retrieval call binding the contract method 0x029b595b.
//
// Solidity: function v4BondBalanceOf(address _user) view returns(uint256)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4BondBalanceOf(_user common.Address) (*big.Int, error) {
	return _TaikoInboxClient.Contract.V4BondBalanceOf(&_TaikoInboxClient.CallOpts, _user)
}

// V4BondToken is a free data retrieval call binding the contract method 0x1e405b01.
//
// Solidity: function v4BondToken() view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCaller) V4BondToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4BondToken")
...
//
// Solidity: function v4BondToken() view returns(address)
func (_TaikoInboxClient *TaikoInboxClientSession) V4BondToken() (common.Address, error) {
	return _TaikoInboxClient.Contract.V4BondToken(&_TaikoInboxClient.CallOpts)
}

// V4BondToken is a free data retrieval call binding the contract method 0x1e405b01.
//
// Solidity: function v4BondToken() view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4BondToken() (common.Address, error) {
	return _TaikoInboxClient.Contract.V4BondToken(&_TaikoInboxClient.CallOpts)
}

// V4GetBatch is a free data retrieval call binding the contract method 0x7bc320af.
//
// Solidity: function v4GetBatch(uint64 _batchId) view returns((bytes32,uint64,uint96,uint96,uint64,uint64,uint64,uint24,uint8,uint24))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetBatch(opts *bind.CallOpts, _batchId uint64) (ITaikoInboxBatch, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetBatch", _batchId)
...
//
// Solidity: function v4GetBatch(uint64 _batchId) view returns((bytes32,uint64,uint96,uint96,uint64,uint64,uint64,uint24,uint8,uint24))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetBatch(_batchId uint64) (ITaikoInboxBatch, error) {
	return _TaikoInboxClient.Contract.V4GetBatch(&_TaikoInboxClient.CallOpts, _batchId)
}

// V4GetBatch is a free data retrieval call binding the contract method 0x7bc320af.
//
// Solidity: function v4GetBatch(uint64 _batchId) view returns((bytes32,uint64,uint96,uint96,uint64,uint64,uint64,uint24,uint8,uint24))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetBatch(_batchId uint64) (ITaikoInboxBatch, error) {
	return _TaikoInboxClient.Contract.V4GetBatch(&_TaikoInboxClient.CallOpts, _batchId)
}

// V4GetBatchVerifyingTransition is a free data retrieval call binding the contract method 0xc68deeed.
//
// Solidity: function v4GetBatchVerifyingTransition(uint64 _batchId) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetBatchVerifyingTransition(opts *bind.CallOpts, _batchId uint64) (ITaikoInboxTransitionState, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetBatchVerifyingTransition", _batchId)
...
//
// Solidity: function v4GetBatchVerifyingTransition(uint64 _batchId) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetBatchVerifyingTransition(_batchId uint64) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetBatchVerifyingTransition(&_TaikoInboxClient.CallOpts, _batchId)
}

// V4GetBatchVerifyingTransition is a free data retrieval call binding the contract method 0xc68deeed.
//
// Solidity: function v4GetBatchVerifyingTransition(uint64 _batchId) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetBatchVerifyingTransition(_batchId uint64) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetBatchVerifyingTransition(&_TaikoInboxClient.CallOpts, _batchId)
}

// V4GetConfig is a free data retrieval call binding the contract method 0x8c718d98.
//
// Solidity: function v4GetConfig() view returns((uint64,uint64,uint64,uint64,uint32,uint96,uint8,uint64,(uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,uint8[2],(uint64,uint64,uint64,uint64)))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetConfig(opts *bind.CallOpts) (ITaikoInboxConfig, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetConfig")
...
//
// Solidity: function v4GetConfig() view returns((uint64,uint64,uint64,uint64,uint32,uint96,uint8,uint64,(uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,uint8[2],(uint64,uint64,uint64,uint64)))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetConfig() (ITaikoInboxConfig, error) {
	return _TaikoInboxClient.Contract.V4GetConfig(&_TaikoInboxClient.CallOpts)
}

// V4GetConfig is a free data retrieval call binding the contract method 0x8c718d98.
//
// Solidity: function v4GetConfig() view returns((uint64,uint64,uint64,uint64,uint32,uint96,uint8,uint64,(uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,uint8[2],(uint64,uint64,uint64,uint64)))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetConfig() (ITaikoInboxConfig, error) {
	return _TaikoInboxClient.Contract.V4GetConfig(&_TaikoInboxClient.CallOpts)
}

// V4GetLastSyncedTransition is a free data retrieval call binding the contract method 0xbb71bf3a.
//
// Solidity: function v4GetLastSyncedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetLastSyncedTransition(opts *bind.CallOpts) (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetLastSyncedTransition")
...
//
// Solidity: function v4GetLastSyncedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetLastSyncedTransition() (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
	return _TaikoInboxClient.Contract.V4GetLastSyncedTransition(&_TaikoInboxClient.CallOpts)
}

// V4GetLastSyncedTransition is a free data retrieval call binding the contract method 0xbb71bf3a.
//
// Solidity: function v4GetLastSyncedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetLastSyncedTransition() (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
...
// V4GetLastVerifiedTransition is a free data retrieval call binding the contract method 0x8d2c7848.
//
// Solidity: function v4GetLastVerifiedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetLastVerifiedTransition(opts *bind.CallOpts) (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetLastVerifiedTransition")
...
//
// Solidity: function v4GetLastVerifiedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetLastVerifiedTransition() (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
	return _TaikoInboxClient.Contract.V4GetLastVerifiedTransition(&_TaikoInboxClient.CallOpts)
}

// V4GetLastVerifiedTransition is a free data retrieval call binding the contract method 0x8d2c7848.
//
// Solidity: function v4GetLastVerifiedTransition() view returns(uint64 batchId_, uint64 blockId_, (bytes32,bytes32,bytes32,address,bool,uint48) ts_)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetLastVerifiedTransition() (struct {
	BatchId uint64
	BlockId uint64
	Ts      ITaikoInboxTransitionState
}, error) {
...
// V4GetStats1 is a free data retrieval call binding the contract method 0x15205a3f.
//
// Solidity: function v4GetStats1() view returns((uint64,uint64,uint64,uint64))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetStats1(opts *bind.CallOpts) (ITaikoInboxStats1, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetStats1")
...
//
// Solidity: function v4GetStats1() view returns((uint64,uint64,uint64,uint64))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetStats1() (ITaikoInboxStats1, error) {
	return _TaikoInboxClient.Contract.V4GetStats1(&_TaikoInboxClient.CallOpts)
}

// V4GetStats1 is a free data retrieval call binding the contract method 0x15205a3f.
//
// Solidity: function v4GetStats1() view returns((uint64,uint64,uint64,uint64))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetStats1() (ITaikoInboxStats1, error) {
	return _TaikoInboxClient.Contract.V4GetStats1(&_TaikoInboxClient.CallOpts)
}

// V4GetStats2 is a free data retrieval call binding the contract method 0x69a858d7.
//
// Solidity: function v4GetStats2() view returns((uint64,uint64,bool,uint56,uint64))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetStats2(opts *bind.CallOpts) (ITaikoInboxStats2, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetStats2")
...
//
// Solidity: function v4GetStats2() view returns((uint64,uint64,bool,uint56,uint64))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetStats2() (ITaikoInboxStats2, error) {
	return _TaikoInboxClient.Contract.V4GetStats2(&_TaikoInboxClient.CallOpts)
}

// V4GetStats2 is a free data retrieval call binding the contract method 0x69a858d7.
//
// Solidity: function v4GetStats2() view returns((uint64,uint64,bool,uint56,uint64))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetStats2() (ITaikoInboxStats2, error) {
	return _TaikoInboxClient.Contract.V4GetStats2(&_TaikoInboxClient.CallOpts)
}

// V4GetTransitionById is a free data retrieval call binding the contract method 0xcab12ee0.
//
// Solidity: function v4GetTransitionById(uint64 _batchId, uint24 _tid) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetTransitionById(opts *bind.CallOpts, _batchId uint64, _tid *big.Int) (ITaikoInboxTransitionState, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetTransitionById", _batchId, _tid)
...
//
// Solidity: function v4GetTransitionById(uint64 _batchId, uint24 _tid) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetTransitionById(_batchId uint64, _tid *big.Int) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetTransitionById(&_TaikoInboxClient.CallOpts, _batchId, _tid)
}

// V4GetTransitionById is a free data retrieval call binding the contract method 0xcab12ee0.
//
// Solidity: function v4GetTransitionById(uint64 _batchId, uint24 _tid) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetTransitionById(_batchId uint64, _tid *big.Int) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetTransitionById(&_TaikoInboxClient.CallOpts, _batchId, _tid)
}

// V4GetTransitionByParentHash is a free data retrieval call binding the contract method 0xcca104e7.
//
// Solidity: function v4GetTransitionByParentHash(uint64 _batchId, bytes32 _parentHash) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCaller) V4GetTransitionByParentHash(opts *bind.CallOpts, _batchId uint64, _parentHash [32]byte) (ITaikoInboxTransitionState, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4GetTransitionByParentHash", _batchId, _parentHash)
...
//
// Solidity: function v4GetTransitionByParentHash(uint64 _batchId, bytes32 _parentHash) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientSession) V4GetTransitionByParentHash(_batchId uint64, _parentHash [32]byte) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetTransitionByParentHash(&_TaikoInboxClient.CallOpts, _batchId, _parentHash)
}

// V4GetTransitionByParentHash is a free data retrieval call binding the contract method 0xcca104e7.
//
// Solidity: function v4GetTransitionByParentHash(uint64 _batchId, bytes32 _parentHash) view returns((bytes32,bytes32,bytes32,address,bool,uint48))
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4GetTransitionByParentHash(_batchId uint64, _parentHash [32]byte) (ITaikoInboxTransitionState, error) {
	return _TaikoInboxClient.Contract.V4GetTransitionByParentHash(&_TaikoInboxClient.CallOpts, _batchId, _parentHash)
}

// V4IsInbox is a free data retrieval call binding the contract method 0x5da14237.
//
// Solidity: function v4IsInbox() pure returns(bool)
func (_TaikoInboxClient *TaikoInboxClientCaller) V4IsInbox(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "v4IsInbox")
...
//
// Solidity: function v4IsInbox() pure returns(bool)
func (_TaikoInboxClient *TaikoInboxClientSession) V4IsInbox() (bool, error) {
	return _TaikoInboxClient.Contract.V4IsInbox(&_TaikoInboxClient.CallOpts)
}

// V4IsInbox is a free data retrieval call binding the contract method 0x5da14237.
//
// Solidity: function v4IsInbox() pure returns(bool)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) V4IsInbox() (bool, error) {
	return _TaikoInboxClient.Contract.V4IsInbox(&_TaikoInboxClient.CallOpts)
}
...
// V4DepositBond is a paid mutator transaction binding the contract method 0x08107d5d.
//
// Solidity: function v4DepositBond(uint256 _amount) payable returns()
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4DepositBond(opts *bind.TransactOpts, _amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4DepositBond", _amount)
}

// V4DepositBond is a paid mutator transaction binding the contract method 0x08107d5d.
//
// Solidity: function v4DepositBond(uint256 _amount) payable returns()
func (_TaikoInboxClient *TaikoInboxClientSession) V4DepositBond(_amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4DepositBond(&_TaikoInboxClient.TransactOpts, _amount)
}

// V4DepositBond is a paid mutator transaction binding the contract method 0x08107d5d.
//
// Solidity: function v4DepositBond(uint256 _amount) payable returns()
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4DepositBond(_amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4DepositBond(&_TaikoInboxClient.TransactOpts, _amount)
}

// V4Init is a paid mutator transaction binding the contract method 0x116606ad.
//
// Solidity: function v4Init(address _owner, bytes32 _genesisBlockHash) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4Init(opts *bind.TransactOpts, _owner common.Address, _genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4Init", _owner, _genesisBlockHash)
}

// V4Init is a paid mutator transaction binding the contract method 0x116606ad.
//
// Solidity: function v4Init(address _owner, bytes32 _genesisBlockHash) returns()
func (_TaikoInboxClient *TaikoInboxClientSession) V4Init(_owner common.Address, _genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4Init(&_TaikoInboxClient.TransactOpts, _owner, _genesisBlockHash)
}

// V4Init is a paid mutator transaction binding the contract method 0x116606ad.
//
// Solidity: function v4Init(address _owner, bytes32 _genesisBlockHash) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4Init(_owner common.Address, _genesisBlockHash [32]byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4Init(&_TaikoInboxClient.TransactOpts, _owner, _genesisBlockHash)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info_, (bytes32,address,uint64,uint64) meta_)
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4ProposeBatch(opts *bind.TransactOpts, _params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4ProposeBatch", _params, _txList, arg2)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info_, (bytes32,address,uint64,uint64) meta_)
func (_TaikoInboxClient *TaikoInboxClientSession) V4ProposeBatch(_params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4ProposeBatch(&_TaikoInboxClient.TransactOpts, _params, _txList, arg2)
}

// V4ProposeBatch is a paid mutator transaction binding the contract method 0xe2d54d39.
//
// Solidity: function v4ProposeBatch(bytes _params, bytes _txList, bytes ) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info_, (bytes32,address,uint64,uint64) meta_)
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4ProposeBatch(_params []byte, _txList []byte, arg2 []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4ProposeBatch(&_TaikoInboxClient.TransactOpts, _params, _txList, arg2)
}

// V4ProveBatches is a paid mutator transaction binding the contract method 0x0a74d82e.
//
// Solidity: function v4ProveBatches(bytes _params, bytes _proof) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4ProveBatches(opts *bind.TransactOpts, _params []byte, _proof []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4ProveBatches", _params, _proof)
}

// V4ProveBatches is a paid mutator transaction binding the contract method 0x0a74d82e.
//
// Solidity: function v4ProveBatches(bytes _params, bytes _proof) returns()
func (_TaikoInboxClient *TaikoInboxClientSession) V4ProveBatches(_params []byte, _proof []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4ProveBatches(&_TaikoInboxClient.TransactOpts, _params, _proof)
}

// V4ProveBatches is a paid mutator transaction binding the contract method 0x0a74d82e.
//
// Solidity: function v4ProveBatches(bytes _params, bytes _proof) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4ProveBatches(_params []byte, _proof []byte) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4ProveBatches(&_TaikoInboxClient.TransactOpts, _params, _proof)
}

// V4VerifyBatches is a paid mutator transaction binding the contract method 0xc47e5f1c.
//
// Solidity: function v4VerifyBatches(uint8 _length) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4VerifyBatches(opts *bind.TransactOpts, _length uint8) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4VerifyBatches", _length)
}

// V4VerifyBatches is a paid mutator transaction binding the contract method 0xc47e5f1c.
//
// Solidity: function v4VerifyBatches(uint8 _length) returns()
func (_TaikoInboxClient *TaikoInboxClientSession) V4VerifyBatches(_length uint8) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4VerifyBatches(&_TaikoInboxClient.TransactOpts, _length)
}

// V4VerifyBatches is a paid mutator transaction binding the contract method 0xc47e5f1c.
//
// Solidity: function v4VerifyBatches(uint8 _length) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4VerifyBatches(_length uint8) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4VerifyBatches(&_TaikoInboxClient.TransactOpts, _length)
}

// V4WithdrawBond is a paid mutator transaction binding the contract method 0xf7052f0f.
//
// Solidity: function v4WithdrawBond(uint256 _amount) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactor) V4WithdrawBond(opts *bind.TransactOpts, _amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.contract.Transact(opts, "v4WithdrawBond", _amount)
}

// V4WithdrawBond is a paid mutator transaction binding the contract method 0xf7052f0f.
//
// Solidity: function v4WithdrawBond(uint256 _amount) returns()
func (_TaikoInboxClient *TaikoInboxClientSession) V4WithdrawBond(_amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4WithdrawBond(&_TaikoInboxClient.TransactOpts, _amount)
}

// V4WithdrawBond is a paid mutator transaction binding the contract method 0xf7052f0f.
//
// Solidity: function v4WithdrawBond(uint256 _amount) returns()
func (_TaikoInboxClient *TaikoInboxClientTransactorSession) V4WithdrawBond(_amount *big.Int) (*types.Transaction, error) {
	return _TaikoInboxClient.Contract.V4WithdrawBond(&_TaikoInboxClient.TransactOpts, _amount)
}
...
// FilterBatchProposed is a free log retrieval operation binding the contract event 0x9451cceae3e6b037d645d2a287e66c02df7beaf59bed1f71ed27f880a835d7e2.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// WatchBatchProposed is a free log subscription operation binding the contract event 0x9451cceae3e6b037d645d2a287e66c02df7beaf59bed1f71ed27f880a835d7e2.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// ParseBatchProposed is a log parse operation binding the contract event 0x9451cceae3e6b037d645d2a287e66c02df7beaf59bed1f71ed27f880a835d7e2.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,uint64,bytes32,(uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
