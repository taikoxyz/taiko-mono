...
//
// Solidity: function getConfig() view returns((address,address,address,uint48,uint48,uint256,uint48,uint256,uint8,uint256,uint64,uint64,uint16) config_)
...
// Helper is a free data retrieval call binding the contract method 0x63b0e66a.
//
// Solidity: function helper() view returns(address)
func (_ShastaInboxClient *ShastaInboxClientCaller) Helper(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ShastaInboxClient.contract.Call(opts, &out, "helper")
...
//
// Solidity: function helper() view returns(address)
func (_ShastaInboxClient *ShastaInboxClientSession) Helper() (common.Address, error) {
	return _ShastaInboxClient.Contract.Helper(&_ShastaInboxClient.CallOpts)
}

// Helper is a free data retrieval call binding the contract method 0x63b0e66a.
//
// Solidity: function helper() view returns(address)
func (_ShastaInboxClient *ShastaInboxClientCallerSession) Helper() (common.Address, error) {
	return _ShastaInboxClient.Contract.Helper(&_ShastaInboxClient.CallOpts)
}
