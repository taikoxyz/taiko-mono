...
// HashTransitionsArray is a free data retrieval call binding the contract method 0xba68778f.
//
// Solidity: function hashTransitionsArray((bytes32,bytes32,(uint48,bytes32,bytes32),address,address)[] _transitions) pure returns(bytes32)
