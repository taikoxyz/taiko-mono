...
// AnchorV2 is a paid mutator transaction binding the contract method 0x17296a9b.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot) returns()
func (_TaikoL2Client *TaikoL2ClientTransactor) AnchorV2(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte) (*types.Transaction, error) {
	return _TaikoL2Client.contract.Transact(opts, "anchorV2", _anchorBlockId, _anchorStateRoot)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x17296a9b.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot) returns()
func (_TaikoL2Client *TaikoL2ClientSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.AnchorV2(&_TaikoL2Client.TransactOpts, _anchorBlockId, _anchorStateRoot)
}

// AnchorV2 is a paid mutator transaction binding the contract method 0x17296a9b.
//
// Solidity: function anchorV2(uint64 _anchorBlockId, bytes32 _anchorStateRoot) returns()
func (_TaikoL2Client *TaikoL2ClientTransactorSession) AnchorV2(_anchorBlockId uint64, _anchorStateRoot [32]byte) (*types.Transaction, error) {
	return _TaikoL2Client.Contract.AnchorV2(&_TaikoL2Client.TransactOpts, _anchorBlockId, _anchorStateRoot)
}
