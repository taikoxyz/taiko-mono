...
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns()
func (_ProverSet *ProverSetTransactor) ProposeBlock(opts *bind.TransactOpts, _params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proposeBlock", _params, _txLists)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x72b6347b.
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns()
func (_ProverSet *ProverSetSession) ProposeBlock(_params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlock(&_ProverSet.TransactOpts, _params, _txLists)
}

// ProposeBlock is a paid mutator transaction binding the contract method 0x72b6347b.
//
// Solidity: function proposeBlock(bytes[] _params, bytes[] _txLists) payable returns()
func (_ProverSet *ProverSetTransactorSession) ProposeBlock(_params [][]byte, _txLists [][]byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlock(&_ProverSet.TransactOpts, _params, _txLists)
}
