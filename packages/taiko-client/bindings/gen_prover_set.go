...
// ProposeBlockV2Conditionally is a paid mutator transaction binding the contract method 0x64834f6e.
//
// Solidity: function proposeBlockV2Conditionally(bytes _params, bytes _txList) returns()
func (_ProverSet *ProverSetTransactor) ProposeBlockV2Conditionally(opts *bind.TransactOpts, _params []byte, _txList []byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proposeBlockV2Conditionally", _params, _txList)
}

// ProposeBlockV2Conditionally is a paid mutator transaction binding the contract method 0x64834f6e.
//
// Solidity: function proposeBlockV2Conditionally(bytes _params, bytes _txList) returns()
func (_ProverSet *ProverSetSession) ProposeBlockV2Conditionally(_params []byte, _txList []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlockV2Conditionally(&_ProverSet.TransactOpts, _params, _txList)
}

// ProposeBlockV2Conditionally is a paid mutator transaction binding the contract method 0x64834f6e.
//
// Solidity: function proposeBlockV2Conditionally(bytes _params, bytes _txList) returns()
func (_ProverSet *ProverSetTransactorSession) ProposeBlockV2Conditionally(_params []byte, _txList []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlockV2Conditionally(&_ProverSet.TransactOpts, _params, _txList)
}
