...
//
// Solidity: function getMinTier(uint256 _rand) pure returns(uint16)
func (_TierProvider *TierProviderCaller) GetMinTier(opts *bind.CallOpts, _rand *big.Int) (uint16, error) {
	var out []interface{}
	err := _TierProvider.contract.Call(opts, &out, "getMinTier", _rand)
...
//
// Solidity: function getMinTier(uint256 _rand) pure returns(uint16)
func (_TierProvider *TierProviderSession) GetMinTier(_rand *big.Int) (uint16, error) {
	return _TierProvider.Contract.GetMinTier(&_TierProvider.CallOpts, _rand)
}

// GetMinTier is a free data retrieval call binding the contract method 0x59ab4e23.
//
// Solidity: function getMinTier(uint256 _rand) pure returns(uint16)
func (_TierProvider *TierProviderCallerSession) GetMinTier(_rand *big.Int) (uint16, error) {
	return _TierProvider.Contract.GetMinTier(&_TierProvider.CallOpts, _rand)
}
