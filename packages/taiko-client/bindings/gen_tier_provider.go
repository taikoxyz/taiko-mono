...
func (_TierProvider *TierProviderCaller) Impl(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _TierProvider.contract.Call(opts, &out, "impl")
...
//
// Solidity: function impl() view returns(address)
func (_TierProvider *TierProviderSession) Impl() (common.Address, error) {
	return _TierProvider.Contract.Impl(&_TierProvider.CallOpts)
}

// Impl is a free data retrieval call binding the contract method 0x8abf6077.
//
// Solidity: function impl() view returns(address)
func (_TierProvider *TierProviderCallerSession) Impl() (common.Address, error) {
	return _TierProvider.Contract.Impl(&_TierProvider.CallOpts)
}
