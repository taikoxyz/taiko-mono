...
func init() {
	...
	if PreconfTaskManagerABI, err = bindings.PreconfTaskManagerMetaData.GetAbi(); err != nil {
		log.Crit("Get PreconfTaskManagerABI ABI error", "error", err)
	}
