...
// IsProposerEligible is a free data retrieval call binding the contract method 0xee8a81ab.
//
// Solidity: function isProposerEligible(address _proposer) view returns(bool)
func (_SequencerRegistry *SequencerRegistryCaller) IsProposerEligible(opts *bind.CallOpts, _proposer common.Address) (bool, error) {
	var out []interface{}
	err := _SequencerRegistry.contract.Call(opts, &out, "isProposerEligible", _proposer)
...
//
// Solidity: function isProposerEligible(address _proposer) view returns(bool)
func (_SequencerRegistry *SequencerRegistrySession) IsProposerEligible(_proposer common.Address) (bool, error) {
	return _SequencerRegistry.Contract.IsProposerEligible(&_SequencerRegistry.CallOpts, _proposer)
}

// IsProposerEligible is a free data retrieval call binding the contract method 0xee8a81ab.
//
// Solidity: function isProposerEligible(address _proposer) view returns(bool)
func (_SequencerRegistry *SequencerRegistryCallerSession) IsProposerEligible(_proposer common.Address) (bool, error) {
	return _SequencerRegistry.Contract.IsProposerEligible(&_SequencerRegistry.CallOpts, _proposer)
}
