...
func (_GuardianProver *GuardianProverCaller) VerifyBatchProof(opts *bind.CallOpts, _ctxs []IVerifierContextV2, arg1 TaikoDataTierProof) error {
	var out []interface{}
	err := _GuardianProver.contract.Call(opts, &out, "verifyBatchProof", _ctxs, arg1)
...
func (_GuardianProver *GuardianProverSession) VerifyBatchProof(_ctxs []IVerifierContextV2, arg1 TaikoDataTierProof) error {
	return _GuardianProver.Contract.VerifyBatchProof(&_GuardianProver.CallOpts, _ctxs, arg1)
}
...
// EnableBondAllowance is a paid mutator transaction binding the contract method 0x640b4cac.
//
// Solidity: function enableBondAllowance(bool _enable) returns()
func (_GuardianProver *GuardianProverTransactor) EnableBondAllowance(opts *bind.TransactOpts, _enable bool) (*types.Transaction, error) {
	return _GuardianProver.contract.Transact(opts, "enableBondAllowance", _enable)
}

// EnableBondAllowance is a paid mutator transaction binding the contract method 0x640b4cac.
//
// Solidity: function enableBondAllowance(bool _enable) returns()
func (_GuardianProver *GuardianProverSession) EnableBondAllowance(_enable bool) (*types.Transaction, error) {
	return _GuardianProver.Contract.EnableBondAllowance(&_GuardianProver.TransactOpts, _enable)
}

// EnableBondAllowance is a paid mutator transaction binding the contract method 0x640b4cac.
//
// Solidity: function enableBondAllowance(bool _enable) returns()
func (_GuardianProver *GuardianProverTransactorSession) EnableBondAllowance(_enable bool) (*types.Transaction, error) {
	return _GuardianProver.Contract.EnableBondAllowance(&_GuardianProver.TransactOpts, _enable)
}
...
// WithdrawBond is a paid mutator transaction binding the contract method 0xca288f18.
//
// Solidity: function withdrawBond(address _to, uint256 _amount) returns()
func (_GuardianProver *GuardianProverTransactor) WithdrawBond(opts *bind.TransactOpts, _to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _GuardianProver.contract.Transact(opts, "withdrawBond", _to, _amount)
}

// WithdrawBond is a paid mutator transaction binding the contract method 0xca288f18.
//
// Solidity: function withdrawBond(address _to, uint256 _amount) returns()
func (_GuardianProver *GuardianProverSession) WithdrawBond(_to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _GuardianProver.Contract.WithdrawBond(&_GuardianProver.TransactOpts, _to, _amount)
}

// WithdrawBond is a paid mutator transaction binding the contract method 0xca288f18.
//
// Solidity: function withdrawBond(address _to, uint256 _amount) returns()
func (_GuardianProver *GuardianProverTransactorSession) WithdrawBond(_to common.Address, _amount *big.Int) (*types.Transaction, error) {
	return _GuardianProver.Contract.WithdrawBond(&_GuardianProver.TransactOpts, _to, _amount)
}
