...
// Approve2 is a paid mutator transaction binding the contract method 0x793b328a.
//
// Solidity: function approve2((bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint8) _meta2, (bytes32,bytes32,bytes32,bytes32) _tran, (uint16,bytes) _proof) returns(bool)
func (_GuardianProver *GuardianProverTransactor) Approve2(opts *bind.TransactOpts, _meta2 TaikoDataBlockMetadataV2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.contract.Transact(opts, "approve2", _meta2, _tran, _proof)
}

// Approve2 is a paid mutator transaction binding the contract method 0x793b328a.
//
// Solidity: function approve2((bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint8) _meta2, (bytes32,bytes32,bytes32,bytes32) _tran, (uint16,bytes) _proof) returns(bool)
func (_GuardianProver *GuardianProverSession) Approve2(_meta2 TaikoDataBlockMetadataV2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.Contract.Approve2(&_GuardianProver.TransactOpts, _meta2, _tran, _proof)
}

// Approve2 is a paid mutator transaction binding the contract method 0x793b328a.
//
// Solidity: function approve2((bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint8) _meta2, (bytes32,bytes32,bytes32,bytes32) _tran, (uint16,bytes) _proof) returns(bool)
func (_GuardianProver *GuardianProverTransactorSession) Approve2(_meta2 TaikoDataBlockMetadataV2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.Contract.Approve2(&_GuardianProver.TransactOpts, _meta2, _tran, _proof)
}
