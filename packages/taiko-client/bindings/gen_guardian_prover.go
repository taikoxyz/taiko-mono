...
//
// Solidity: function approvals(uint256 , bytes32 ) view returns(uint256)
func (_GuardianProver *GuardianProverCaller) Approvals(opts *bind.CallOpts, arg0 *big.Int, arg1 [32]byte) (*big.Int, error) {
	var out []interface{}
	err := _GuardianProver.contract.Call(opts, &out, "approvals", arg0, arg1)
...
//
// Solidity: function approvals(uint256 , bytes32 ) view returns(uint256)
func (_GuardianProver *GuardianProverSession) Approvals(arg0 *big.Int, arg1 [32]byte) (*big.Int, error) {
	return _GuardianProver.Contract.Approvals(&_GuardianProver.CallOpts, arg0, arg1)
}

// Approvals is a free data retrieval call binding the contract method 0x81e395f5.
//
// Solidity: function approvals(uint256 , bytes32 ) view returns(uint256)
func (_GuardianProver *GuardianProverCallerSession) Approvals(arg0 *big.Int, arg1 [32]byte) (*big.Int, error) {
	return _GuardianProver.Contract.Approvals(&_GuardianProver.CallOpts, arg0, arg1)
}

// GuardianIds is a free data retrieval call binding the contract method 0xb6158373.
//
// Solidity: function guardianIds(address ) view returns(uint256)
func (_GuardianProver *GuardianProverCaller) GuardianIds(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _GuardianProver.contract.Call(opts, &out, "guardianIds", arg0)
...
//
// Solidity: function guardianIds(address ) view returns(uint256)
func (_GuardianProver *GuardianProverSession) GuardianIds(arg0 common.Address) (*big.Int, error) {
	return _GuardianProver.Contract.GuardianIds(&_GuardianProver.CallOpts, arg0)
}

// GuardianIds is a free data retrieval call binding the contract method 0xb6158373.
//
// Solidity: function guardianIds(address ) view returns(uint256)
func (_GuardianProver *GuardianProverCallerSession) GuardianIds(arg0 common.Address) (*big.Int, error) {
	return _GuardianProver.Contract.GuardianIds(&_GuardianProver.CallOpts, arg0)
}
...
//
// Solidity: function latestProofHash(uint256 , uint256 ) view returns(bytes32)
func (_GuardianProver *GuardianProverCaller) LatestProofHash(opts *bind.CallOpts, arg0 *big.Int, arg1 *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _GuardianProver.contract.Call(opts, &out, "latestProofHash", arg0, arg1)
...
//
// Solidity: function latestProofHash(uint256 , uint256 ) view returns(bytes32)
func (_GuardianProver *GuardianProverSession) LatestProofHash(arg0 *big.Int, arg1 *big.Int) ([32]byte, error) {
	return _GuardianProver.Contract.LatestProofHash(&_GuardianProver.CallOpts, arg0, arg1)
}

// LatestProofHash is a free data retrieval call binding the contract method 0x56a10f42.
//
// Solidity: function latestProofHash(uint256 , uint256 ) view returns(bytes32)
func (_GuardianProver *GuardianProverCallerSession) LatestProofHash(arg0 *big.Int, arg1 *big.Int) ([32]byte, error) {
	return _GuardianProver.Contract.LatestProofHash(&_GuardianProver.CallOpts, arg0, arg1)
}
...
func (_GuardianProver *GuardianProverTransactor) ApproveV2(opts *bind.TransactOpts, _metaV2 TaikoDataBlockMetadataV2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.contract.Transact(opts, "approveV2", _metaV2, _tran, _proof)
}
...
func (_GuardianProver *GuardianProverSession) ApproveV2(_metaV2 TaikoDataBlockMetadataV2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.Contract.ApproveV2(&_GuardianProver.TransactOpts, _metaV2, _tran, _proof)
}
