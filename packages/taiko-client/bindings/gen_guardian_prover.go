...
func (_GuardianProver *GuardianProverTransactor) Approve2(opts *bind.TransactOpts, _meta2 TaikoDataBlockMetadata2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
...
//
// Solidity: function approve2((bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint8) _meta2, (bytes32,bytes32,bytes32,bytes32) _tran, (uint16,bytes) _proof) returns(bool)
func (_GuardianProver *GuardianProverSession) Approve2(_meta2 TaikoDataBlockMetadata2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
...
//
// Solidity: function approve2((bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint16,bool,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint8) _meta2, (bytes32,bytes32,bytes32,bytes32) _tran, (uint16,bytes) _proof) returns(bool)
func (_GuardianProver *GuardianProverTransactorSession) Approve2(_meta2 TaikoDataBlockMetadata2, _tran TaikoDataTransition, _proof TaikoDataTierProof) (*types.Transaction, error) {
	return _GuardianProver.Contract.Approve2(&_GuardianProver.TransactOpts, _meta2, _tran, _proof)
}
