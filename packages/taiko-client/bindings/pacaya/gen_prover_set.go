...
// ProposeBlocksV3 is a paid mutator transaction binding the contract method 0xedbf20b5.
//
...
func (_ProverSet *ProverSetTransactor) ProposeBlocksV3(opts *bind.TransactOpts, _paramsArray []ITaikoInboxBlockParamsV3, _txList []byte, _revertIfNotFirstProposal bool) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proposeBlocksV3", _paramsArray, _txList, _revertIfNotFirstProposal)
}

// ProposeBlocksV3 is a paid mutator transaction binding the contract method 0xedbf20b5.
//
// Solidity: function proposeBlocksV3((bytes32,uint64,bytes32,uint64,uint32,uint32,uint8,bytes32[])[] _paramsArray, bytes _txList, bool _revertIfNotFirstProposal) returns((bytes32,bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],bytes32,(uint8,uint8,uint32,uint64,uint32))[] metas_)
func (_ProverSet *ProverSetSession) ProposeBlocksV3(_paramsArray []ITaikoInboxBlockParamsV3, _txList []byte, _revertIfNotFirstProposal bool) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlocksV3(&_ProverSet.TransactOpts, _paramsArray, _txList, _revertIfNotFirstProposal)
}

// ProposeBlocksV3 is a paid mutator transaction binding the contract method 0xedbf20b5.
//
// Solidity: function proposeBlocksV3((bytes32,uint64,bytes32,uint64,uint32,uint32,uint8,bytes32[])[] _paramsArray, bytes _txList, bool _revertIfNotFirstProposal) returns((bytes32,bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],bytes32,(uint8,uint8,uint32,uint64,uint32))[] metas_)
func (_ProverSet *ProverSetTransactorSession) ProposeBlocksV3(_paramsArray []ITaikoInboxBlockParamsV3, _txList []byte, _revertIfNotFirstProposal bool) (*types.Transaction, error) {
	return _ProverSet.Contract.ProposeBlocksV3(&_ProverSet.TransactOpts, _paramsArray, _txList, _revertIfNotFirstProposal)
}
...
func (_ProverSet *ProverSetTransactor) ProveBlocksV3(opts *bind.TransactOpts, _metas []ITaikoInboxBlockMetadataV3, _transitions []ITaikoInboxTransitionV3, _proof []byte) (*types.Transaction, error) {
	return _ProverSet.contract.Transact(opts, "proveBlocksV3", _metas, _transitions, _proof)
}

// ProveBlocksV3 is a paid mutator transaction binding the contract method 0xf0c00397.
//
// Solidity: function proveBlocksV3((bytes32,bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],bytes32,(uint8,uint8,uint32,uint64,uint32))[] _metas, (bytes32,bytes32,bytes32)[] _transitions, bytes _proof) returns()
func (_ProverSet *ProverSetSession) ProveBlocksV3(_metas []ITaikoInboxBlockMetadataV3, _transitions []ITaikoInboxTransitionV3, _proof []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProveBlocksV3(&_ProverSet.TransactOpts, _metas, _transitions, _proof)
}

// ProveBlocksV3 is a paid mutator transaction binding the contract method 0xf0c00397.
//
// Solidity: function proveBlocksV3((bytes32,bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],bytes32,(uint8,uint8,uint32,uint64,uint32))[] _metas, (bytes32,bytes32,bytes32)[] _transitions, bytes _proof) returns()
func (_ProverSet *ProverSetTransactorSession) ProveBlocksV3(_metas []ITaikoInboxBlockMetadataV3, _transitions []ITaikoInboxTransitionV3, _proof []byte) (*types.Transaction, error) {
	return _ProverSet.Contract.ProveBlocksV3(&_ProverSet.TransactOpts, _metas, _transitions, _proof)
}
