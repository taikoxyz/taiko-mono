...
func (_ProverSet *ProverSetCaller) ResolveAddress(opts *bind.CallOpts, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _ProverSet.contract.Call(opts, &out, "resolveAddress", _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ProverSet *ProverSetSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ProverSet.Contract.ResolveAddress(&_ProverSet.CallOpts, _name, _allowZeroAddress)
}

// ResolveAddress is a free data retrieval call binding the contract method 0x10d3a3be.
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ProverSet *ProverSetCallerSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ProverSet.Contract.ResolveAddress(&_ProverSet.CallOpts, _name, _allowZeroAddress)
}
...
func (_ProverSet *ProverSetCaller) ResolveAddress0(opts *bind.CallOpts, _chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _ProverSet.contract.Call(opts, &out, "resolveAddress0", _chainId, _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ProverSet *ProverSetSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ProverSet.Contract.ResolveAddress0(&_ProverSet.CallOpts, _chainId, _name, _allowZeroAddress)
}

// ResolveAddress0 is a free data retrieval call binding the contract method 0x1e5b3921.
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ProverSet *ProverSetCallerSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ProverSet.Contract.ResolveAddress0(&_ProverSet.CallOpts, _chainId, _name, _allowZeroAddress)
}
