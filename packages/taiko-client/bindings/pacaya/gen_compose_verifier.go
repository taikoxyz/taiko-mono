...
func (_ComposeVerifier *ComposeVerifierCaller) PendingOwner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "pendingOwner")
...
func (_ComposeVerifier *ComposeVerifierSession) PendingOwner() (common.Address, error) {
	return _ComposeVerifier.Contract.PendingOwner(&_ComposeVerifier.CallOpts)
}
...
func (_ComposeVerifier *ComposeVerifierCaller) Resolve(opts *bind.CallOpts, _chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "resolve", _chainId, _name, _allowZeroAddress)
...
//
// Solidity: function resolve(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ComposeVerifier *ComposeVerifierSession) Resolve(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ComposeVerifier.Contract.Resolve(&_ComposeVerifier.CallOpts, _chainId, _name, _allowZeroAddress)
}

// Resolve is a free data retrieval call binding the contract method 0x3eb6b8cf.
//
// Solidity: function resolve(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ComposeVerifier *ComposeVerifierCallerSession) Resolve(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ComposeVerifier.Contract.Resolve(&_ComposeVerifier.CallOpts, _chainId, _name, _allowZeroAddress)
}
...
func (_ComposeVerifier *ComposeVerifierCaller) Resolve0(opts *bind.CallOpts, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _ComposeVerifier.contract.Call(opts, &out, "resolve0", _name, _allowZeroAddress)
...
//
// Solidity: function resolve(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ComposeVerifier *ComposeVerifierSession) Resolve0(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ComposeVerifier.Contract.Resolve0(&_ComposeVerifier.CallOpts, _name, _allowZeroAddress)
}

// Resolve0 is a free data retrieval call binding the contract method 0xa86f9d9e.
//
// Solidity: function resolve(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_ComposeVerifier *ComposeVerifierCallerSession) Resolve0(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _ComposeVerifier.Contract.Resolve0(&_ComposeVerifier.CallOpts, _name, _allowZeroAddress)
}
...
func (_ComposeVerifier *ComposeVerifierTransactor) AcceptOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ComposeVerifier.contract.Transact(opts, "acceptOwnership")
}
...
func (_ComposeVerifier *ComposeVerifierSession) AcceptOwnership() (*types.Transaction, error) {
	return _ComposeVerifier.Contract.AcceptOwnership(&_ComposeVerifier.TransactOpts)
}
...
func (_ComposeVerifier *ComposeVerifierTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.contract.Transact(opts, "init", _owner, _rollupResolver)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _rollupResolver) returns()
func (_ComposeVerifier *ComposeVerifierSession) Init(_owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.Contract.Init(&_ComposeVerifier.TransactOpts, _owner, _rollupResolver)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _rollupResolver) returns()
func (_ComposeVerifier *ComposeVerifierTransactorSession) Init(_owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.Contract.Init(&_ComposeVerifier.TransactOpts, _owner, _rollupResolver)
}
...
func (_ComposeVerifier *ComposeVerifierTransactor) SetResolver(opts *bind.TransactOpts, _resolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.contract.Transact(opts, "setResolver", _resolver)
}

// SetResolver is a paid mutator transaction binding the contract method 0x4e543b26.
//
// Solidity: function setResolver(address _resolver) returns()
func (_ComposeVerifier *ComposeVerifierSession) SetResolver(_resolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.Contract.SetResolver(&_ComposeVerifier.TransactOpts, _resolver)
}

// SetResolver is a paid mutator transaction binding the contract method 0x4e543b26.
//
// Solidity: function setResolver(address _resolver) returns()
func (_ComposeVerifier *ComposeVerifierTransactorSession) SetResolver(_resolver common.Address) (*types.Transaction, error) {
	return _ComposeVerifier.Contract.SetResolver(&_ComposeVerifier.TransactOpts, _resolver)
}
...
type ComposeVerifierOwnershipTransferStartedIterator struct {
	Event *ComposeVerifierOwnershipTransferStarted // Event containing the contract specifics and raw log
...
func (it *ComposeVerifierOwnershipTransferStartedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ComposeVerifierOwnershipTransferStarted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ComposeVerifierOwnershipTransferStarted struct {
...
func (_ComposeVerifier *ComposeVerifierFilterer) FilterOwnershipTransferStarted(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*ComposeVerifierOwnershipTransferStartedIterator, error) {
	...
	logs, sub, err := _ComposeVerifier.contract.FilterLogs(opts, "OwnershipTransferStarted", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &ComposeVerifierOwnershipTransferStartedIterator{contract: _ComposeVerifier.contract, event: "OwnershipTransferStarted", logs: logs, sub: sub}, nil
}
...
func (_ComposeVerifier *ComposeVerifierFilterer) WatchOwnershipTransferStarted(opts *bind.WatchOpts, sink chan<- *ComposeVerifierOwnershipTransferStarted, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ComposeVerifier.contract.WatchLogs(opts, "OwnershipTransferStarted", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ComposeVerifierOwnershipTransferStarted)
				if err := _ComposeVerifier.contract.UnpackLog(event, "OwnershipTransferStarted", log); err != nil {
					return err
				}
				event.Raw = log
...
// ComposeVerifierResolverUpdatedIterator is returned from FilterResolverUpdated and is used to iterate over the raw logs and unpacked data for ResolverUpdated events raised by the ComposeVerifier contract.
type ComposeVerifierResolverUpdatedIterator struct {
	Event *ComposeVerifierResolverUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ComposeVerifierResolverUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ComposeVerifierResolverUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ComposeVerifierResolverUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ComposeVerifierResolverUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ComposeVerifierResolverUpdated represents a ResolverUpdated event raised by the ComposeVerifier contract.
type ComposeVerifierResolverUpdated struct {
...
func (_ComposeVerifier *ComposeVerifierFilterer) FilterResolverUpdated(opts *bind.FilterOpts) (*ComposeVerifierResolverUpdatedIterator, error) {

	logs, sub, err := _ComposeVerifier.contract.FilterLogs(opts, "ResolverUpdated")
	if err != nil {
		return nil, err
	}
	return &ComposeVerifierResolverUpdatedIterator{contract: _ComposeVerifier.contract, event: "ResolverUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ResolverUpdated(address oldResolver, address newResolver)
func (_ComposeVerifier *ComposeVerifierFilterer) WatchResolverUpdated(opts *bind.WatchOpts, sink chan<- *ComposeVerifierResolverUpdated) (event.Subscription, error) {

	logs, sub, err := _ComposeVerifier.contract.WatchLogs(opts, "ResolverUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ComposeVerifierResolverUpdated)
				if err := _ComposeVerifier.contract.UnpackLog(event, "ResolverUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ResolverUpdated(address oldResolver, address newResolver)
func (_ComposeVerifier *ComposeVerifierFilterer) ParseResolverUpdated(log types.Log) (*ComposeVerifierResolverUpdated, error) {
	event := new(ComposeVerifierResolverUpdated)
	if err := _ComposeVerifier.contract.UnpackLog(event, "ResolverUpdated", log); err != nil {
		return nil, err
	}
