...
func (_TaikoToken *TaikoTokenCaller) ResolveAddress(opts *bind.CallOpts, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoToken.contract.Call(opts, &out, "resolveAddress", _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoToken *TaikoTokenSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoToken.Contract.ResolveAddress(&_TaikoToken.CallOpts, _name, _allowZeroAddress)
}

// ResolveAddress is a free data retrieval call binding the contract method 0x10d3a3be.
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoToken *TaikoTokenCallerSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoToken.Contract.ResolveAddress(&_TaikoToken.CallOpts, _name, _allowZeroAddress)
}
...
func (_TaikoToken *TaikoTokenCaller) ResolveAddress0(opts *bind.CallOpts, _chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoToken.contract.Call(opts, &out, "resolveAddress0", _chainId, _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoToken *TaikoTokenSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoToken.Contract.ResolveAddress0(&_TaikoToken.CallOpts, _chainId, _name, _allowZeroAddress)
}

// ResolveAddress0 is a free data retrieval call binding the contract method 0x1e5b3921.
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoToken *TaikoTokenCallerSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoToken.Contract.ResolveAddress0(&_TaikoToken.CallOpts, _chainId, _name, _allowZeroAddress)
}
...
func (_TaikoToken *TaikoTokenTransactor) BatchTransfer(opts *bind.TransactOpts, recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _TaikoToken.contract.Transact(opts, "batchTransfer", recipients, amounts)
}
...
func (_TaikoToken *TaikoTokenSession) BatchTransfer(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _TaikoToken.Contract.BatchTransfer(&_TaikoToken.TransactOpts, recipients, amounts)
}
