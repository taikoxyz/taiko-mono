...
//
// Solidity: function getBatch(uint64 _batchId) view returns((bytes32,uint64,uint96,uint96,uint64,uint64,uint24,uint8,uint24) batch_)
...
//
// Solidity: function proposeBatch(bytes _params, bytes _txList) returns((bytes32,(bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,bytes32,(uint64,uint64,uint64,uint64,uint32,uint96,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,(uint64,uint64,uint64,uint64))) info_, (bytes32,address,uint64,uint64) meta_)
...
// FilterBatchProposed is a free log retrieval operation binding the contract event 0x0b64ce80f275cf597bb86b947814f56fb2506264c9c66fc43fc36f300805eee3.
//
// Solidity: event BatchProposed((bytes32,(bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,bytes32,(uint64,uint64,uint64,uint64,uint32,uint96,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,(uint64,uint64,uint64,uint64))) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// WatchBatchProposed is a free log subscription operation binding the contract event 0x0b64ce80f275cf597bb86b947814f56fb2506264c9c66fc43fc36f300805eee3.
//
// Solidity: event BatchProposed((bytes32,(bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,bytes32,(uint64,uint64,uint64,uint64,uint32,uint96,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,(uint64,uint64,uint64,uint64))) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// ParseBatchProposed is a log parse operation binding the contract event 0x0b64ce80f275cf597bb86b947814f56fb2506264c9c66fc43fc36f300805eee3.
//
// Solidity: event BatchProposed((bytes32,(bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint64,uint64,bytes32,(uint64,uint64,uint64,uint64,uint32,uint96,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint32),uint16,uint24,uint8,uint16,(uint64,uint64,uint64,uint64))) info, (bytes32,address,uint64,uint64) meta, bytes txList)
