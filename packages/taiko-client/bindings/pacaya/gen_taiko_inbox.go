...
//
// Solidity: function getBatch(uint64 _batchId) view returns((bytes32,uint64,uint192,uint64,uint64,uint64,uint24,uint8,uint24) batch_)
...
// ProveBatches is a paid mutator transaction binding the contract method 0x2fc380a8.
//
// Solidity: function proveBatches((bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],(uint16,uint8)[],bytes32,(uint8,uint8,uint32,uint64,uint32))[] _metas, (bytes32,bytes32,bytes32)[] _transitions, bytes _proof) returns()
...
// FilterBatchProposed is a free log retrieval operation binding the contract event 0x574559c5d82e2cdd258a0232038efbcceb719d5e484763d5df43b7b90ebc0637.
//
// Solidity: event BatchProposed((bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],(uint16,uint8)[],bytes32,(uint8,uint8,uint32,uint64,uint32)) meta, bool calldataUsed, bytes txListInCalldata)
...
// WatchBatchProposed is a free log subscription operation binding the contract event 0x574559c5d82e2cdd258a0232038efbcceb719d5e484763d5df43b7b90ebc0637.
//
// Solidity: event BatchProposed((bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],(uint16,uint8)[],bytes32,(uint8,uint8,uint32,uint64,uint32)) meta, bool calldataUsed, bytes txListInCalldata)
...
// ParseBatchProposed is a log parse operation binding the contract event 0x574559c5d82e2cdd258a0232038efbcceb719d5e484763d5df43b7b90ebc0637.
//
// Solidity: event BatchProposed((bytes32,bytes32,address,uint64,uint32,uint64,bytes32,address,uint96,uint64,uint64,uint32,uint32,uint8,uint64,bytes32,bytes32[],(uint16,uint8)[],bytes32,(uint8,uint8,uint32,uint64,uint32)) meta, bool calldataUsed, bytes txListInCalldata)
