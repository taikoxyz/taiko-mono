...
//
// Solidity: function getTransitionById(uint64 _batchId, uint24 _tid) view returns((bytes32,bytes32,bytes32,address,bool))
...
//
// Solidity: function getTransitionByParentHash(uint64 _batchId, bytes32 _parentHash) view returns((bytes32,bytes32,bytes32,address,bool))
...
//
// Solidity: function pacayaConfig() view returns((uint64,uint64,uint64,uint64,uint32,uint96,uint96,uint8,uint64,(uint8,uint8,uint32,uint64,uint32),uint16,uint8,uint16,(uint64,uint64)))
...
// ResolveAddress is a free data retrieval call binding the contract method 0x10d3a3be.
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCaller) ResolveAddress(opts *bind.CallOpts, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "resolveAddress", _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoInboxClient.Contract.ResolveAddress(&_TaikoInboxClient.CallOpts, _name, _allowZeroAddress)
}

// ResolveAddress is a free data retrieval call binding the contract method 0x10d3a3be.
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoInboxClient.Contract.ResolveAddress(&_TaikoInboxClient.CallOpts, _name, _allowZeroAddress)
}

// ResolveAddress0 is a free data retrieval call binding the contract method 0x1e5b3921.
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCaller) ResolveAddress0(opts *bind.CallOpts, _chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoInboxClient.contract.Call(opts, &out, "resolveAddress0", _chainId, _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoInboxClient.Contract.ResolveAddress0(&_TaikoInboxClient.CallOpts, _chainId, _name, _allowZeroAddress)
}

// ResolveAddress0 is a free data retrieval call binding the contract method 0x1e5b3921.
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoInboxClient *TaikoInboxClientCallerSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoInboxClient.Contract.ResolveAddress0(&_TaikoInboxClient.CallOpts, _chainId, _name, _allowZeroAddress)
}
