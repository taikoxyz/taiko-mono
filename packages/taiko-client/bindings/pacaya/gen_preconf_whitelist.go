...
// GetOperatorForEpoch is a free data retrieval call binding the contract method 0x57dce9ea.
//
// Solidity: function getOperatorForEpoch() view returns(address)
func (_PreconfWhitelist *PreconfWhitelistCaller) GetOperatorForEpoch(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _PreconfWhitelist.contract.Call(opts, &out, "getOperatorForEpoch")
...
//
// Solidity: function getOperatorForEpoch() view returns(address)
func (_PreconfWhitelist *PreconfWhitelistSession) GetOperatorForEpoch() (common.Address, error) {
	return _PreconfWhitelist.Contract.GetOperatorForEpoch(&_PreconfWhitelist.CallOpts)
}

// GetOperatorForEpoch is a free data retrieval call binding the contract method 0x57dce9ea.
//
// Solidity: function getOperatorForEpoch() view returns(address)
func (_PreconfWhitelist *PreconfWhitelistCallerSession) GetOperatorForEpoch() (common.Address, error) {
	return _PreconfWhitelist.Contract.GetOperatorForEpoch(&_PreconfWhitelist.CallOpts)
}
