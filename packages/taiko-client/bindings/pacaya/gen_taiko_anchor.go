...
func (_TaikoAnchorClient *TaikoAnchorClientCaller) ResolveAddress(opts *bind.CallOpts, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "resolveAddress", _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoAnchorClient *TaikoAnchorClientSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoAnchorClient.Contract.ResolveAddress(&_TaikoAnchorClient.CallOpts, _name, _allowZeroAddress)
}

// ResolveAddress is a free data retrieval call binding the contract method 0x10d3a3be.
//
// Solidity: function resolveAddress(bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) ResolveAddress(_name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoAnchorClient.Contract.ResolveAddress(&_TaikoAnchorClient.CallOpts, _name, _allowZeroAddress)
}
...
func (_TaikoAnchorClient *TaikoAnchorClientCaller) ResolveAddress0(opts *bind.CallOpts, _chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	var out []interface{}
	err := _TaikoAnchorClient.contract.Call(opts, &out, "resolveAddress0", _chainId, _name, _allowZeroAddress)
...
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoAnchorClient *TaikoAnchorClientSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoAnchorClient.Contract.ResolveAddress0(&_TaikoAnchorClient.CallOpts, _chainId, _name, _allowZeroAddress)
}

// ResolveAddress0 is a free data retrieval call binding the contract method 0x1e5b3921.
//
// Solidity: function resolveAddress(uint64 _chainId, bytes32 _name, bool _allowZeroAddress) view returns(address)
func (_TaikoAnchorClient *TaikoAnchorClientCallerSession) ResolveAddress0(_chainId uint64, _name [32]byte, _allowZeroAddress bool) (common.Address, error) {
	return _TaikoAnchorClient.Contract.ResolveAddress0(&_TaikoAnchorClient.CallOpts, _chainId, _name, _allowZeroAddress)
}
