...
//
// Solidity: function anchorV3(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) , bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientTransactor) AnchorV3(opts *bind.TransactOpts, _anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, arg3 LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.contract.Transact(opts, "anchorV3", _anchorBlockId, _anchorStateRoot, _parentGasUsed, arg3, _signalSlots)
}

// AnchorV3 is a paid mutator transaction binding the contract method 0x48080a45.
//
// Solidity: function anchorV3(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) , bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientSession) AnchorV3(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, arg3 LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.Contract.AnchorV3(&_TaikoAnchorClient.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, arg3, _signalSlots)
}

// AnchorV3 is a paid mutator transaction binding the contract method 0x48080a45.
//
// Solidity: function anchorV3(uint64 _anchorBlockId, bytes32 _anchorStateRoot, uint32 _parentGasUsed, (uint8,uint8,uint32,uint64,uint32) , bytes32[] _signalSlots) returns()
func (_TaikoAnchorClient *TaikoAnchorClientTransactorSession) AnchorV3(_anchorBlockId uint64, _anchorStateRoot [32]byte, _parentGasUsed uint32, arg3 LibSharedDataBaseFeeConfig, _signalSlots [][32]byte) (*types.Transaction, error) {
	return _TaikoAnchorClient.Contract.AnchorV3(&_TaikoAnchorClient.TransactOpts, _anchorBlockId, _anchorStateRoot, _parentGasUsed, arg3, _signalSlots)
}
