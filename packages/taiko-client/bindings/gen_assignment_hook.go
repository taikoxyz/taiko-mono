...
// OnBlockProposed is a paid mutator transaction binding the contract method 0x37fa8e23.
//
// Solidity: function onBlockProposed((bytes32,address,uint96,uint64,uint64,uint64,uint32,uint32) _blk, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32,address) _meta, bytes _data) payable returns()
...
// FilterBlockAssigned is a free log retrieval operation binding the contract event 0x98c474a0b61cdccdf24e6bfbf4eb6d092cd8a3aa15d452800d5bed1b6087e664.
//
// Solidity: event BlockAssigned(address indexed assignedProver, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32,address) meta, (address,uint64,uint64,uint64,bytes32,bytes32,(uint16,uint128)[],bytes) assignment)
...
// WatchBlockAssigned is a free log subscription operation binding the contract event 0x98c474a0b61cdccdf24e6bfbf4eb6d092cd8a3aa15d452800d5bed1b6087e664.
//
// Solidity: event BlockAssigned(address indexed assignedProver, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32,address) meta, (address,uint64,uint64,uint64,bytes32,bytes32,(uint16,uint128)[],bytes) assignment)
...
// ParseBlockAssigned is a log parse operation binding the contract event 0x98c474a0b61cdccdf24e6bfbf4eb6d092cd8a3aa15d452800d5bed1b6087e664.
//
// Solidity: event BlockAssigned(address indexed assignedProver, (bytes32,bytes32,bytes32,bytes32,bytes32,address,uint64,uint32,uint64,uint64,uint24,uint24,uint16,bool,bytes32,address) meta, (address,uint64,uint64,uint64,bytes32,bytes32,(uint16,uint128)[],bytes) assignment)
