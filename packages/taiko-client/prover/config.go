...
type Config struct {
	...
	RaikoHostEndpointPacaya     string
	RaikoZKVMHostEndpointPacaya string
}
...
func NewConfigFromCliContext(c *cli.Context) (*Config, error) {
	...
	return &Config{
		...
		RaikoHostEndpointPacaya:     c.String(flags.RaikoHostEndpointPacaya.Name),
		RaikoZKVMHostEndpointPacaya: c.String(flags.RaikoZKVMHostEndpointPacaya.Name),
