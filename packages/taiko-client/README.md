...
Taiko Alethia protocol's client software implementation in Go. Learn more about running Taiko Alethia nodes in the [simple-taiko-node repository](https://github.com/taikoxyz/simple-taiko-node).
