...
// BlocksInserterShasta is responsible for inserting Shasta blocks to the L2 execution engine.
type BlocksInserterShasta struct {
	rpc                  *rpc.Client
...
// NewBlocksInserterShasta creates a new BlocksInserterShasta instance.
func NewBlocksInserterShasta(
	...
	blobFetcher txlistFetcher.TxListFetcher,
	latestSeenProposalCh chan *encoding.LastSeenProposal,
) *BlocksInserterShasta {
	return &BlocksInserterShasta{
		rpc:                  rpc,
...
func (i *BlocksInserterShasta) InsertBlocks(
	ctx context.Context,
...
func (i *BlocksInserterShasta) InsertPreconfBlocksFromExecutionPayloads(
	ctx context.Context,
...
func (i *BlocksInserterShasta) insertPreconfBlockFromExecutionPayload(
	ctx context.Context,
...
func (i *BlocksInserterShasta) RemovePreconfBlocks(ctx context.Context, newLastBlockID uint64) error {
	i.mutex.Lock()
	defer i.mutex.Unlock()
...
func (i *BlocksInserterShasta) IsBasedOnCanonicalChain(
	ctx context.Context,
	executableData *eth.ExecutionPayload,
...
func (i *BlocksInserterShasta) sendLatestSeenProposal(proposal *encoding.LastSeenProposal) {
