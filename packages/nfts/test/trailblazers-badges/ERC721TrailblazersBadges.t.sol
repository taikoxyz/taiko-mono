...
import { ERC721TrailblazersBadges } from
    "../../contracts/trailblazers-badges/ERC721TrailblazersBadges.sol";
...
contract ERC721TrailblazersBadgesTest is Test {
    UtilsScript public utils;

    ERC721TrailblazersBadges public token;
    ...
    function setUp() public {
        ...
        address impl = address(new ERC721TrailblazersBadges());
        address proxy = address(
            new ERC1967Proxy(
                impl,
                abi.encodeCall(
                    ERC721TrailblazersBadges.initialize, (owner, "ipfs://", mintSigner, blacklist)
                )
            )
        );

        token = ERC721TrailblazersBadges(proxy);
