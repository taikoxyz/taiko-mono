...
<div style="display: flex; gap: 1rem; margin: 2rem 0;">
  ...
  <NetworkAdder network="Taiko Hekla" />
  <NetworkAdder network="Taiko Tolba" />
</div>
...
- Network Name: Taiko Tolba (based on the Hoodi testnet)
- RPC URL: https://rpc.tolba.taiko.xyz
- Chain ID: 167012
- Currency Symbol: ETH
- Block Explorer URL: https://blockscout.tolba.taiko.xyz/
