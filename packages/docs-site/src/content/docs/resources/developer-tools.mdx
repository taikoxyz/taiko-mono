...
<CardGrid>
  <LinkCard
    title="Tenderly"
    description="Tenderly is an all-in-one Web3 development platform that empowers developers to build, test, monitor, and operate smart contracts from inception to mass adoption."
