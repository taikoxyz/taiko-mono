...
You can find all L1 and L2 contract addresses of the latest smart contract deployments of the Taiko Alethia Protocol [here](https://github.com/taikoxyz/taiko-mono/blob/main/packages/protocol/deployments/tolba-contract-logs.md).
