...
You can find all the corresponding values below for Alethia in the [deployed TierProviderBase contract](https://etherscan.io/address/0x394E30d83d020469a1F8b16E89D7fD5FdB1935b0#code#F3#L1)!
...
![alethia proof tiers](~/assets/content/docs/network-reference/proof-tier-config-alethia.webp)

If the function of the bonds is not clear to you, please find out more [here](/resources/terminology#bonding-related).

## Network configuration (Alethia)
