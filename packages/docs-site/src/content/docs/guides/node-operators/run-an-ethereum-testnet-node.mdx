...
4. Start Docker containers
    <Aside type="tip">
    The Fusaka upgrade is rolling out to Ethereum Hoodi October 28, 2025, at slot 1,622,016. This means that if you are not running an Ethereum Hoodi semi-supernode or supernode beacon client,
