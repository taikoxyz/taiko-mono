...
### Ensure that your node has joined the P2P network
  ...
  As long as `connected=X` is greater than or equal to 4, your node should have joined the P2P network correctly! If it is below that, please reach out to us on Discord for troubleshooting help.
