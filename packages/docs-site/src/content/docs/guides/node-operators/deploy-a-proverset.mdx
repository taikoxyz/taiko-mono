...
1. **Clone the Taiko monorepo**
    ...
    The <NewTabLink href="https://github.com/taikoxyz/taiko-mono" text="Taiko monorepo"/> contains the scripts for deploying your `ProverSet`.
...
2. **Deploy the ProverSet**
    ...
    Run the `DeployProverSet.s.sol` script with your **proposer's private key**. You can find the script <NewTabLink href="https://github.com/taikoxyz/taiko-mono/tree/main/packages/protocol/script/DeployProverSet.s.sol" text="here"/>.
...
5. **Configure the contract as necessary**
    ...
    Manage the contract's allowance with <NewTabLink href="https://github.com/taikoxyz/taiko-mono/blob/116d3f4886dea01333b829677ec9b6d4492479c6/packages/protocol/contracts/team/proving/ProverSet.sol#L63" text="approveAllowance()"/>. TaikoL1's contract allowance is by default set to `UINT256.MAX` in the init function.
...
6. **Deposit your tokens and run your proposer + prover as usual!**
    ...
    <Aside>
    You can withdraw the deposited tokens to the `admin` address with <NewTabLink href="https://github.com/taikoxyz/taiko-mono/blob/116d3f4886dea01333b829677ec9b6d4492479c6/packages/protocol/contracts/team/proving/ProverSet.sol#L76" text="withdrawToAdmin()"/>.
    </Aside>
...
### Where is my TTKOh/TAIKO?
    ...
    It's not missing, it's just been deposited as bond in the TaikoL1 contract; you can withdraw it from the ProverSet contract with <NewTabLink href="https://github.com/taikoxyz/taiko-mono/blob/dd09223de53669b84241672eeb4b8574e5c7f821/packages/protocol/contracts/team/proving/ProverSet.sol#L110" text="withdrawBond()"/> manually.
