...
2. **Deploy the ProverSet**
    ...
    <Tabs>
      ...
      ```bash
      PRIVATE_KEY={PRIVATE_KEY} OWNER={OWNER_ADDRESS} ADMIN={ADMIN_ADDRESS} TAIKO_TOKEN=0x10dea67478c5F8C5E2D90e5E9B26dBe60c54d800 ENTRYPOINT=0x9F9D2fC7abe74C79f86F0D1212107692430eef72 INBOX=0x06a9Ab27c7e2255df1815E6CC0168d7755Feb19a forge script --evm-version cancun --chain-id 1 --rpc-url {YOUR_RPC_URL} --broadcast script/layer1/DeployProverSet.s.sol:DeployProverSet
      ```
