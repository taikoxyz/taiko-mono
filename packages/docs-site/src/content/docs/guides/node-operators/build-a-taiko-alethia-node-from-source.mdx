...
2. Checkout the release branch you wish to run
    ...
    Some may be specific to Taiko Hekla, Taiko Hoodi or Taiko Alethia.
    </Aside>
...
## What's Next?
    Now that you've built your own node from source, you can run it for Taiko Hekla, Taiko Hoodi or Taiko Alethia!
...
<CardGrid stagger>
    ...
    <Card title="Taiko Hoodi Node" icon="laptop">
        Click here to [run a node for Taiko Hoodi](/guides/node-operators/run-a-node-for-taiko-hoodi)!
    </Card>
