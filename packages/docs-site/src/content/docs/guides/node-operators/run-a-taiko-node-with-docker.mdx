...
2. Checkout the release branch you wish to run
    ...
    Find the branch you wish to check out in the [repository](https://github.com/taikoxyz/simple-taiko-node/branches). 

    The `main` branch corresponds to our mainnet, and the `hekla` branch corresponds to our current live testnet.
