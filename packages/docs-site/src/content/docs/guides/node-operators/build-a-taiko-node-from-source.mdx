...
2. Checkout the release branch you wish to run
    ...
    Some may be specific to Hekla or Alethia.
    </Aside>
...
## What's Next?
    Now that you've built your own node from source, you can run it for Taiko Alethia or Hekla!

<CardGrid stagger>
    <Card title="Taiko Alethia Node" icon="laptop">
        Click here to [Run a Taiko Alethia Node from Source](/guides/node-operators/run-a-taiko-alethia-node-from-source)!
    </Card>
     <Card title="Taiko Hekla Node" icon="laptop">
        Click here to [Run a Taiko Hekla Node from Source](/guides/node-operators/run-a-taiko-hekla-node-from-source)!
    </Card>
