...
3. Set environment variables
    ...
    <Aside type="tip">
    The Fusaka upgrade is rolling out to Ethereum Hoodi October 28, 2025, at slot 1,622,016. With this upgrade comes [EIP-7594](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7594.md),
    which introduces data sampling instead of full downloads; this means that if you are not running an Etherum Hoodi semi-supernode or supernode beacon client,
    ...
    Alternatively, you may set a `--blob.server` url if you wish to use a a thirdparty or self hosted blob indexer service.
