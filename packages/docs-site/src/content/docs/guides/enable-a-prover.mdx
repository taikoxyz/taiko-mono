...
Finally you can choose to register your prover endpoint on the <a href="https://dojonode.xyz/tatami" target="_blank">communiy prover marketplace</a> so other can use it to propose blocks.
