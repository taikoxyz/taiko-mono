...
1. Set up the environment
    ...
    To effectively use Hardhat, your system must have <NewTabLink href="https://nodejs.org/en/" text="Node.js"/> (v10+ LTS) and npm installed.

    <Aside type="tip">
    If you are using Windows, we strongly recommend using <NewTabLink href="https://learn.microsoft.com/en-us/assessments/" text="WSL 2"/> to follow this guide.
    </Aside>
...
2. Deploying with Thirdweb
    ...
    5. Complete Deployment Details
        ...
        For a more detailed documentation on deployments through Thirdweb using CLI, visit <NewTabLink href="https://portal.thirdweb.com/cli" text="Thirdweb CLI Docs"/>.
