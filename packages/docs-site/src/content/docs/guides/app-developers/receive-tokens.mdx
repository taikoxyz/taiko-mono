...
HORSE is a dummy testnet token we deployed on Taiko Hekla. You can see all deployed contracts [here](/network-reference/hekla-addresses). Navigate to the [bridge](https://bridge.hekla.taiko.xyz) and click "Faucet" on the sidebar to receive some HORSE.
