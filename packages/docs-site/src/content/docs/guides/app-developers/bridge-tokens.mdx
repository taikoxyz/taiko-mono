...
This guide will help you use the bridge to send tokens between L1 and L2. This means Holesky and Taiko Hekla, or Hoodi and Taiko Hoodi.

## Prerequisites

- A wallet with some ETH on Ethereum Mainnet/Taiko, or some testnet ETH on Holesky/Taiko Hekla, or Ethereum Hoodi/Taiko Hoodi.
