...
1. First, you will need to have a prover from <a href="https://dojonode.xyz/tatami" target="_blank">the communiy marketplace</a>, [the official marketplace](/resources/prover-marketplace) or [run your own SGX prover](/guides/enable-a-prover).
