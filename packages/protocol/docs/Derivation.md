...
| **MAX_ANCHOR_OFFSET**            | Hoodi: `128`, Mainnet: `512`                           | The maximum anchor block number offset from the proposal origin block number. Keep the legacy Hoodi value (`128`), and use the new mainnet value (`512` blocks). |
| **TIMESTAMP_MAX_OFFSET**         | Hoodi: `1536` (12 \* 128), Mainnet: `6144` (12 \* 512) | The maximum timestamp offset from the proposal origin timestamp. Keep the legacy Hoodi value (`1536` seconds), and use the new mainnet value (`6144` seconds).   |
