...
After all calculation above, another `1_000,000` gas limit will be added on top of the final value, reserving headroom for the mandatory `Anchor.updateState` transaction.
