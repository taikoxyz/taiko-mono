...
[`IInbox.Proposed`](../contracts/layer1/core/iface/IInbox.sol#L172-L186)).
...
[`IInbox.DerivationSource`](../contracts/layer1/core/iface/IInbox.sol#L49-L55)). Each source includes a `blobSlice` field that serves as the primary mechanism for locating and validating proposal metadata. Responsibilities are split as follows:
