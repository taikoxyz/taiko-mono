...
| **TIMESTAMP_MAX_OFFSET**         | `21600` (12 \* 1800)          | The maximum number timestamp offset from the proposal origin timestamp. This is set to longer than an epoch to allow the next proposer to recover without causing a reorg. |
