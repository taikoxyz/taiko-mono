...
| **MAX_ANCHOR_OFFSET**            | Hoodi: `128`, Mainnet: `1800`                            | The maximum anchor block number offset from the proposal origin block number. Keep the legacy Hoodi value (`128`), and use the 6-hour window (`1800` blocks) on mainnet. |
| **TIMESTAMP_MAX_OFFSET**         | Hoodi: `1536` (12 \* 128), Mainnet: `21600` (12 \* 1800) | The maximum timestamp offset from the proposal origin timestamp. Keep the legacy Hoodi value (`1536` seconds), and use the 6-hour window (`21600` seconds) on mainnet.   |
