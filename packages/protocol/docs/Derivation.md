...
| **TIMESTAMP_MAX_OFFSET**         | `21600` (12 \* 1800)          | The maximum timestamp offset from the proposal origin timestamp, equivalent to a 6-hour window (assuming 12-second L1 blocks) to allow proposer recovery without causing a reorg. |
