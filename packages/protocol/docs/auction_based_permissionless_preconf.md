...
*Resolution:* the bounty is a watchdog fee. It is denied to `escrow.winner` and to a backup `escrow.challenger`; their share stays locked. Third-party watchers keep the incentive Q8 introduced.
