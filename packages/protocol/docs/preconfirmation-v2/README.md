...
python3 commitment-model.py          # 654 golden vectors / 1432 assertion sites
python3 commitment-model.py --export-json # 654 sorted typed oracle rows
