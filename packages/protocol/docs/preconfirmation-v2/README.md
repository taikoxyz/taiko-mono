...
python3 commitment-model.py          # 648 golden vectors / 1425 assertion sites
python3 commitment-model.py --export-json # 648 sorted typed oracle rows
