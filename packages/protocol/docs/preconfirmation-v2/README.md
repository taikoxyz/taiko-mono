...
python3 test-settlement-window.py    # 267 adversarial regression tests
python3 lookahead-model.py           # 38 assertions
python3 commitment-model.py          # 702 golden vectors / 1478 assertion sites
python3 commitment-model.py --export-json # 702 sorted typed oracle rows
