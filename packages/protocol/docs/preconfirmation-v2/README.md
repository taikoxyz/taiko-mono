...
python3 commitment-model.py          # 875 golden vectors / 1677 assertion sites
python3 commitment-model.py --export-json # 875 sorted typed oracle rows
