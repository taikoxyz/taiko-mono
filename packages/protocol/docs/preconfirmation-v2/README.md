...
python3 test-settlement-window.py    # 297 adversarial regression tests
python3 lookahead-model.py           # 38 assertions
python3 commitment-model.py          # 812 golden vectors / 1611 assertion sites
