...
python3 test-settlement-window.py    # 298 adversarial regression tests
...
verifier and a typed static constructor tuple while leaving all roots, custody, locators and writes
in Registry; its exact calls, output masks and Factory pins are covered by both executable models.
The
