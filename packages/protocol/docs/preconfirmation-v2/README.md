...
python3 test-settlement-window.py    # 254 adversarial regression tests
python3 lookahead-model.py           # 38 assertions
python3 commitment-model.py          # 675 golden vectors / 1466 assertion sites
python3 commitment-model.py --export-json # 675 sorted typed oracle rows
