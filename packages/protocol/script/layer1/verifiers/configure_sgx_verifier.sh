...
Available Environments:
  dev-ontake, dev-pacaya, dev-sgxgeth, dev-shasta, dev-shasta-sgxgeth
  tolba-pacaya, tolba-pacaya-sgxgeth, tolba-shasta, tolba-shasta-sgxgeth
  transition-shasta-sgxreth, transition-shasta-sgxgeth
...
[[ -z "$SGX_VERIFIER_ADDRESS" ]] && {
    echo "Error: SGX_VERIFIER_ADDRESS not set (pass --env NAME or export it)"
    exit 1
}
