...
contract DeployProtocolOnL1 is DeployCapability {
        ...
        returns (address taikoInboxAddr, address proofVerifier, address whitelist)
    {
        ...
        address tempFork = address(new DevnetShastaInbox(proofVerifier, whitelist, bondToken, helper));
        ...
        address newFork = address(new DevnetShastaInbox(proofVerifier, whitelist, bondToken, helper));
