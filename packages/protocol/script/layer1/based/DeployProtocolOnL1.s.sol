...
contract DeployProtocolOnL1 is DeployCapability {
        ...
        returns (address taikoInboxAddr, address proofVerifier, address whitelist)
    {
        ...
        address tempFork = address(new ShastaDevnetInbox(proofVerifier, whitelist, bondToken));
        ...
        address newFork = address(new ShastaDevnetInbox(proofVerifier, whitelist, bondToken));
