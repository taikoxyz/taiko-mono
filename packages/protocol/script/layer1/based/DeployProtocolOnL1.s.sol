...
contract DeployProtocolOnL1 is DeployCapability {
        ...
        returns (address rollupResolver, address proofVerifier)
    {
        ...
        (address sgxVerifier, address gethVerifier) =
        ...
        UUPSUpgradeable(proofVerifier).upgradeTo({
            newImplementation: address(
                new DevnetVerifier(
                    taikoInboxAddr, gethVerifier, opVerifier, sgxVerifier, risc0Verifier, sp1Verifier
                )
            )
        });
    ...
    function deploySgxVerifier(
        ...
        private
        returns (address sgxVerifier, address gethVerifier)
    {
