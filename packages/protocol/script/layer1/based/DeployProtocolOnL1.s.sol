...
//         register(rollupResolver, "signal_service", vm.envAddress("L2_SIGNAL_SERVICE"),
// l2ChainId);
...
//         );
//         console2.log(
//             "sharedResolver.registerAddress(remoteChainId, 'erc20_vault',
// address(remoteERC20Vault))"
//         );
//         console2.log(
//             "sharedResolver.registerAddress(remoteChainId, 'erc721_vault',
// address(remoteERC721Vault))"
//         );
//         console2.log(
//             "sharedResolver.registerAddress(remoteChainId, 'erc1155_vault',
...
//         );
//         register(
//             sharedResolver, "bridged_erc1155", address(new
// BridgedERC1155(address(sharedResolver)))
//         );
//     }
...
//         address bullToken =
//             address(new FreeMintERC20Token_With50PctgMintAndTransferFailure("Bull Token",
// "BULL"));
