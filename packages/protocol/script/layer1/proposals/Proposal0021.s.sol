...
contract Proposal0021 is BuildProposal {
    ...
    function buildL1Actions() internal pure override returns (Controller.Action[] memory actions) {
        ...
        actions[0] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(Risc0Verifier.setImageIdTrusted, (LibRisc0Constants.V0_6_0_PROPOSAL_IMAGE_ID, false))
        });
        actions[1] = Controller.Action({
            target: L1.RISC0_RETH_VERIFIER,
            value: 0,
            data: abi.encodeCall(
                Risc0Verifier.setImageIdTrusted, (LibRisc0Constants.V0_6_0_AGGREGATION_IMAGE_ID, false)
            )
        });
        actions[2] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                Risc0Verifier.setImageIdTrusted, (LibRisc0Constants.V0_8_0_RC1_PROPOSAL_IMAGE_ID, true)
            )
        });
        actions[3] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                Risc0Verifier.setImageIdTrusted, (LibRisc0Constants.V0_8_0_RC1_AGGREGATION_IMAGE_ID, true)
            )
        });
        ...
        actions[4] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_6_0_PROPOSAL_PROGRAM_VKEY_BN254, false)
            )
        });
        actions[5] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_6_0_PROPOSAL_PROGRAM_VKEY_HASH_BYTES, false)
            )
        });
        actions[6] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_6_0_AGGREGATION_PROGRAM_VKEY_BN254, false)
            )
        });
        actions[7] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_6_0_AGGREGATION_PROGRAM_VKEY_HASH_BYTES, false)
            )
        });
        actions[8] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_8_0_RC1_PROPOSAL_PROGRAM_VKEY_BN254, true)
            )
        });
        actions[9] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_8_0_RC1_PROPOSAL_PROGRAM_VKEY_HASH_BYTES, true)
            )
        });
        actions[10] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_8_0_RC1_AGGREGATION_PROGRAM_VKEY_BN254, true)
            )
        });
        actions[11] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(
                SP1Verifier.setProgramTrusted, (LibSP1Constants.V0_8_0_RC1_AGGREGATION_PROGRAM_VKEY_HASH_BYTES, true)
            )
        });
        ...
        actions[12] = Controller.Action({
            ...
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (OLD_SGXGETH_MR_ENCLAVE, false))
        });
        actions[13] = Controller.Action({
            target: L1.SGXRETH_ATTESTER,
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (OLD_SGXRETH_NON_EDMM_MR_ENCLAVE, false))
        });
        actions[14] = Controller.Action({
            target: L1.SGXRETH_ATTESTER,
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (OLD_SGXRETH_EDMM_MR_ENCLAVE, false))
        });
        actions[15] = Controller.Action({
            target: L1.SGXGETH_ATTESTER,
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (NEW_SGXGETH_MR_ENCLAVE, true))
        });
        actions[16] = Controller.Action({
            target: L1.SGXRETH_ATTESTER,
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (NEW_SGXRETH_NON_EDMM_MR_ENCLAVE, true))
        });
        actions[17] = Controller.Action({
            target: L1.SGXRETH_ATTESTER,
            value: 0,
            data: abi.encodeCall(IProposal0021Attestation.setMrEnclave, (NEW_SGXRETH_EDMM_MR_ENCLAVE, true))
        });
    ...
    function _checkRisc0Constants() private pure {
        ...
        require(
            LibRisc0Constants.V0_6_0_PROPOSAL_IMAGE_ID != LibRisc0Constants.V0_8_0_RC1_PROPOSAL_IMAGE_ID
                && LibRisc0Constants.V0_6_0_AGGREGATION_IMAGE_ID != LibRisc0Constants.V0_8_0_RC1_AGGREGATION_IMAGE_ID,
    ...
    function _checkSP1Constants() private pure {
        ...
        require(
            LibSP1Constants.V0_6_0_PROPOSAL_PROGRAM_VKEY_BN254 != LibSP1Constants.V0_8_0_RC1_PROPOSAL_PROGRAM_VKEY_BN254
