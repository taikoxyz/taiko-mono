...
//         });
//         UUPSUpgradeable(sgxVerifier).upgradeTo(address(new SgxVerifier(rollupResolver,
// l2ChainId)));
...
//         UUPSUpgradeable(sp1Verifier).upgradeTo(address(new SP1Verifier(rollupResolver,
// l2ChainId)));
