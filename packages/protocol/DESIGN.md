...
2) shall for the hash function , shall we use **keccak256** or **Poseidon** hash?
...
We choose option 2 to maximize the chance that a transaction makes into the L2 chain.
