...
describe("Lib_BlockHeaderDecoder", async function () {
    ...
    it("Decode should return stateRoot and timeStamp", async function () {
        ...
        const blockHeader: any = {
            ...
            logsBloom:
                "",
            // .match(/.{1,64}/g)!
            // .map((s) => "0x" + s),
        ...
        const bytesBlockHeader = [
            ...
            await ethers.utils.hexValue(blockHeader.difficulty),
            await ethers.utils.hexValue(blockHeader.height),
            await ethers.utils.hexValue(blockHeader.gasLimit),
            await ethers.utils.hexValue(blockHeader.gasUsed),
            await ethers.utils.hexValue(blockHeader.timestamp),
