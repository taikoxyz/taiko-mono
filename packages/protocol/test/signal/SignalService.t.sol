...
contract TestSignalService is TestBase {
    ...
    //         hex"e5a4e3a120be7cf54b321b1863f6772ac6b5776a712628a78149e662c87d93ae1ef2a5b3bd01";
    // //eth_getProof's
    //         // result RLP encoded storage proof
    //     bytes32 signalRoot =
    //         0x15e2682cef63ccbfeb896e5faaf1eeaa2a834301e468c92f9764be56416682d4;
    // //eth_getProof
    ...
    //     address app = 0x927a146e18294efb36edCacC99D9aCEA6aB16b95; // Mock
    // app,
    //         // actually it is an EOA, but it is ok for tests! Same applies
    // here,
    ...
    //         0x630872b5926b611c6dbcff64c181865a376d4e9250b594e8669198e0f19aa9b0;
    // //eth_getProof
    //         // result's storage hash

    //     vm.startPrank(Alice);
    //     signalService.authorize(address(crossChainSync),
    ...
    //     // The 'hop' proof is the one that proves to L2B, that L1 Signal
    // service
