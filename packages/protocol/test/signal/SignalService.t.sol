...
contract TestSignalService is TaikoTest {
    ...
    function test_first() public {
        ...
        address srcChainApp = 0x927a146e18294efb36edCacC99D9aCEA6aB16b95;
        ...
        vm.startPrank(Alice);
        relayer.verifyMerkleProof(keccak256(worldStateRootRLPEncoded), chainId, srcChainApp, signalSent, merkleProof);
    }
