...
contract LibEIP1559SimpleTest is Layer2Test {
    ...
    function test_1559classic_baseFeeStaysSameWithDifferentBaseFees(uint256 parentBaseFee) public pure {
        // Bound the parent base fee to reasonable values
        parentBaseFee = bound(parentBaseFee, LibEIP1559Classic.MIN_BASE_FEE, LibEIP1559Classic.MAX_BASE_FEE);
    ...
    function test_1559classic_baseFeeStaysSameWithDifferentBlockTimes(uint256 blockTime) public pure {
