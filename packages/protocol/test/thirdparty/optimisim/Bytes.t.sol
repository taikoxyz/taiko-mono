...
contract TestBytes is TaikoTest {
    ...
    function test_toNibbles() external {
        ...
        assertEq(hex"00010203040506070809000102030405060708090001020304050607080900010203040506070809", nibbles);
    ...
    function test_slice() external {
        ...
        bytes memory someBytes = hex"0123456789012345678901234567890123456789";
            ...
            // 1.B. full length
                // 1.B.i. 0 start
                assertEq(Bytes.slice(someBytes, 0, someBytes.length), hex"0123456789012345678901234567890123456789");
        ...
        someBytes = hex"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";
            ...
            // 2.B. full length
                // 2.B.i. 0 start
                assertEq(Bytes.slice(someBytes, 0, someBytes.length), hex"0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef");
    ...
    function test_slice2() external {
        ...
        assertEq(Bytes.slice(someBytes, someBytes.length*1000), hex""); //Doesnt revert if start is out of bounds
    }
}