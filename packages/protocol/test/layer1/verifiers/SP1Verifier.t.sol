...
contract TaikoStub_ReturnMainnetChainId {
    function getConfigV3() external pure returns (ITaiko.ConfigV3 memory config) {
...
contract TestSP1Verifier is Layer1Test {
    ...
    //     (IVerifier.Context memory ctx, ITaiko.TransitionV3 memory transition) =
    ...
    //     internal
    //     pure
    //     returns (IVerifier.Context memory ctx, ITaiko.TransitionV3 memory transition)
    // {
    //     // Context
    ...
    //     // Transition
    //     transition = ITaiko.TransitionV3({
