...
contract InboxProveMinProposalsTest is InboxTestBase {
    ...
    function test_prove_succeedsWhen_MinProposalsFinalized() public {
        ...
        IInbox.CoreState memory state = _getCoreState();
...
contract InboxProveTest is InboxTestBase {
    ...
    function test_prove_acceptsProofWithFinalizedPrefix() public {
        ...
        assertEq(_getCoreState().lastFinalizedProposalId, p1.proposal.id, "p1 finalized");
    ...
    function test_prove_succeedsWhen_FirstProposalIdAtExactBoundary() public {
        ...
        assertEq(_getCoreState().lastFinalizedProposalId, 0, "lastFinalizedProposalId should be 0");

        _prove(input);

        assertEq(_getCoreState().lastFinalizedProposalId, 1, "should finalize");
    }
    ...
    function test_prove_succeedsWhen_LastProposalIdAtExactBoundary() public {
        ...
        assertEq(_getCoreState().nextProposalId, 2, "nextProposalId should be 2");
    ...
    function test_prove_checkpointSyncsAfterDelay() public {
        ...
        uint48 checkpointBefore = _getCoreState().lastCheckpointTimestamp;
