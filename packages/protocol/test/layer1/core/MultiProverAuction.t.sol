...
import { MultiProverAuction } from "src/layer1/core/impl/MultiProverAuction.sol";
import { TestERC20 } from "test/mocks/TestERC20.sol";
import { CommonTest } from "test/shared/CommonTest.sol";

contract MultiProverAuctionTest is CommonTest {
    MultiProverAuction internal auction;
    ...
    function setUp() public virtual override {
        ...
        MultiProverAuction impl = new MultiProverAuction(
            inbox,
            address(bondToken),
            LIVENESS_BOND,
            BOND_MULTIPLIER,
        ...
        auction = MultiProverAuction(
            address(
                new ERC1967Proxy(
                    address(impl), abi.encodeCall(MultiProverAuction.init, (address(this)))
                )
            )
        );
    ...
    function test_poolFullReverts() public {
        ...
        vm.prank(extra);
        vm.expectRevert(MultiProverAuction.PoolFull.selector);
        auction.bid(100);
    }
