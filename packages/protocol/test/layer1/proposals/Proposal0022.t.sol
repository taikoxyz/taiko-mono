...
import { Proposal0022 } from "script/layer1/proposals/Proposal0022.s.sol";
...
contract Proposal0022Test is Test {
    ...
    function test_placeholderConstantsStillGuardTheBuilders() external {
        ...
        vm.expectRevert(Proposal0022.ImplementationNotDeployed.selector);
...
contract Proposal0022Harness is Proposal0022 {
