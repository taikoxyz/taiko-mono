...
contract InboxFinalization is ShastaInboxTestBase {
    ...
    function test_finalize_single_proposal() public {
        ...
        inbox.exposed_setClaimRecordHash(proposalId, coreState.lastFinalizedClaimHash, claimRecordHash);
    ...
    function test_finalize_stops_at_missing_claim() public {
        ...
        IInbox.Claim memory claim3 = createValidClaim(proposal3, bytes32(uint256(999))); // Different parent
        ...
        inbox.exposed_setClaimRecordHash(3, bytes32(uint256(999)), keccak256(abi.encode(claimRecord3)));
    ...
    function test_finalize_invalid_claim_hash() public {
        ...
        inbox.exposed_setClaimRecordHash(proposalId, coreState.lastFinalizedClaimHash, keccak256(abi.encode(claimRecord)));
    ...
    function test_finalize_respects_max_count() public {
        ...
        expectSyncedBlockSave(secondClaim.endBlockNumber, secondClaim.endBlockHash, secondClaim.endStateRoot);
