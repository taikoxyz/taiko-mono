...
contract InboxProveBasic is InboxTest {
    ...
    function test_prove_submission_flow() public {
        ...
        vm.prank(Bob);
        inbox.prove(InboxTestAdapter.encodeProveData(inboxType, _toArray(proposal), _toArray(claim)), proof);
    ...
    function test_prove_with_mock_verification() public {
        ...
        vm.prank(Bob);
        inbox.prove(
            InboxTestAdapter.encodeProveData(inboxType, _toArray(proposal), _toArray(claim)), bytes("test_proof")
        );
