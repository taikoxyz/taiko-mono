...
contract InboxFinalization is InboxTest {
        ...
        private
    {
        ...
        newCoreState.nextProposalBlockId = uint48(InboxTestLib.calculateProposalBlock(2, 102));
        ...
        setupBlobHashes();
        uint256 targetBlock = InboxTestLib.calculateProposalBlock(2, 102);
        vm.roll(targetBlock);
        vm.prank(Alice);
        ...
        private
    {
        ...
        uint256 targetBlock = InboxTestLib.calculateProposalBlock(_nextProposalId, 102);
        vm.roll(targetBlock);
        vm.prank(Carol);
        inbox.propose(
            bytes(""),
    ...
    function test_finalize_stops_at_missing_transition() public {
        ...
        coreState1.nextProposalBlockId = uint48(InboxTestLib.calculateProposalBlock(2, 102));
        ...
        coreState2.nextProposalBlockId = uint48(InboxTestLib.calculateProposalBlock(3, 102));
        ...
        coreState.nextProposalBlockId = uint48(InboxTestLib.calculateProposalBlock(3, 102));
    ...
    function test_finalize_invalid_transition_hash() public {
        ...
        coreState.nextProposalBlockId = uint48(InboxTestLib.calculateProposalBlock(2, 102));
