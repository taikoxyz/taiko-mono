...
/// @title InboxOptimized4GasTest
/// @notice Gas measurement test for InboxOptimized4 implementation
/// @dev Use this to measure optimized gas usage for comparison with standard Inbox
contract InboxOptimized4GasTest is AbstractProposeTest {
    ...
    function test_gasUsage_singleProposal() public {
        ...
        emit log_named_uint("InboxOptimized4 Gas Usage", gasUsed);
