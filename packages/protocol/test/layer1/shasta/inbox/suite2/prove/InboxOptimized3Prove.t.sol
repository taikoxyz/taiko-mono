...
contract InboxOptimized3Prove is AbstractProveTest {
    ...
    /// @dev Override for InboxOptimized3 which uses custom decoding that doesn't support this test
    /// scenario
    ...
    function test_prove_RevertWhen_InconsistentParams() public override {
        ...
        // InboxOptimized3's decoder misinterprets abi.encode format and sees empty arrays
