...
contract PreconfRouterForkTest is Test {
    ...
    function test_preconfRouter_proposeBatch_L1Calldata_forked() external {
        ...
        TaikoWrapper wrapperImpl = new TaikoWrapper(MAINNET_INBOX, MAINNET_FORCED_INCLUSION, MAINNET_ROUTER);
        address forkImpl = address(new MainnetInbox(MAINNET_WRAPPER, PROOF_VERIFIER, TAIKO_TOKEN, SIGNAL_SERVICE));
