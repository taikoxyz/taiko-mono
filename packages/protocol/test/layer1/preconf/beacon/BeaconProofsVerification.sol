...
import {MerkleUtils} from "src/layer1/preconf/libraries/MerkleUtils.sol";
...
contract BeaconProofsVerification is BaseTest {
    function test_beaconProofsVerification_validatorInclusionInValidatorList() public  {
        ...
        assertTrue(MerkleUtils.verifyProof(validatorProof, validatorsRoot, validatorHashTreeRoot, validatorIndex));
    }
    ...
    function test_beaconProofsVerification_validatorListInclusionInBeaconState() public  {
        ...
        assertTrue(MerkleUtils.verifyProof(beaconStateProofForValidatorList, beaconStateRoot, validatorListRoot, 11));
    }
    ...
    function test_beaconProofsVerification_beaconStateInclusionInBeaconBlock() public  {
        ...
        assertTrue(MerkleUtils.verifyProof(beaconBlockProofForBeaconState, beaconBlockRoot, beaconStateRoot, 3));
    }
