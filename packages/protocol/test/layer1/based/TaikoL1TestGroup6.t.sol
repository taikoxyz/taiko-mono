...
contract TaikoL1TestGroup6 is TaikoL1TestGroupBase {
    ...
    function test_taikoL1_group_6_case_1() external {
        ...
        ITierProvider.Tier memory tierOp = TestTierRouter(cp).getTier(LibTiers.TIER_OPTIMISTIC);
        ITierProvider.Tier memory tierSgx = TestTierRouter(cp).getTier(LibTiers.TIER_SGX);
        ...
        mineAndWrap(10 seconds);
        proveBlock(Alice, meta, parentHash, blockHash, stateRoot, LibTiers.TIER_SGX, "");
