...
contract TaikoL1TestGroup1 is TaikoL1Test {
    ...
    function test_taikoL1_group_1_case_1() external {
...

        {
            ...
            assertEq(getBondTokenBalance(Alice), 10_000 ether - tier2.validityBond);
        }
    ...
    //     giveEthAndTko(Alice, 10_000 ether, 1000 ether);
    //     giveEthAndTko(Taylor, 10_000 ether, 1000 ether);
    //     ITierProvider.Tier memory tier2 = ITierProvider(tr).getTier(LibTiers.TIER_OPTIMISTIC);
    ...
    //             10_000 ether - tier2.validityBond + livenessBond * 7 / 8
    //         );
    //     }
    ...
    //         assertEq(getBondTokenBalance(Taylor), 10_000 ether - tier2.validityBond);
    //     }
    // }
    ...
    //             10_000 ether - tier2.validityBond - livenessBond / 8
    //         );
    //     }
