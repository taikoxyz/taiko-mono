...
/// @dev Tests all bond management functions including deposits, withdrawals, debits, credits, and
/// edge cases
contract BondManagerTest is CommonTest {
    ...
    function setUp() public override {
        ...
        BondManager impl = new BondManager(authorized, bondToken, minBond, withdrawalDelay);
    ...
    function testFuzz_deposit_withdraw_consistency(
