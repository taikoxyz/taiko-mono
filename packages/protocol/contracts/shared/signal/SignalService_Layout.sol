...
//   _receivedSignals               | mapping(uint256 => mapping(bytes32 => bool))       | Slot: 253  | Offset: 0    | Bytes: 32  
//   _checkpoints                   | mapping(uint256 => mapping(uint48 => struct SignalService.CheckpointRecord)) | Slot: 254  | Offset: 0    | Bytes: 32  
