...
/// @title AlethiaHoodiTaikoToken
/// @notice Taiko token for Taiko Alethia-Hoodi testnet.
/// @dev Labeled in address resolver as "taiko_token".
/// @dev Due to historical reasons, the Taiko Token on Alethia-Hoodi has a different storage layout
/// compared
/// to the mainnet token contract. Therefore, we need to maintain this file.
/// @custom:security-contact security@taiko.xyz
contract AlethiaHoodiTaikoToken is
    EssentialContract,
