...
contract ProverSet is EssentialContract, IERC1271 {
        ...
        onlyProver
    {
        ...
        taiko.proposeBlocksV3(address(0), address(0), _anchorExtraInput,_paramsArray, _txList);
    }
    ...
    function proposeBlocksV3(
        ...
        onlyProver
    {
        ITaikoL1(taikoL1()).proposeBlocksV3(address(0), address(0),_anchorExtraInput ,_paramsArray, _txList);
    }
