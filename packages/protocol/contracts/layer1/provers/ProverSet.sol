...
contract ProverSet is EssentialContract, IERC1271 {
    ...
    function proposeBlocksV3Conditionally(
        ITaikoL1.L1StaticCall[] calldata _l1StaticCalls,
        ...
        onlyProver
    {
        ...
        taiko.proposeBlocksV3(address(0), address(0), _l1StaticCalls, _paramsArray, _txList);
    }
    ...
    function proposeBlocksV3(
        ...
        onlyProver
    {
        ITaikoL1(taikoL1()).proposeBlocksV3(
            address(0), address(0), _l1StaticCalls, _paramsArray, _txList
        );
    }
