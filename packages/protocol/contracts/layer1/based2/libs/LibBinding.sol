...
library LibBinding {
    ...
    struct Bindings {
        ...
        // Decoding functions -----------------------------------------------------
        function(bytes memory) pure returns (I.Summary memory, I.Batch[] memory, I.BatchProposeMetadataEvidence memory, I.TransitionMeta[] memory)
            decodeProposeBatchesInputs;
