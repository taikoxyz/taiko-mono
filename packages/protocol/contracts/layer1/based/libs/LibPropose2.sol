...
import { ITaikoData as D } from "../ITaikoData.sol";
...
library LibPropose {
    ...
    struct Output {
        D.BatchProposeMetadata parentProposeMeta;
        ...
        returns (Output memory output_)
    {
        ...
        output_.parentProposeMeta = abi.decode(_parentProposeMeta, (D.BatchProposeMetadata));
