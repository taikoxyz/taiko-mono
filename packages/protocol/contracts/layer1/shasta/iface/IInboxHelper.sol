...
/// @title IInboxHelper
/// @notice Interface for unified helper contract providing encoder/decoder and hashing functions
...
interface IInboxHelper {
    ...
    /// @notice Encodes propose input data using optimized encoding
    ...
    /// @notice Encodes prove input data using optimized encoding
