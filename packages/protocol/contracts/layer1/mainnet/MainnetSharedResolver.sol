...
/// @title MainnetSharedResolver
/// @dev Resolver used by multiple based rollups.
/// @custom:security-contact security@taiko.xyz
contract MainnetSharedResolver is ResolverBase {
    function getAddress(
        uint256 _chainId,
        bytes32 _name
    )
        ...
        returns (address)
    {
        if (_chainId == LibNetwork.ETHEREUM_MAINNET) {
            ...
            if (_name == LibNames.B_ERC721_VAULT) {
                return 0x0b470dd3A0e1C41228856Fb319649E7c08f419Aa;
            }
            if (_name == LibNames.B_ERC1155_VAULT) {
                return 0xaf145913EA4a56BE22E120ED9C24589659881702;
            }
            if (_name == LibNames.B_SIGNAL_SERVICE) {
