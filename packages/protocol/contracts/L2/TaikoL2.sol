...
contract TaikoL2 is EssentialContract {
    ...
    /// @param _l1BlockHash The hash of the L1 block with id `anchorBlockId` in this L2 block's
    /// metadata.
    /// @param _l1StateRoot The state root of the L1 block with id `anchorBlockId` in this L2
    /// block's metadata.
    /// @param _l1BlockId The L1 block's id (aka `anchorBlockId`) in this L2 block's metadata.
