...
interface IBlockHash {
    ...
    /// @return blockHash The block hash of the specified block ID, or 0 if no hash is found.
    function getBlockHash(uint256 _blockId) external view returns (bytes32 blockHash);
}
