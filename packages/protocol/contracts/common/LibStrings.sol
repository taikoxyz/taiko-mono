...
library LibStrings {
    ...
    bytes32 internal constant B_VERIFIER_GUARDIAN = bytes32("verifeir_guardian");
    ...
    bytes32 internal constant B_VERIFIER_TEE_ZK = bytes32("verifier_tee_zk");
    bytes32 internal constant B_VERIFIER_SGX = bytes32("verifier_sgx");
    bytes32 internal constant B_VERIFIER_RISC0 = bytes32("verifier_risc0");
    bytes32 internal constant B_VERIFIER_SP1 = bytes32("verifier_sp1");
