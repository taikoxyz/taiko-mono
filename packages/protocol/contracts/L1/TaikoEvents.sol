...
abstract contract TaikoEvents {
    ...
    /// @param txList The list of transactions.
    ...
    /// @notice Emitted when some state variable values change.
    ...
    /// @param proposedIn The L1 block in which the transition is proved.
    ...
    /// @param tier The tier of the proof.
    /// @param proposedIn The L1 block in which the L2 block is proposed.
