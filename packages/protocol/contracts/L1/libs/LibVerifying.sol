...
library LibVerifying {
        ...
        internal
    {
        ...
        unchecked {
            ...
            state.slot6.feePerGas = initFeePerGas;
            state.slot6.avgProofDelay = initAvgProofDelay;
        ...
        internal
    {
        ...
        if (processed > 0) {
            unchecked {
                state.lastVerifiedAt = uint64(block.timestamp);
                state.slot8.lastVerifiedBlockId += processed;
            }
            ...
            emit CrossChainSynced(
                state.slot8.lastVerifiedBlockId, blockHash, signalRoot
            );
        }
    }
        ...
        private
    {
        ...
        if (fc.prover == address(1)) {
            ...
            state.slot6.avgProofDelay = uint16(
                LibUtils.movingAverage({
                    maValue: state.slot6.avgProofDelay,
            ...
            state.slot6.feePerGas = uint32(
                LibUtils.movingAverage({
                    maValue: state.slot6.feePerGas,
