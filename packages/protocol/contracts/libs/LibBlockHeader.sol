...
library LibBlockHeader {
        ...
        returns (bytes[] memory list)
    {
        ...
        list[1] = RLPWriter.writeHash(header.ommersHash);
        list[2] = RLPWriter.writeAddress(header.beneficiary);
        list[3] = RLPWriter.writeHash(header.stateRoot);
        list[4] = RLPWriter.writeHash(header.transactionsRoot);
        list[5] = RLPWriter.writeHash(header.receiptsRoot);
        ...
        list[13] = RLPWriter.writeHash(header.mixHash);
