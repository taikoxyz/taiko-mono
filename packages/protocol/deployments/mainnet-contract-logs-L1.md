...
- todo:
  - change `prover_set` to a deployment of `CachedProverSet` then unregisgter `assignment_hook`.
...
- logs:
  ...
  - todo:
    - upgrade to enable permissionless block-proposing and apply gas optimization changes
...
- todo:
  - upgrade to the a newly deployed `CachedProverSet`
