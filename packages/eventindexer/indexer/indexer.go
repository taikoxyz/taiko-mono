...
import (
	...
	v3 "github.com/taikoxyz/taiko-mono/packages/eventindexer/contracts/v3/taikol1"
...
func InitFromConfig(ctx context.Context, i *Indexer, cfg *Config) error {
	...
	if cfg.L1TaikoAddress.Hex() != ZeroAddress.Hex() {
		...
		if err != nil {
			return errors.Wrap(err, "contracts.v1.NewTaikoL1")
		}

		taikol1V2, err = v2.NewTaikoL1(cfg.L1TaikoAddress, ethClient)
		if err != nil {
			return errors.Wrap(err, "contracts.v2.NewTaikoL1")
		}

		taikol1V3, err = v3.NewTaikoL1(cfg.L1TaikoAddress, ethClient)
		if err != nil {
			return errors.Wrap(err, "contracts.v3.NewTaikoL1")
		}
	}
