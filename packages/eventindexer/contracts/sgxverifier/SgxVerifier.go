...
func (_SgxVerifier *SgxVerifierCaller) Impl(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SgxVerifier.contract.Call(opts, &out, "impl")
...
func (_SgxVerifier *SgxVerifierSession) Impl() (common.Address, error) {
	return _SgxVerifier.Contract.Impl(&_SgxVerifier.CallOpts)
}
...
func (_SgxVerifier *SgxVerifierCaller) InNonReentrant(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _SgxVerifier.contract.Call(opts, &out, "inNonReentrant")
...
func (_SgxVerifier *SgxVerifierSession) InNonReentrant() (bool, error) {
	return _SgxVerifier.Contract.InNonReentrant(&_SgxVerifier.CallOpts)
}
...
func (_SgxVerifier *SgxVerifierCaller) Resolver(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SgxVerifier.contract.Call(opts, &out, "resolver")
...
//
// Solidity: function resolver() view returns(address)
func (_SgxVerifier *SgxVerifierSession) Resolver() (common.Address, error) {
	return _SgxVerifier.Contract.Resolver(&_SgxVerifier.CallOpts)
}

// Resolver is a free data retrieval call binding the contract method 0x04f3bcec.
//
// Solidity: function resolver() view returns(address)
func (_SgxVerifier *SgxVerifierCallerSession) Resolver() (common.Address, error) {
	return _SgxVerifier.Contract.Resolver(&_SgxVerifier.CallOpts)
}

// TaikoChainId is a free data retrieval call binding the contract method 0xa5a1d0c5.
//
// Solidity: function taikoChainId() view returns(uint64)
func (_SgxVerifier *SgxVerifierCaller) TaikoChainId(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _SgxVerifier.contract.Call(opts, &out, "taikoChainId")
...
//
// Solidity: function taikoChainId() view returns(uint64)
func (_SgxVerifier *SgxVerifierSession) TaikoChainId() (uint64, error) {
	return _SgxVerifier.Contract.TaikoChainId(&_SgxVerifier.CallOpts)
}

// TaikoChainId is a free data retrieval call binding the contract method 0xa5a1d0c5.
//
// Solidity: function taikoChainId() view returns(uint64)
func (_SgxVerifier *SgxVerifierCallerSession) TaikoChainId() (uint64, error) {
	return _SgxVerifier.Contract.TaikoChainId(&_SgxVerifier.CallOpts)
}
...
//
// Solidity: function init(address _owner, address _rollupResolver) returns()
func (_SgxVerifier *SgxVerifierTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.contract.Transact(opts, "init", _owner, _rollupResolver)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _rollupResolver) returns()
func (_SgxVerifier *SgxVerifierSession) Init(_owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.Contract.Init(&_SgxVerifier.TransactOpts, _owner, _rollupResolver)
}

// Init is a paid mutator transaction binding the contract method 0xf09a4016.
//
// Solidity: function init(address _owner, address _rollupResolver) returns()
func (_SgxVerifier *SgxVerifierTransactorSession) Init(_owner common.Address, _rollupResolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.Contract.Init(&_SgxVerifier.TransactOpts, _owner, _rollupResolver)
}
...
func (_SgxVerifier *SgxVerifierTransactor) SetResolver(opts *bind.TransactOpts, _resolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.contract.Transact(opts, "setResolver", _resolver)
}

// SetResolver is a paid mutator transaction binding the contract method 0x4e543b26.
//
// Solidity: function setResolver(address _resolver) returns()
func (_SgxVerifier *SgxVerifierSession) SetResolver(_resolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.Contract.SetResolver(&_SgxVerifier.TransactOpts, _resolver)
}

// SetResolver is a paid mutator transaction binding the contract method 0x4e543b26.
//
// Solidity: function setResolver(address _resolver) returns()
func (_SgxVerifier *SgxVerifierTransactorSession) SetResolver(_resolver common.Address) (*types.Transaction, error) {
	return _SgxVerifier.Contract.SetResolver(&_SgxVerifier.TransactOpts, _resolver)
}
...
func (_SgxVerifier *SgxVerifierTransactor) VerifyProof(opts *bind.TransactOpts, _ctxs []IVerifierContext, _proof []byte) (*types.Transaction, error) {
	return _SgxVerifier.contract.Transact(opts, "verifyProof", _ctxs, _proof)
}

// VerifyProof is a paid mutator transaction binding the contract method 0x9b26b724.
//
// Solidity: function verifyProof((uint64,bytes32,(bytes32,bytes32,bytes32))[] _ctxs, bytes _proof) returns()
func (_SgxVerifier *SgxVerifierSession) VerifyProof(_ctxs []IVerifierContext, _proof []byte) (*types.Transaction, error) {
	return _SgxVerifier.Contract.VerifyProof(&_SgxVerifier.TransactOpts, _ctxs, _proof)
}

// VerifyProof is a paid mutator transaction binding the contract method 0x9b26b724.
//
// Solidity: function verifyProof((uint64,bytes32,(bytes32,bytes32,bytes32))[] _ctxs, bytes _proof) returns()
func (_SgxVerifier *SgxVerifierTransactorSession) VerifyProof(_ctxs []IVerifierContext, _proof []byte) (*types.Transaction, error) {
	return _SgxVerifier.Contract.VerifyProof(&_SgxVerifier.TransactOpts, _ctxs, _proof)
}
...
func (_SgxVerifier *SgxVerifierFilterer) FilterInstanceAdded(opts *bind.FilterOpts, id []*big.Int, instance []common.Address, replaced []common.Address) (*SgxVerifierInstanceAddedIterator, error) {
	...
	logs, sub, err := _SgxVerifier.contract.FilterLogs(opts, "InstanceAdded", idRule, instanceRule, replacedRule)
	if err != nil {
		return nil, err
	}
...
func (_SgxVerifier *SgxVerifierFilterer) WatchInstanceAdded(opts *bind.WatchOpts, sink chan<- *SgxVerifierInstanceAdded, id []*big.Int, instance []common.Address, replaced []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SgxVerifier.contract.WatchLogs(opts, "InstanceAdded", idRule, instanceRule, replacedRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// SgxVerifierResolverUpdatedIterator is returned from FilterResolverUpdated and is used to iterate over the raw logs and unpacked data for ResolverUpdated events raised by the SgxVerifier contract.
type SgxVerifierResolverUpdatedIterator struct {
	Event *SgxVerifierResolverUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SgxVerifierResolverUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SgxVerifierResolverUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SgxVerifierResolverUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SgxVerifierResolverUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SgxVerifierResolverUpdated represents a ResolverUpdated event raised by the SgxVerifier contract.
type SgxVerifierResolverUpdated struct {
...
func (_SgxVerifier *SgxVerifierFilterer) FilterResolverUpdated(opts *bind.FilterOpts) (*SgxVerifierResolverUpdatedIterator, error) {

	logs, sub, err := _SgxVerifier.contract.FilterLogs(opts, "ResolverUpdated")
	if err != nil {
		return nil, err
	}
	return &SgxVerifierResolverUpdatedIterator{contract: _SgxVerifier.contract, event: "ResolverUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event ResolverUpdated(address oldResolver, address newResolver)
func (_SgxVerifier *SgxVerifierFilterer) WatchResolverUpdated(opts *bind.WatchOpts, sink chan<- *SgxVerifierResolverUpdated) (event.Subscription, error) {

	logs, sub, err := _SgxVerifier.contract.WatchLogs(opts, "ResolverUpdated")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SgxVerifierResolverUpdated)
				if err := _SgxVerifier.contract.UnpackLog(event, "ResolverUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ResolverUpdated(address oldResolver, address newResolver)
func (_SgxVerifier *SgxVerifierFilterer) ParseResolverUpdated(log types.Log) (*SgxVerifierResolverUpdated, error) {
	event := new(SgxVerifierResolverUpdated)
	if err := _SgxVerifier.contract.UnpackLog(event, "ResolverUpdated", log); err != nil {
		return nil, err
	}
