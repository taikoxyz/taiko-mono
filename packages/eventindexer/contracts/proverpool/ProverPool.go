...
func (_ProverPool *ProverPoolTransactor) SlashProver(opts *bind.TransactOpts, addr common.Address, proofReward uint64) (*types.Transaction, error) {
	return _ProverPool.contract.Transact(opts, "slashProver", addr, proofReward)
}

// SlashProver is a paid mutator transaction binding the contract method 0xee39d18e.
//
// Solidity: function slashProver(address addr, uint64 proofReward) returns()
func (_ProverPool *ProverPoolSession) SlashProver(addr common.Address, proofReward uint64) (*types.Transaction, error) {
	return _ProverPool.Contract.SlashProver(&_ProverPool.TransactOpts, addr, proofReward)
}

// SlashProver is a paid mutator transaction binding the contract method 0xee39d18e.
//
// Solidity: function slashProver(address addr, uint64 proofReward) returns()
func (_ProverPool *ProverPoolTransactorSession) SlashProver(addr common.Address, proofReward uint64) (*types.Transaction, error) {
	return _ProverPool.Contract.SlashProver(&_ProverPool.TransactOpts, addr, proofReward)
}
