...
//
// Solidity: function getProofReward(uint64 effectiveAt, uint64 proposedAt) view returns(uint64)
func (_TaikoL1 *TaikoL1Caller) GetProofReward(opts *bind.CallOpts, effectiveAt uint64, proposedAt uint64) (uint64, error) {
	var out []interface{}
	err := _TaikoL1.contract.Call(opts, &out, "getProofReward", effectiveAt, proposedAt)
...
//
// Solidity: function getProofReward(uint64 effectiveAt, uint64 proposedAt) view returns(uint64)
func (_TaikoL1 *TaikoL1Session) GetProofReward(effectiveAt uint64, proposedAt uint64) (uint64, error) {
	return _TaikoL1.Contract.GetProofReward(&_TaikoL1.CallOpts, effectiveAt, proposedAt)
}

// GetProofReward is a free data retrieval call binding the contract method 0x4ee56f9e.
//
// Solidity: function getProofReward(uint64 effectiveAt, uint64 proposedAt) view returns(uint64)
func (_TaikoL1 *TaikoL1CallerSession) GetProofReward(effectiveAt uint64, proposedAt uint64) (uint64, error) {
	return _TaikoL1.Contract.GetProofReward(&_TaikoL1.CallOpts, effectiveAt, proposedAt)
}
