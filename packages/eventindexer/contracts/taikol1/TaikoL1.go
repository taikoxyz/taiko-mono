...
//
// Solidity: function getConfig() pure returns((uint256,uint256,uint256,uint256,uint64,uint64,uint64,uint256,uint256,uint256,uint256,uint256,uint256,uint64,uint64,uint96,uint96,uint8,bool))
...
//
// Solidity: function state() view returns(uint64 genesisHeight, uint64 genesisTimestamp, uint64 __reserved71, uint64 __reserved72, uint64 accProposedAt, uint64 accBlockFees, uint64 numBlocks, uint64 nextEthDepositToProcess, uint64 blockFee, uint64 proofTimeIssued, uint64 lastVerifiedBlockId, uint64 proofTimeTarget)
func (_TaikoL1 *TaikoL1Caller) State(opts *bind.CallOpts) (struct {
	...
	outstruct.ProofTimeTarget = *abi.ConvertType(out[11], new(uint64)).(*uint64)
...
// Init is a paid mutator transaction binding the contract method 0xde92a0ba.
//
// Solidity: function init(address _addressManager, bytes32 _genesisBlockHash, uint64 _initBlockFee, uint64 _initProofTimeTarget, uint64 _initProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1Transactor) Init(opts *bind.TransactOpts, _addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.contract.Transact(opts, "init", _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued)
}

// Init is a paid mutator transaction binding the contract method 0xde92a0ba.
//
// Solidity: function init(address _addressManager, bytes32 _genesisBlockHash, uint64 _initBlockFee, uint64 _initProofTimeTarget, uint64 _initProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1Session) Init(_addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.Contract.Init(&_TaikoL1.TransactOpts, _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued)
}

// Init is a paid mutator transaction binding the contract method 0xde92a0ba.
//
// Solidity: function init(address _addressManager, bytes32 _genesisBlockHash, uint64 _initBlockFee, uint64 _initProofTimeTarget, uint64 _initProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1TransactorSession) Init(_addressManager common.Address, _genesisBlockHash [32]byte, _initBlockFee uint64, _initProofTimeTarget uint64, _initProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.Contract.Init(&_TaikoL1.TransactOpts, _addressManager, _genesisBlockHash, _initBlockFee, _initProofTimeTarget, _initProofTimeIssued)
}
...
// SetProofParams is a paid mutator transaction binding the contract method 0x8cde54b3.
//
// Solidity: function setProofParams(uint64 newProofTimeTarget, uint64 newProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1Transactor) SetProofParams(opts *bind.TransactOpts, newProofTimeTarget uint64, newProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.contract.Transact(opts, "setProofParams", newProofTimeTarget, newProofTimeIssued)
}

// SetProofParams is a paid mutator transaction binding the contract method 0x8cde54b3.
//
// Solidity: function setProofParams(uint64 newProofTimeTarget, uint64 newProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1Session) SetProofParams(newProofTimeTarget uint64, newProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.Contract.SetProofParams(&_TaikoL1.TransactOpts, newProofTimeTarget, newProofTimeIssued)
}

// SetProofParams is a paid mutator transaction binding the contract method 0x8cde54b3.
//
// Solidity: function setProofParams(uint64 newProofTimeTarget, uint64 newProofTimeIssued) returns()
func (_TaikoL1 *TaikoL1TransactorSession) SetProofParams(newProofTimeTarget uint64, newProofTimeIssued uint64) (*types.Transaction, error) {
	return _TaikoL1.Contract.SetProofParams(&_TaikoL1.TransactOpts, newProofTimeTarget, newProofTimeIssued)
}
...
// TaikoL1ProofTimeTargetChangedIterator is returned from FilterProofTimeTargetChanged and is used to iterate over the raw logs and unpacked data for ProofTimeTargetChanged events raised by the TaikoL1 contract.
type TaikoL1ProofTimeTargetChangedIterator struct {
	Event *TaikoL1ProofTimeTargetChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TaikoL1ProofTimeTargetChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TaikoL1ProofTimeTargetChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TaikoL1ProofTimeTargetChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TaikoL1ProofTimeTargetChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TaikoL1ProofTimeTargetChanged represents a ProofTimeTargetChanged event raised by the TaikoL1 contract.
type TaikoL1ProofTimeTargetChanged struct {
	ProofTimeTarget uint64
	Raw             types.Log // Blockchain specific contextual infos
}

// FilterProofTimeTargetChanged is a free log retrieval operation binding the contract event 0xd0d6b30ee02ac04d7032e76d46c0dea02728e0c38b84d893648ab040dad051c9.
//
// Solidity: event ProofTimeTargetChanged(uint64 proofTimeTarget)
func (_TaikoL1 *TaikoL1Filterer) FilterProofTimeTargetChanged(opts *bind.FilterOpts) (*TaikoL1ProofTimeTargetChangedIterator, error) {

	logs, sub, err := _TaikoL1.contract.FilterLogs(opts, "ProofTimeTargetChanged")
	if err != nil {
		return nil, err
	}
	return &TaikoL1ProofTimeTargetChangedIterator{contract: _TaikoL1.contract, event: "ProofTimeTargetChanged", logs: logs, sub: sub}, nil
}

// WatchProofTimeTargetChanged is a free log subscription operation binding the contract event 0xd0d6b30ee02ac04d7032e76d46c0dea02728e0c38b84d893648ab040dad051c9.
//
// Solidity: event ProofTimeTargetChanged(uint64 proofTimeTarget)
func (_TaikoL1 *TaikoL1Filterer) WatchProofTimeTargetChanged(opts *bind.WatchOpts, sink chan<- *TaikoL1ProofTimeTargetChanged) (event.Subscription, error) {

	logs, sub, err := _TaikoL1.contract.WatchLogs(opts, "ProofTimeTargetChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TaikoL1ProofTimeTargetChanged)
				if err := _TaikoL1.contract.UnpackLog(event, "ProofTimeTargetChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseProofTimeTargetChanged is a log parse operation binding the contract event 0xd0d6b30ee02ac04d7032e76d46c0dea02728e0c38b84d893648ab040dad051c9.
//
// Solidity: event ProofTimeTargetChanged(uint64 proofTimeTarget)
func (_TaikoL1 *TaikoL1Filterer) ParseProofTimeTargetChanged(log types.Log) (*TaikoL1ProofTimeTargetChanged, error) {
	event := new(TaikoL1ProofTimeTargetChanged)
	if err := _TaikoL1.contract.UnpackLog(event, "ProofTimeTargetChanged", log); err != nil {
		return nil, err
	}
