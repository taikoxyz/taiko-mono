...
func (_AssignmentHook *AssignmentHookCaller) Impl(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _AssignmentHook.contract.Call(opts, &out, "impl")
...
//
// Solidity: function impl() view returns(address)
func (_AssignmentHook *AssignmentHookSession) Impl() (common.Address, error) {
	return _AssignmentHook.Contract.Impl(&_AssignmentHook.CallOpts)
}

// Impl is a free data retrieval call binding the contract method 0x8abf6077.
//
// Solidity: function impl() view returns(address)
func (_AssignmentHook *AssignmentHookCallerSession) Impl() (common.Address, error) {
	return _AssignmentHook.Contract.Impl(&_AssignmentHook.CallOpts)
}
...
func (_AssignmentHook *AssignmentHookCaller) InNonReentrant(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _AssignmentHook.contract.Call(opts, &out, "inNonReentrant")
...
//
// Solidity: function inNonReentrant() view returns(bool)
func (_AssignmentHook *AssignmentHookSession) InNonReentrant() (bool, error) {
	return _AssignmentHook.Contract.InNonReentrant(&_AssignmentHook.CallOpts)
}

// InNonReentrant is a free data retrieval call binding the contract method 0x3075db56.
//
// Solidity: function inNonReentrant() view returns(bool)
func (_AssignmentHook *AssignmentHookCallerSession) InNonReentrant() (bool, error) {
	return _AssignmentHook.Contract.InNonReentrant(&_AssignmentHook.CallOpts)
}
