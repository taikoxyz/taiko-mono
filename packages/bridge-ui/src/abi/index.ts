...
export const bridgeAbi = [
  ...
  { type: 'error', inputs: [], name: 'B_MESSAGE_FAILED' },
  { type: 'error', inputs: [], name: 'B_MESSAGE_NOT_PROVEN' },
  { type: 'error', inputs: [], name: 'B_MESSAGE_NOT_SENT' },
  { type: 'error', inputs: [], name: 'B_MESSAGE_NOT_SUSPENDED' },
  { type: 'error', inputs: [], name: 'B_MESSAGE_SUSPENDED' },
  { type: 'error', inputs: [], name: 'B_NON_RETRIABLE' },
  { type: 'error', inputs: [], name: 'B_NOT_ENOUGH_GASLEFT' },
