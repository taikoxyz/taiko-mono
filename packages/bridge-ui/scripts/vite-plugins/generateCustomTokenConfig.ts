...
import configuredCustomTokensSchema from '../../config/schemas/configuredCustomTokens.schema.json';
  ...
  return {
    ...
    async buildStart() {
      ...
      if (skip) {
        ...
        const isValid = validateJsonAgainstSchema(configuredTokenConfigFile, configuredCustomTokensSchema);
