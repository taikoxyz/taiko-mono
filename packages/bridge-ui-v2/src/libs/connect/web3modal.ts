...
// todo remove this when we have the new config system, it will dynmically load the chain images
...
export const initWeb3Modal = (theme: 'dark' | 'light') => {
  web3modal = new Web3Modal(
    {
      ...
      themeVariables: {
        ...
        '--w3m-overlay-background-color': 'rgba(12, 17, 28, 0.02)',
        ...
        '--w3m-overlay-backdrop-filter': 'blur(0.5px)',
