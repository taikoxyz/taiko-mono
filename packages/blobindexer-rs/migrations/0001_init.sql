...
CREATE INDEX IF NOT EXISTS idx_blocks_parent_root ON blocks(parent_root);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_blobs_versioned_hash ON blobs(versioned_hash);
CREATE INDEX IF NOT EXISTS idx_blobs_block_root ON blobs(block_root);
