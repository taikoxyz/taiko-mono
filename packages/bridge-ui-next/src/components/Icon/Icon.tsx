...
export default function Icon({
  ...
  // You can now pass width and height as props, or they will default to size
  width,
  height,
  ...
  return (
    ...
    >
      ...
      {type === "relayer" && (
        <>
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            d="M4 4.25C4 3.00736 5.00736 2 6.25 2C7.49264 2 8.5 3.00736 8.5 4.25C8.5 5.49264 7.49264 6.5 6.25 6.5C5.00736 6.5 4 5.49264 4 4.25ZM11.5 10C11.5 8.61929 12.6193 7.5 14 7.5C15.3807 7.5 16.5 8.61929 16.5 10C16.5 11.3807 15.3807 12.5 14 12.5C12.6193 12.5 11.5 11.3807 11.5 10ZM4 15.75C4 14.5074 5.00736 13.5 6.25 13.5C7.49264 13.5 8.5 14.5074 8.5 15.75C8.5 16.9926 7.49264 18 6.25 18C5.00736 18 4 16.9926 4 15.75Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="M7.70694 5.9638C7.45094 5.63808 7.50747 5.16659 7.83319 4.91059L13.0705 0.795588C13.2921 0.621427 13.5943 0.586738 13.8496 0.706131C14.1049 0.825523 14.2698 1.07867 14.2746 1.36048L14.3109 3.50397C14.3179 3.91812 13.9879 4.25949 13.5738 4.2665C13.1597 4.2735 12.8183 3.9435 12.8113 3.52935L12.8076 3.30857L8.76015 6.09005C8.43443 6.34604 7.96293 6.28952 7.70694 5.9638ZM12.2931 14.0362C12.5491 13.7105 13.0206 13.654 13.3463 13.91L17.3937 17.0914L17.3975 16.8707C17.4045 16.4565 17.7458 16.1265 18.16 16.1335C18.5741 16.1405 18.9041 16.4819 18.8971 16.896L18.8608 19.0395C18.856 19.3213 18.6911 19.5745 18.4358 19.6939C18.1805 19.8133 17.8783 19.7786 17.6567 19.6044L12.4193 15.0894C12.0936 14.8334 12.0371 14.3619 12.2931 14.0362Z"
          />
        </>
      )}
      {type === "transactions" && (
      ...
      {type === "chevron-left" && (
        <path
          className="stroke-primary-icon"
          fill="none"
          strokeWidth="2"
          d="M15 3 L8 10 L15 17"
        />
      )}
      {type === "chevron-right" && (
        <path
      ...
      {type === "circle" && (
        <circle className={fillClass} cx="10" cy="10" r="6" />
      )}
      {type === "arrow-right" && (
        <path
          className={fillClass}
      ...
      {type === "sun" && (
        <>
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            d="m10,2c.41,0,.75.34.75.75v1.5c0,.41-.34.75-.75.75s-.75-.34-.75-.75v-1.5c0-.41.34-.75.75-.75Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="m10,15c.41,0,.75.34.75.75v1.5c0,.41-.34.75-.75.75s-.75-.34-.75-.75v-1.5c0-.41.34-.75.75-.75Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
          ...
          <path
            ...
            fillRule="evenodd"
            clipRule="evenodd"
            d="m15.66,5.4c.29-.29.29-.77,0-1.06-.29-.29-.77-.29-1.06,0l-1.06,1.06c-.29.29-.29.77,0,1.06.29.29.77.29,1.06,0l1.06-1.06Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="m6.46,14.6c.29-.29.29-.77,0-1.06-.29-.29-.77-.29-1.06,0l-1.06,1.06c-.29.29-.29.77,0,1.06.29.29.77.29,1.06,0l1.06-1.06Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="m18,10c0,.41-.34.75-.75.75h-1.5c-.41,0-.75-.34-.75-.75s.34-.75.75-.75h1.5c.41,0,.75.34.75.75Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="m5,10c0,.41-.34.75-.75.75h-1.5c-.41,0-.75-.34-.75-.75s.34-.75.75-.75h1.5c.41,0,.75.34.75.75Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
            clipRule="evenodd"
            d="m14.6,15.66c.29.29.77.29,1.06,0s.29-.77,0-1.06l-1.06-1.06c-.29-.29-.77-.29-1.06,0-.29.29-.29.77,0,1.06l1.06,1.06Z"
          />
          <path
            className={fillClass}
            fillRule="evenodd"
      ...
      {type === "approve-light" && (
        <>
          <path
            ...
            style={{ fill: "#e22b91", fillRule: "evenodd", strokeWidth: 0 }}
          />
          <rect
            x="11.34"
            y="16.55"
            width="7.66"
            height="2.95"
            style={{ fill: "#e22b91", strokeWidth: 0 }}
          />
          <path
            ...
            style={{ fill: "#e7e7e7", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "approve-dark" && (
        <>
          ...
          <path
            d="m14.53,5.91c0-.71-.57-1.28-1.28-1.28s-1.28.57-1.28,1.28v7.07s-1.77-1.77-1.77-1.77c-.5-.5-1.31-.5-1.81,0-.5.5-.5,1.31,0,1.81l3.53,3.53h3.54s3.54,0,3.54,0v-4.17c0-1.59-1.29-2.89-2.89-2.89h-1.59v-3.58Z"
            style={{ fill: "#f3f3f4", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "bridge-light" && (
        <>
          <defs>
            ...
            >
              <stop offset="0" stopColor="#e22b91" />
              <stop offset="1" stopColor="#f7c7dd" stopOpacity="0" />
            </linearGradient>
          </defs>
          <path
          ...
          <path
            ...
            style={{ fill: "url(#b)", strokeWidth: 0 }}
          />
          <path
            ...
            style={{ fill: "#f7c7dd", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "bridge-dark" && (
        <>
          <defs>
            ...
            >
              <stop offset="0" stopColor="#e22b91" />
              <stop offset="1" stopColor="#e22b91" stopOpacity="0" />
            </linearGradient>
          </defs>
          <path
            d="m7.81,9.8c0,.63.25,1.24.7,1.69.45.45,1.06.7,1.69.7h6.91c.63,0,1.24-.25,1.69-.7.45-.45.7-1.06.7-1.69V2.89c0-.63-.25-1.24-.7-1.69-.45-.45-1.06-.7-1.69-.7h-6.91c-.63,0-1.24.25-1.69.7-.45.45-.7,1.06-.7,1.69v6.91Z"
      ...
      {type === "success-light" && (
        <>
          ...
          <path
            ...
            style={{ fill: "#005e36", fillRule: "evenodd", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "success-dark" && (
        <>
          ...
          <path
            ...
            style={{ fill: "#69c396", fillRule: "evenodd", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "welcome-icon" && (
        <>
          ...
          <path
            ...
            style={{ fill: "#fafbfb", strokeWidth: 0 }}
          />
        </>
      )}
      {type === "settings" && (
